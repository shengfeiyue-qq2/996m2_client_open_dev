...
function ui.init(parent)
	...
	-- Create Text_1_1
	local Text_1_1 = GUI:Text_Create(Panel_1, "Text_1_1", 406.00, 390.00, 16, "#ffffff", [[状态]])
	...
	-- Create Text_1_2
	local Text_1_2 = GUI:Text_Create(Panel_1, "Text_1_2", 581.00, 390.00, 16, "#ffffff", [[价格]])
	...
	local ListView_items = GUI:ListView_Create(Panel_1, "ListView_items", 366.00, 50.00, 730.00, 322.00, 1)
	...
	-- Create Image_line
	local Image_line = GUI:Image_Create(Panel_1, "Image_line", 0.00, 48.00, "res/public/bg_yyxsz_01.png")
	GUI:setTouchEnabled(Image_line, false)
	GUI:setTag(Image_line, -1)

	-- Create Panel_btn
	local Panel_btn = GUI:Layout_Create(Panel_1, "Panel_btn", 0.00, 0.00, 732.00, 48.00, false)
	GUI:setTouchEnabled(Panel_btn, false)
	GUI:setTag(Panel_btn, -1)

	-- Create Button_bid
	local Button_bid = GUI:Button_Create(Panel_btn, "Button_bid", 522.00, 8.00, "res/public/1900000653.png")
	GUI:Button_setScale9Slice(Button_bid, 27, 28, 10, 10)
	GUI:setContentSize(Button_bid, 82, 30)
	...
	-- Create Button_buy
	local Button_buy = GUI:Button_Create(Panel_btn, "Button_buy", 634.00, 8.00, "res/public/1900000652.png")
	GUI:Button_setScale9Slice(Button_buy, 27, 28, 10, 10)
	GUI:setContentSize(Button_buy, 82, 30)
	...
	local Button_acquire = GUI:Button_Create(Panel_btn, "Button_acquire", 634.00, 8.00, "res/public/1900000652.png")
	GUI:Button_setScale9Slice(Button_acquire, 27, 28, 10, 10)
	GUI:setContentSize(Button_acquire, 82, 30)
