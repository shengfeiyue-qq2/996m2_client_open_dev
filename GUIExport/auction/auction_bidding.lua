...
function ui.init(parent)
	...
	GUI:setTag(Image_1_0, 161.0)

	-- Create Text_1
	local Text_1 = GUI:Text_Create(Panel_1, "Text_1", 85.00, 390.00, 16.0, "#ffffff", [[竞拍道具]])
	GUI:setChineseName(Text_1, "通用标题_竞拍道具_文本")
	GUI:setAnchorPoint(Text_1, 0.50, 0.50)
	GUI:setTouchEnabled(Text_1, false)
	GUI:setTag(Text_1, 218.0)
	GUI:Text_enableOutline(Text_1, "#000000", 1.0)

	-- Create Text_1_0
	local Text_1_0 = GUI:Text_Create(Panel_1, "Text_1_0", 275.00, 390.00, 16.0, "#ffffff", [[剩余时间]])
	GUI:setChineseName(Text_1_0, "通用标题_剩余时间_文本")
	GUI:setAnchorPoint(Text_1_0, 0.50, 0.50)
	GUI:setTouchEnabled(Text_1_0, false)
	GUI:setTag(Text_1_0, 217.0)
	GUI:Text_enableOutline(Text_1_0, "#000000", 1.0)

	-- Create Text_1_1
	local Text_1_1 = GUI:Text_Create(Panel_1, "Text_1_1", 467.00, 390.00, 16.0, "#ffffff", [[竞拍价格]])
	GUI:setChineseName(Text_1_1, "通用标题_竞拍价格_文本")
	GUI:setAnchorPoint(Text_1_1, 0.50, 0.50)
	GUI:setTouchEnabled(Text_1_1, false)
	GUI:setTag(Text_1_1, 216.0)
	GUI:Text_enableOutline(Text_1_1, "#000000", 1.0)

	-- Create Text_1_2
	local Text_1_2 = GUI:Text_Create(Panel_1, "Text_1_2", 660.00, 390.00, 16.0, "#ffffff", [[一口价]])
	GUI:setChineseName(Text_1_2, "通用标题_一口价_文本")
	GUI:setAnchorPoint(Text_1_2, 0.50, 0.50)
	GUI:setTouchEnabled(Text_1_2, false)
	GUI:setTag(Text_1_2, 215.0)
	GUI:Text_enableOutline(Text_1_2, "#000000", 1.0)

	-- Create ListView_items
	local ListView_items = GUI:ListView_Create(Panel_1, "ListView_items", 366.00, 0.00, 730.00, 373.00, 1.0)
	GUI:ListView_setGravity(ListView_items, 5.0)
	...
	GUI:setTag(ListView_items, 300.0)
	...
	GUI:setTag(Image_empty, 310.0)

	-- Create TextMaxTips
	local TextMaxTips = GUI:Text_Create(Panel_1, "TextMaxTips", 600.00, 20.00, 16.0, "#ffe400", [[我的竞拍只显示100条竞拍]])
	GUI:setChineseName(TextMaxTips, "通用标题_我的竞拍上限提示")
	GUI:setTouchEnabled(TextMaxTips, false)
	GUI:setTag(TextMaxTips, -1.0)
	GUI:setVisible(TextMaxTips, false)
	GUI:Text_enableOutline(TextMaxTips, "#000000", 1.0)
end
return ui