...
function ui.init(parent)
	...
	-- Create TitleText
	local TitleText = GUI:Text_Create(FrameLayout, "TitleText", 36.00, 498.00, 20, "#d8c8ae", [[拍卖行]])
	...
	local ListView_group = GUI:ListView_Create(FrameLayout, "ListView_group", 35.00, 484.00, 490.00, 35.00, 2)
	...
	-- Create Panel_search
	local Panel_search = GUI:Layout_Create(FrameLayout, "Panel_search", 745.00, 448.00, 220.00, 35.00, false)
