...
function ui.init(parent)
	...
	-- Create Panel_bg
	local Panel_bg = GUI:Layout_Create(Node, "Panel_bg", 0.00, 0.00, 120.00, 50.00, false)
	...
	-- Create Node_item
	local Node_item = GUI:Layout_Create(Panel_bg, "Node_item", 22.00, 25.00, 0.00, 0.00, false)
	...
	-- Create Text_count
	local Text_count = GUI:Text_Create(Panel_bg, "Text_count", 42.00, 26.00, 16, "#ffffff", [[666666]])
