...
function ui.init(parent)
	...
	GUI:setTag(Panel_items, 262.0)

	-- Create Text_tile
	local Text_tile = GUI:Text_Create(Panel_items, "Text_tile", 225.00, 345.00, 16.0, "#ebf291", [[寄售货架]])
	GUI:setChineseName(Text_tile, "拍卖行_寄售货架_文本")
	GUI:setAnchorPoint(Text_tile, 0.50, 0.50)
	GUI:setTouchEnabled(Text_tile, false)
	GUI:setTag(Text_tile, 90.0)
	GUI:Text_enableOutline(Text_tile, "#111111", 1.0)

	-- Create ScrollView_items
	local ScrollView_items = GUI:ScrollView_Create(Panel_items, "ScrollView_items", 225.00, 331.00, 450.00, 330.00, 1.0)
	...
	GUI:setTag(ScrollView_items, 265.0)
	...
	GUI:setTag(Panel_bag, 266.0)

	-- Create Text_tile_0
	local Text_tile_0 = GUI:Text_Create(Panel_bag, "Text_tile_0", 135.00, 345.00, 16.0, "#ebf291", [[选择寄售道具]])
	...
	GUI:setTag(Text_tile_0, 147.0)
	GUI:Text_enableOutline(Text_tile_0, "#111111", 1.0)

	-- Create ScrollView_bag
	local ScrollView_bag = GUI:ScrollView_Create(Panel_bag, "ScrollView_bag", 135.00, 331.00, 270.00, 330.00, 1.0)
	...
	GUI:setTag(ScrollView_bag, 267.0)
end
return ui