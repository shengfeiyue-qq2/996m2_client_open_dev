...
function ui.init(parent)
	...
	GUI:Button_setTitleFontSize(Button_page1, 14.0)
	GUI:Button_titleEnableOutline(Button_page1, "#000000", 1.0)
	...
	GUI:setTag(Button_page1, -1.0)

	-- Create PageText
	local PageText = GUI:Text_Create(Button_page1, "PageText", 20.00, 60.00, 18.0, "#ffffff", [[一]])
	GUI:setChineseName(PageText, "背包_第一页_文本")
	GUI:setAnchorPoint(PageText, 0.50, 0.50)
	GUI:setTouchEnabled(PageText, false)
	GUI:setTag(PageText, -1.0)
	GUI:Text_enableOutline(PageText, "#000000", 1.0)
	...
	GUI:Button_setTitleFontSize(Button_page2, 14.0)
	GUI:Button_titleEnableOutline(Button_page2, "#000000", 1.0)
	...
	GUI:setTag(Button_page2, -1.0)

	-- Create PageText
	local PageText = GUI:Text_Create(Button_page2, "PageText", 20.00, 60.00, 18.0, "#ffffff", [[二]])
	...
	GUI:Button_setTitleFontSize(Button_page3, 14.0)
	GUI:Button_titleEnableOutline(Button_page3, "#000000", 1.0)
	...
	GUI:setTag(Button_page3, -1.0)

	-- Create PageText
	local PageText = GUI:Text_Create(Button_page3, "PageText", 20.00, 60.00, 18.0, "#ffffff", [[三]])
	...
	GUI:Button_setTitleFontSize(Button_page4, 14.0)
	GUI:Button_titleEnableOutline(Button_page4, "#000000", 1.0)
	...
	GUI:setTag(Button_page4, -1.0)

	-- Create PageText
	local PageText = GUI:Text_Create(Button_page4, "PageText", 20.00, 60.00, 18.0, "#ffffff", [[四]])
	...
	GUI:Button_setTitleFontSize(Button_page5, 14.0)
	GUI:Button_titleEnableOutline(Button_page5, "#000000", 1.0)
	...
	GUI:setTag(Button_page5, -1.0)

	-- Create PageText
	local PageText = GUI:Text_Create(Button_page5, "PageText", 20.00, 60.00, 18.0, "#ffffff", [[五]])
	...
	GUI:Button_setScale9Slice(Button_close, 9, 8.0, 15, 13.0)
	...
	GUI:setTag(Button_close, 8.0)

	-- Create Image_gold
	local Image_gold = GUI:Image_Create(Panel_1, "Image_gold", 27.00, 102.00, "res/private/bag_ui/bag_ui_mobile/1900015220.png")
	GUI:setChineseName(Image_gold, "背包_金币图片")
	GUI:setAnchorPoint(Image_gold, 0.50, 0.50)
	GUI:setTouchEnabled(Image_gold, true)
	GUI:setTag(Image_gold, 5.0)
	...
	GUI:setContentSize(Button_store_hero_bag, 120.0, 29.0)
	...
	GUI:Button_setTitleFontSize(Button_store_hero_bag, 18.0)
	GUI:Button_titleEnableOutline(Button_store_hero_bag, "#000000", 1.0)
	...
	GUI:setTag(Button_store_hero_bag, 17.0)

	-- Create Panel_items
	local Panel_items = GUI:ScrollView_Create(Panel_1, "Panel_items", 24.00, 452.00, 500.00, 320.00, 1.0)
	GUI:ScrollView_setInnerContainerSize(Panel_items, 500.00, 320.00)
	GUI:setChineseName(Panel_items, "背包_物品列表")
	GUI:setAnchorPoint(Panel_items, 0.00, 1.00)
	GUI:setTouchEnabled(Panel_items, true)
	GUI:setTag(Panel_items, -1.0)
	...
	GUI:setTag(Panel_addItems, 10.0)
end
return ui