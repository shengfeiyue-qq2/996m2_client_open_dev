...
function ui.init(parent)
	...
	-- Create Panel_items
	local Panel_items = GUI:ScrollView_Create(Panel_1, "Panel_items", 32.00, 316.00, 338.00, 214.00, 1)
	GUI:ScrollView_setInnerContainerSize(Panel_items, 340.00, 214.00)
