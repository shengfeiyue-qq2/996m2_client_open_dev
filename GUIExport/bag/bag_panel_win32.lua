...
function ui.init(parent)
	...
	GUI:Button_setTitleFontSize(Button_store_hero_bag, 16)
	GUI:Button_titleEnableOutline(Button_store_hero_bag, "#000000", 1)
	GUI:setAnchorPoint(Button_store_hero_bag, 0.50, 0.50)
	GUI:setScaleX(Button_store_hero_bag, 0.75)
	GUI:setScaleY(Button_store_hero_bag, 0.75)
	GUI:setTouchEnabled(Button_store_hero_bag, true)
	GUI:setTag(Button_store_hero_bag, 17)

	-- Create ScrollView_items
	local ScrollView_items = GUI:ScrollView_Create(Panel_1, "ScrollView_items", 31.00, 316.00, 338.00, 214.00, 1)
