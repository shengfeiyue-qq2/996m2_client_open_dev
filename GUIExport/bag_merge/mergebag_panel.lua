...
function ui.init(parent)
	...
	-- Create Image_gold
	local Image_gold = GUI:Image_Create(Panel_1, "Image_gold", 30.00, 102.00, "res/private/bag_ui_mobile/1900015220.png")
	...
	-- Create BtnPlayer
	local BtnPlayer = GUI:Button_Create(Panel_1, "BtnPlayer", 540.00, 320.00, "res/public/1900000641.png")
	...
	-- Create BtnText
	local BtnText = GUI:Text_Create(BtnPlayer, "BtnText", 13.00, 65.00, 16, "#ffffff", [[主
角]])
	...
	-- Create TouchSize
	local TouchSize = GUI:Layout_Create(BtnPlayer, "TouchSize", 0.00, 92.00, 33.00, 75.00, false)
	GUI:setAnchorPoint(TouchSize, 0.00, 1.00)
	GUI:setTouchEnabled(TouchSize, true)
	GUI:setTag(TouchSize, -1)

	-- Create BtnHero
	local BtnHero = GUI:Button_Create(Panel_1, "BtnHero", 540.00, 245.00, "res/public/1900000641.png")
	...
	-- Create BtnText
	local BtnText = GUI:Text_Create(BtnHero, "BtnText", 13.00, 65.00, 16, "#ffffff", [[英
雄]])
	GUI:setAnchorPoint(BtnText, 0.50, 0.50)
	GUI:setTouchEnabled(BtnText, false)
	GUI:setTag(BtnText, -1)
	...
	-- Create TouchSize
	local TouchSize = GUI:Layout_Create(BtnHero, "TouchSize", 0.00, 92.00, 33.00, 75.00, false)
	GUI:setAnchorPoint(TouchSize, 0.00, 1.00)
	GUI:setTouchEnabled(TouchSize, true)
	GUI:setTag(TouchSize, -1)
end
