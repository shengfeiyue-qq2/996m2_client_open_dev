...
function ui.init(parent)
	...
	-- Create Button_quick
	local Button_quick = GUI:Button_Create(Panel_group, "Button_quick", 74.20, 30.00, "res/private/chat/1900012861.png")
	...
	-- Create Button_emoji
	local Button_emoji = GUI:Button_Create(Panel_group, "Button_emoji", 148.40, 30.00, "res/private/chat/1900012853.png")
	...
	-- Create Button_items
	local Button_items = GUI:Button_Create(Panel_group, "Button_items", 222.60, 30.00, "res/private/chat/1900012857.png")
	...
	local Button_position = GUI:Button_Create(Panel_group, "Button_position", 296.80, 30.00, "res/private/chat/1900012858.png")
