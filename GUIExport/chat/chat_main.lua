...
function ui.init(parent)
	...
	GUI:Image_setScale9Slice(Image_list_bg, 138, 138.0, 172, 172.0)
	GUI:setContentSize(Image_list_bg, 327.0, 485.0)
	...
	GUI:setTag(Image_list_bg, 149.0)

	-- Create ListView_receive
	local ListView_receive = GUI:ListView_Create(Panel_bg, "ListView_receive", 0.00, 635.00, 115.00, 484.00, 1.0)
	GUI:ListView_setGravity(ListView_receive, 5.0)
	...
	GUI:setTag(ListView_receive, 75.0)

	-- Create ListView_cells
	local ListView_cells = GUI:ListView_Create(Panel_bg, "ListView_cells", 124.00, 634.00, 320.00, 480.00, 1.0)
	...
	GUI:setTag(ListView_cells, 92.0)

	-- Create ListView_ex
	local ListView_ex = GUI:ListView_Create(Panel_bg, "ListView_ex", 124.00, 634.00, 320.00, 90.00, 1.0)
	GUI:ListView_setGravity(ListView_ex, 5.0)
	GUI:setChineseName(ListView_ex, "聊天_公告位置")
	GUI:setAnchorPoint(ListView_ex, 0.00, 1.00)
	GUI:setTouchEnabled(ListView_ex, false)
	GUI:setTag(ListView_ex, 43.0)
	...
	GUI:setTag(Image_close, 41.0)

	-- Create Button_close
	local Button_close = GUI:Button_Create(Panel_bg, "Button_close", 483.00, 640.00, "res/private/chat/1900012802.png")
	GUI:Button_setScale9Slice(Button_close, 8, 8.0, 11, 11.0)
	GUI:setContentSize(Button_close, 83.0, 95.0)
	...
	GUI:setTag(Panel_input, 109.0)

	-- Create Image_input
	local Image_input = GUI:Image_Create(Panel_input, "Image_input", 9.00, 32.00, "res/private/chat/1900012805.png")
	GUI:Image_setScale9Slice(Image_input, 50, 50.0, 10, 10.0)
	GUI:setContentSize(Image_input, 355.0, 40.0)
	...
	GUI:setTag(Image_channel, 154.0)
	...
	GUI:setTag(Image_33, 152.0)

	-- Create TextField_input
	local TextField_input = GUI:TextInput_Create(Panel_input, "TextField_input", 278.00, 32.00, 155.00, 33.00, 24.0)
	...
	GUI:TextInput_setMaxLength(TextField_input, 30.0)
	...
	GUI:setTag(Image_target, 97.0)

	-- Create Text_target
	local Text_target = GUI:Text_Create(Image_target, "Text_target", 5.00, 13.00, 18.0, "#ffff00", [[玩家名字八个字]])
	GUI:setChineseName(Text_target, "聊天_目标对象")
	GUI:setAnchorPoint(Text_target, 0.00, 0.50)
	GUI:setTouchEnabled(Text_target, false)
	GUI:setTag(Text_target, 40.0)
	GUI:Text_enableOutline(Text_target, "#000000", 1.0)
	...
	GUI:setTag(Image_target_a, 98.0)
	...
	GUI:Button_setTitleFontSize(Button_send, 18.0)
	GUI:Button_titleEnableOutline(Button_send, "#111111", 2.0)
	GUI:setChineseName(Button_send, "聊天_发送_按钮")
	GUI:setAnchorPoint(Button_send, 0.50, 0.50)
	GUI:setTouchEnabled(Button_send, true)
	GUI:setTag(Button_send, 155.0)
	...
	GUI:Button_setTitleFontSize(Button_input_2, 18.0)
	GUI:Button_titleEnableOutline(Button_input_2, "#111111", 2.0)
	...
	GUI:setTag(Button_input_2, 27.0)
	...
	GUI:Button_setTitleFontSize(Button_input_3, 18.0)
	GUI:Button_titleEnableOutline(Button_input_3, "#111111", 2.0)
	...
	GUI:setTag(Button_input_3, 140.0)
	...
	GUI:Button_setTitleFontSize(Button_input_4, 18.0)
	GUI:Button_titleEnableOutline(Button_input_4, "#111111", 2.0)
	...
	GUI:setTag(Button_input_4, 141.0)
	...
	GUI:Button_setTitleFontSize(Button_input_5, 18.0)
	GUI:Button_titleEnableOutline(Button_input_5, "#111111", 2.0)
	...
	GUI:setTag(Button_input_5, 41.0)
	...
	GUI:setTag(Layout_check_auto_shout, -1.0)

	-- Create Text_title
	local Text_title = GUI:Text_Create(Layout_check_auto_shout, "Text_title", 34.00, 4.00, 18.0, "#10ff00", [[自动]])
	GUI:setTouchEnabled(Text_title, false)
	GUI:setTag(Text_title, -1.0)
	GUI:Text_enableOutline(Text_title, "#000000", 1.0)
	...
	GUI:setTag(ImageView_select1, -1.0)
	...
	GUI:setTag(Panel_channel, 186.0)

	-- Create Image_channel
	local Image_channel = GUI:Image_Create(Panel_channel, "Image_channel", 45.00, 119.00, "res/public/1900000677.png")
	GUI:Image_setScale9Slice(Image_channel, 19, 19.0, 15, 15.0)
	GUI:setContentSize(Image_channel, 90.0, 238.0)
	GUI:setIgnoreContentAdaptWithSize(Image_channel, false)
	GUI:setChineseName(Image_channel, "聊天_聊天频道_背景图")
	GUI:setAnchorPoint(Image_channel, 0.50, 0.50)
	GUI:setTouchEnabled(Image_channel, false)
	GUI:setTag(Image_channel, 187.0)

	-- Create ListView_channel
	local ListView_channel = GUI:ListView_Create(Panel_channel, "ListView_channel", 45.00, 119.00, 90.00, 234.00, 1.0)
	...
	GUI:setTag(ListView_channel, 188.0)
	...
	GUI:setTag(Image_private, 191.0)
	...
	GUI:Layout_setBackGroundImageScale9Slice(Panel_drop, 0, 82.0, 0, 449.0)
	GUI:setTouchEnabled(Panel_drop, false)
	GUI:setTag(Panel_drop, -1.0)

	-- Create List_drop_type
	local List_drop_type = GUI:ListView_Create(Panel_drop, "List_drop_type", 1.00, 0.00, 80.00, 446.00, 1.0)
	GUI:ListView_setGravity(List_drop_type, 5.0)
	GUI:ListView_setItemsMargin(List_drop_type, 5.0)
	GUI:setTouchEnabled(List_drop_type, true)
	GUI:setTag(List_drop_type, -1.0)
	...
	GUI:Layout_setBackGroundImageScale9Slice(Panel_drop_switch, 0, 82.0, 0, 33.0)
	GUI:setTouchEnabled(Panel_drop_switch, true)
	GUI:setTag(Panel_drop_switch, -1.0)
	...
	GUI:setOpacity(Image_drop_arrow, 100.0)
	GUI:setTouchEnabled(Image_drop_arrow, false)
	GUI:setTag(Image_drop_arrow, -1.0)
	...
	GUI:Image_setScale9Slice(Image_targets, 21, 21.0, 34, 32.0)
	GUI:setContentSize(Image_targets, 139.0, 204.0)
	...
	GUI:setTag(Image_targets, 100.0)

	-- Create ListView_targets
	local ListView_targets = GUI:ListView_Create(Panel_targets, "ListView_targets", 0.00, 0.00, 135.00, 200.00, 1.0)
	GUI:ListView_setGravity(ListView_targets, 5.0)
	GUI:setChineseName(ListView_targets, "聊天对象_列表")
	GUI:setTouchEnabled(ListView_targets, true)
	GUI:setTag(ListView_targets, 39.0)
end
return ui