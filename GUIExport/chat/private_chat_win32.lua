...
function ui.init(parent)
	...
	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(Scene, "Panel_1", 568.00, 320.00, 400.00, 260.00, false)
	...
	-- Create Image_bg
	local Image_bg = GUI:Image_Create(Panel_1, "Image_bg", 200.00, 130.00, "res/private/main-win32/chat/01150.png")
	GUI:setContentSize(Image_bg, 400, 260)
	...
	-- Create Button_close
	local Button_close = GUI:Button_Create(Panel_1, "Button_close", 376.00, 238.00, "res/public_win32/btn_02.png")
	GUI:Button_setScale9Slice(Button_close, 6, 6, 11, 11)
	GUI:setContentSize(Button_close, 16, 26)
	...
	-- Create Image_2
	local Image_2 = GUI:Image_Create(Panel_1, "Image_2", 370.00, 130.00, "res/private/main-win32/chat/00291.png")
	...
	-- Create Image_bar
	local Image_bar = GUI:Image_Create(Image_2, "Image_bar", 9.00, 88.00, "res/private/main-win32/chat/00579.png")
	...
	-- Create CheckBox_1
	local CheckBox_1 = GUI:CheckBox_Create(Panel_1, "CheckBox_1", 27.00, 30.00, "res/public/1900000654.png", "res/public/1900000655.png")
	...
	-- Create Text_1
	local Text_1 = GUI:Text_Create(Panel_1, "Text_1", 62.00, 30.00, 12, "#ffffff", [[自动回复]])
	...
	GUI:setContentSize(Image_inputbg, 288, 24)
	...
	-- Create TextField_1
	local TextField_1 = GUI:TextInput_Create(Image_inputbg, "TextField_1", 144.00, 12.00, 282.00, 22.00, 12)
