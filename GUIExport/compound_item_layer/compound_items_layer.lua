...
function ui.init(parent)
	...
	GUI:setTag(Image_frame_bg, 61.0)
	...
	GUI:setTag(Image_frame_bg2, 63.0)

	-- Create Text_frame_title
	local Text_frame_title = GUI:Text_Create(Panel_1, "Text_frame_title", 104.00, 498.00, 20.0, "#d8c8ae", [[合成]])
	...
	GUI:setTag(Text_frame_title, 64.0)
	...
	local ListView_list1 = GUI:ListView_Create(Panel_bg, "ListView_list1", 1.00, 1.00, 120.00, 440.00, 1.0)
	...
	GUI:setContentSize(Image_line1, 2.0, 444.0)
	...
	GUI:setContentSize(Image_line2, 2.0, 444.0)
	...
	local ListView_list2 = GUI:ListView_Create(Panel_bg, "ListView_list2", 125.00, 0.00, 177.00, 440.00, 1.0)
	...
	-- Create Image_material
	local Image_material = GUI:Image_Create(Image_show1, "Image_material", 150.00, 5.00, "res/private/compound_items_ui/word_clhczy_02.png")
	GUI:setChineseName(Image_material, "合成操作_材料消耗_图片")
	GUI:setAnchorPoint(Image_material, 0.50, 0.50)
	GUI:setTouchEnabled(Image_material, false)
	GUI:setTag(Image_material, 15.0)
	...
	-- Create Image_obtain
	local Image_obtain = GUI:Image_Create(Image_show2, "Image_obtain", 150.00, 5.00, "res/private/compound_items_ui/word_clhczy_01.png")
	GUI:setChineseName(Image_obtain, "合成操作_合成获得_图片")
	GUI:setAnchorPoint(Image_obtain, 0.50, 0.50)
	GUI:setTouchEnabled(Image_obtain, false)
	GUI:setTag(Image_obtain, 13.0)
	...
	GUI:setTag(Panel_material, 38.0)
	...
	GUI:setTag(Image_material_bg, 110.0)

	-- Create ListView_2
	local ListView_2 = GUI:ListView_Create(Panel_material, "ListView_2", 210.00, 125.00, 300.00, 64.00, 2.0)
	...
	GUI:setTag(Image_get_bg, 113.0)

	-- Create ListView_get
	local ListView_get = GUI:ListView_Create(Panel_get, "ListView_get", 210.00, 125.00, 300.00, 64.00, 2.0)
	...
	GUI:setTag(Button_right2, 123.0)
	...
	GUI:setTag(Panel_money, 117.0)

	-- Create ListView_money
	local ListView_money = GUI:ListView_Create(Panel_money, "ListView_money", 150.00, 50.00, 150.00, 60.00, 1.0)
	...
	GUI:setTag(ListView_money, 120.0)
