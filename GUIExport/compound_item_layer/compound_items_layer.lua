...
function ui.init(parent)
	...
	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(Node, "Panel_1", 518.00, 320.00, 790.00, 536.00, false)
	GUI:setAnchorPoint(Panel_1, 0.50, 0.50)
	GUI:setTouchEnabled(Panel_1, true)
	GUI:setTag(Panel_1, 62)

	-- Create Image_frame_bg
	local Image_frame_bg = GUI:Image_Create(Panel_1, "Image_frame_bg", 0.00, 0.00, "res/private/compound_items_ui/1900000610.png")
	GUI:setTouchEnabled(Image_frame_bg, false)
	GUI:setTag(Image_frame_bg, 61)

	-- Create Image_frame_3
	local Image_frame_3 = GUI:Image_Create(Panel_1, "Image_frame_3", 27.00, 513.00, "res/private/compound_items_ui/1900000610_1.png")
	GUI:setAnchorPoint(Image_frame_3, 0.50, 0.50)
	GUI:setTouchEnabled(Image_frame_3, false)
	GUI:setTag(Image_frame_3, 63)

	-- Create Text_frame_title
	local Text_frame_title = GUI:Text_Create(Panel_1, "Text_frame_title", 32.00, 509.00, 20, "#d8c8ae", [[合成]])
	...
	-- Create Button_close
	local Button_close = GUI:Button_Create(Panel_1, "Button_close", 781.00, 535.00, "res/private/compound_items_ui/1900000510.png")
	...
	-- Create Panel_bg
	local Panel_bg = GUI:Layout_Create(Panel_1, "Panel_bg", 30.00, 40.00, 732.00, 445.00, false)
	...
	-- Create Image_7
	local Image_7 = GUI:Image_Create(Panel_show, "Image_7", 210.00, 386.00, "res/private/compound_items_ui/word_sxbt_05.png")
	...
	-- Create Image_6
	local Image_6 = GUI:Image_Create(Panel_show, "Image_6", 210.00, 385.00, "res/private/compound_items_ui/word_clhczy_02.png")
	GUI:setAnchorPoint(Image_6, 0.50, 0.50)
	GUI:setTouchEnabled(Image_6, false)
	GUI:setTag(Image_6, 15)

	-- Create Image_5
	local Image_5 = GUI:Image_Create(Panel_show, "Image_5", 208.00, 223.00, "res/private/compound_items_ui/word_sxbt_05.png")
	...
	-- Create Image_4
	local Image_4 = GUI:Image_Create(Panel_show, "Image_4", 208.00, 222.00, "res/private/compound_items_ui/word_clhczy_01.png")
	...
	-- Create Image_2
	local Image_2 = GUI:Image_Create(Panel_material, "Image_2", 210.00, 126.00, "res/private/compound_items_ui/cailiao_dikuang.png")
	GUI:setAnchorPoint(Image_2, 0.50, 0.00)
	GUI:setTouchEnabled(Image_2, false)
	GUI:setTag(Image_2, 110)

	-- Create Image_8
	local Image_8 = GUI:Image_Create(Panel_material, "Image_8", 210.00, 91.00, "res/private/compound_items_ui/icon_arror_04.png")
	...
	GUI:setTag(Image_8, 39)

	-- Create Node_cost1
	local Node_cost1 = GUI:Node_Create(Panel_material, "Node_cost1", 207.00, 160.00)
	GUI:setAnchorPoint(Node_cost1, 0.50, 0.50)
	GUI:setTag(Node_cost1, 40)

	-- Create ListView_2
	local ListView_2 = GUI:ListView_Create(Panel_material, "ListView_2", 210.00, 125.00, 250.00, 65.00, 2)
	...
	-- Create Node_get
	local Node_get = GUI:Node_Create(Panel_get, "Node_get", 207.00, 160.00)
	GUI:setAnchorPoint(Node_get, 0.50, 0.50)
	GUI:setTag(Node_get, 115)

	-- Create ListView_get
	local ListView_get = GUI:ListView_Create(Panel_get, "ListView_get", 210.00, 125.00, 250.00, 65.00, 2)
	...
	-- Create Button_left
	local Button_left = GUI:Button_Create(Panel_get, "Button_left", 42.00, 160.00, "res/private/compound_items_ui/btn_szjm_01_1.png")
	GUI:Button_setScale9Slice(Button_left, 15, 15, 12, 10)
	GUI:setContentSize(Button_left, 47, 61)
	GUI:setIgnoreContentAdaptWithSize(Button_left, false)
	GUI:Button_setTitleText(Button_left, "")
	...
	GUI:setAnchorPoint(Button_left, 0.50, 0.50)
	GUI:setTouchEnabled(Button_left, true)
	GUI:setTag(Button_left, 122)

	-- Create Button_right
	local Button_right = GUI:Button_Create(Panel_get, "Button_right", 377.00, 160.00, "res/private/compound_items_ui/btn_szjm_01_1.png")
	GUI:Button_setScale9Slice(Button_right, 15, 15, 12, 10)
	GUI:setContentSize(Button_right, 47, 61)
	GUI:setIgnoreContentAdaptWithSize(Button_right, false)
	GUI:Button_setTitleText(Button_right, "")
	...
	-- Create Text_1
	local Text_1 = GUI:Text_Create(Panel_money, "Text_1", 121.00, 73.00, 16, "#ffffff", [[消耗：]])
	GUI:setAnchorPoint(Text_1, 0.50, 0.50)
	GUI:setTouchEnabled(Text_1, false)
	GUI:setTag(Text_1, 121)
	GUI:Text_enableOutline(Text_1, "#111111", 1)

	-- Create ListView_money
	local ListView_money = GUI:ListView_Create(Panel_money, "ListView_money", 110.00, 54.00, 250.00, 58.00, 1)
	...
	local Button_compound = GUI:Button_Create(Panel_show, "Button_compound", 210.00, 35.00, "res/public/1900000680.png")
