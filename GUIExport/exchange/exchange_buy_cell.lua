...
function ui.init(parent)
	...
	-- Create Text_p_num
	local Text_p_num = GUI:Text_Create(Panel_cell, "Text_p_num", 214.00, 40.00, 16, "#ffffff", [[数量]])
	...
	-- Create Text_single
	local Text_single = GUI:Text_Create(Panel_cell, "Text_single", 309.00, 40.00, 16, "#ffffff", [[单价]])
	...
	-- Create Text_total
	local Text_total = GUI:Text_Create(Panel_cell, "Text_total", 408.00, 40.00, 16, "#ffffff", [[总价]])
	...
	GUI:Button_setTitleText(Button_oper, "购买")
	...
	-- Create Text_coin
	local Text_coin = GUI:Text_Create(Panel_cell, "Text_coin", 488.00, 40.00, 16, "#ffffff", [[货币]])
	GUI:setAnchorPoint(Text_coin, 0.50, 0.50)
	GUI:setTouchEnabled(Text_coin, false)
	GUI:setTag(Text_coin, 104)
