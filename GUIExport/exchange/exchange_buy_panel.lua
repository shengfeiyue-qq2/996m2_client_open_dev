...
function ui.init(parent)
	...
	-- Create Panel_2
	local Panel_2 = GUI:Layout_Create(Scene, "Panel_2", 621.00, 326.00, 395.00, 595.00, false)
	...
	-- Create Image_bg
	local Image_bg = GUI:Image_Create(Panel_2, "Image_bg", 196.00, 298.00, "res/public/1900000601.png")
	GUI:Image_setScale9Slice(Image_bg, 15, 15, 16, 14)
	GUI:setContentSize(Image_bg, 395, 595)
	...
	-- Create Button_close
	local Button_close = GUI:Button_Create(Panel_2, "Button_close", 395.00, 574.00, "res/public/1900000510.png")
	...
	-- Create Text_title
	local Text_title = GUI:Text_Create(Panel_2, "Text_title", 200.00, 570.00, 18, "#f8e6c6", [[购买道具]])
	...
	-- Create Image_14
	local Image_14 = GUI:Image_Create(Panel_2, "Image_14", 200.00, 552.00, "res/public/1900000667.png")
	...
	-- Create Image_icon
	local Image_icon = GUI:Image_Create(Panel_2, "Image_icon", 78.00, 479.00, "res/public/1900000664.png")
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Panel_2, "Text_name", 80.00, 525.00, 16, "#ffffff", [[装备名称七个字]])
	...
	-- Create Image_16
	local Image_16 = GUI:Image_Create(Panel_2, "Image_16", 192.00, 374.00, "res/public/1900000668.png")
	...
	local Button_countadd = GUI:Button_Create(Panel_2, "Button_countadd", 298.00, 372.00, "res/public/1900000621.png")
	...
	local Button_countsub = GUI:Button_Create(Panel_2, "Button_countsub", 85.00, 372.00, "res/public/1900000620.png")
	...
	local Button_submit = GUI:Button_Create(Panel_2, "Button_submit", 183.00, 39.00, "res/public/1900000660.png")
	...
	-- Create Text_6
	local Text_6 = GUI:Text_Create(Panel_2, "Text_6", 198.00, 512.00, 16, "#ffffff", [[数量]])
	...
	-- Create Image_22
	local Image_22 = GUI:Image_Create(Panel_2, "Image_22", 300.00, 510.00, "res/public/1900000668.png")
	...
	-- Create Image_23
	local Image_23 = GUI:Image_Create(Panel_2, "Image_23", 300.00, 510.00, "res/private/main/assist/1900000678.png")
	...
	-- Create Text_itemNum
	local Text_itemNum = GUI:Text_Create(Panel_2, "Text_itemNum", 230.00, 500.00, 16, "#ffffff", [[222222000000]])
	GUI:setTouchEnabled(Text_itemNum, false)
	GUI:setTag(Text_itemNum, 228)
	GUI:Text_enableOutline(Text_itemNum, "#000000", 1)

	-- Create Text_7
	local Text_7 = GUI:Text_Create(Panel_2, "Text_7", 198.00, 470.00, 16, "#ffffff", [[单价]])
	...
	-- Create Image_24
	local Image_24 = GUI:Image_Create(Panel_2, "Image_24", 300.00, 472.00, "res/public/1900000668.png")
	...
	local Node_money_single = GUI:Node_Create(Panel_2, "Node_money_single", 242.00, 472.00)
	...
	-- Create Text_single
	local Text_single = GUI:Text_Create(Panel_2, "Text_single", 262.00, 462.00, 16, "#ffffff", [[666]])
	GUI:setTouchEnabled(Text_single, false)
	GUI:setTag(Text_single, 260)
	GUI:Text_enableOutline(Text_single, "#000000", 1)

	-- Create Text_8
	local Text_8 = GUI:Text_Create(Panel_2, "Text_8", 180.00, 430.00, 16, "#ffffff", [[总价]])
	...
	-- Create Image_26
	local Image_26 = GUI:Image_Create(Panel_2, "Image_26", 292.00, 434.00, "res/public/1900000668.png")
	...
	-- Create Image_27
	local Image_27 = GUI:Image_Create(Panel_2, "Image_27", 292.00, 434.00, "res/private/main/assist/1900000678.png")
	...
	local Node_money_total = GUI:Node_Create(Panel_2, "Node_money_total", 222.00, 432.00)
	...
	-- Create Text_total
	local Text_total = GUI:Text_Create(Panel_2, "Text_total", 242.00, 424.00, 16, "#ffffff", [[66655]])
	GUI:setTouchEnabled(Text_total, false)
	GUI:setTag(Text_total, 262)
	GUI:Text_enableOutline(Text_total, "#000000", 1)

	-- Create Panel_num
	local Panel_num = GUI:Layout_Create(Panel_2, "Panel_num", 60.00, 66.00, 258.00, 284.00, false)
