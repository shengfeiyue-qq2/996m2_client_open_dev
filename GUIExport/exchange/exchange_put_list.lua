...
function ui.init(parent)
	...
	GUI:setChineseName(Image_1_1, "交易所_装饰条_图片")
	...
	GUI:setChineseName(Image_1_2, "交易所_装饰条_图片")
	...
	GUI:setChineseName(Image_1_3, "交易所_装饰条_图片")
	...
	-- Create Text_tile
	local Text_tile = GUI:Text_Create(Panel_items, "Text_tile", 225.00, 345.00, 16, "#ebf291", [[上架货物]])
	GUI:setChineseName(Text_tile, "交易所_寄售货架_文本")
	...
	GUI:setChineseName(ScrollView_items, "交易所_寄售物品列表")
	...
	-- Create Text_tile_0
	local Text_tile_0 = GUI:Text_Create(Panel_bag, "Text_tile_0", 135.00, 345.00, 16, "#ebf291", [[选择上架道具]])
	GUI:setChineseName(Text_tile_0, "交易所_选择寄售道具_文本")
	...
	GUI:setChineseName(ScrollView_bag, "交易所_背包物品列表")
