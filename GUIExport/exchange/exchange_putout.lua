...
function ui.init(parent)
	...
	-- Create Text_1_0_2
	local Text_1_0_2 = GUI:Text_Create(Panel_2, "Text_1_0_2", 110.00, 210.00, 16, "#ffffff", [[总价：]])
	GUI:setChineseName(Text_1_0_2, "交易所_竞拍价_文本")
	...
	GUI:setChineseName(Image_16_0_0, "交易所_竞拍价输入框_图片")
	...
	GUI:setChineseName(Node_money_bid, "交易所_竞拍货币_节点")
	GUI:setAnchorPoint(Node_money_bid, 0.50, 0.50)
	GUI:setTag(Node_money_bid, 251)

	-- Create Text_price
	local Text_price = GUI:Text_Create(Panel_2, "Text_price", 220.00, 210.00, 16, "#ffffff", [[9999]])
	GUI:setChineseName(Text_price, "交易所_竞拍价价格_文本")
	...
	GUI:setChineseName(Text_remaining, "交易所_竞拍状态倒计时_文本")
