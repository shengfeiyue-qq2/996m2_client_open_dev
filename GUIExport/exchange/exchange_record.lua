...
function ui.init(parent)
	...
	-- Create Image_1_1
	local Image_1_1 = GUI:Image_Create(Panel_1, "Image_1_1", 366.00, 365.00, "res/public/bg_yyxsz_01.png")
	GUI:Image_setScale9Slice(Image_1_1, 93, 93, 0, 0)
	GUI:setContentSize(Image_1_1, 732, 2)
	...
	-- Create Panel_items
	local Panel_items = GUI:Layout_Create(Panel_1, "Panel_items", 652.00, 405.00, 650.00, 355.00, false)
	GUI:setAnchorPoint(Panel_items, 1.00, 1.00)
	GUI:setTouchEnabled(Panel_items, false)
	GUI:setTag(Panel_items, 328)

	-- Create Text_1
	local Text_1 = GUI:Text_Create(Panel_items, "Text_1", 60.00, 338.00, 16, "#ffffff", [[物品名称]])
	...
	-- Create Text_1_0
	local Text_1_0 = GUI:Text_Create(Panel_items, "Text_1_0", 204.00, 338.00, 16, "#ffffff", [[数量]])
	...
	local Text_coin_type = GUI:Text_Create(Panel_items, "Text_coin_type", 600.00, 338.00, 16, "#ffffff", [[全部]])
	...
	-- Create Text_1_2_1
	local Text_1_2_1 = GUI:Text_Create(Panel_items, "Text_1_2_1", 280.00, 338.00, 16, "#ffffff", [[价格]])
	...
	-- Create Text_1_2_2
	local Text_1_2_2 = GUI:Text_Create(Panel_items, "Text_1_2_2", 398.00, 338.00, 16, "#ffffff", [[日期]])
	...
	local ListView_items = GUI:ListView_Create(Panel_items, "ListView_items", 320.00, 0.00, 640.00, 313.00, 1)
	...
	local Image_filter_bg = GUI:Image_Create(Panel_items, "Image_filter_bg", 610.00, 324.00, "res/public/1900000677.png")
	...
	-- Create Text_states
	local Text_states = GUI:Text_Create(Panel_items, "Text_states", 520.00, 338.00, 16, "#ffffff", [[操作]])
	...
	-- Create Text_tips
	local Text_tips = GUI:Text_Create(Panel_1, "Text_tips", 125.00, 21.00, 16, "#ffffff", [[出售/购买记录各记录最多为30条]])
