...
function ui.init(parent)
	-- Create Panel_cell
	local Panel_cell = GUI:Layout_Create(parent, "Panel_cell", 640.00, 290.00, 640.00, 80.00, false)
	GUI:setAnchorPoint(Panel_cell, 1.00, 1.00)
	GUI:setTouchEnabled(Panel_cell, false)
	GUI:setTag(Panel_cell, 328)

	-- Create Image_bg
	local Image_bg = GUI:Image_Create(Panel_cell, "Image_bg", 6.00, 40.00, "res/public/1900000664.png")
	GUI:setAnchorPoint(Image_bg, 0.00, 0.50)
	GUI:setTouchEnabled(Image_bg, false)
	GUI:setTag(Image_bg, -1)

	-- Create Text_name
	local Text_name = GUI:Text_Create(Panel_cell, "Text_name", 78.00, 40.00, 16, "#ffffff", [[物品名称]])
	...
	-- Create Text_p_num
	local Text_p_num = GUI:Text_Create(Panel_cell, "Text_p_num", 204.00, 40.00, 16, "#ffffff", [[数量]])
	...
	-- Create Text_total
	local Text_total = GUI:Text_Create(Panel_cell, "Text_total", 288.00, 40.00, 16, "#ffffff", [[价格]])
	...
	-- Create Text_time
	local Text_time = GUI:Text_Create(Panel_cell, "Text_time", 388.00, 40.00, 16, "#ffffff", [[日期]])
	...
	-- Create Text_state
	local Text_state = GUI:Text_Create(Panel_cell, "Text_state", 520.00, 40.00, 16, "#ffffff", [[出售]])
	...
	-- Create Text_coin
	local Text_coin = GUI:Text_Create(Panel_cell, "Text_coin", 600.00, 40.00, 16, "#ffffff", [[货币]])
