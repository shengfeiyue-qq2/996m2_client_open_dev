...
function ui.init(parent)
	...
	-- Create Text_1_0
	local Text_1_0 = GUI:Text_Create(Panel_items, "Text_1_0", 174.00, 310.00, 12, "#ffffff", [[数量]])
	...
	local Text_coin_type = GUI:Text_Create(Panel_items, "Text_coin_type", 408.00, 310.00, 12, "#ffffff", [[全部]])
	...
	-- Create Text_1_2_1
	local Text_1_2_1 = GUI:Text_Create(Panel_items, "Text_1_2_1", 249.00, 310.00, 12, "#ffffff", [[单价]])
	...
	-- Create Text_1_2_2
	local Text_1_2_2 = GUI:Text_Create(Panel_items, "Text_1_2_2", 328.00, 310.00, 12, "#ffffff", [[总价]])
	...
	local Image_filter_bg = GUI:Image_Create(Panel_items, "Image_filter_bg", 408.00, 300.00, "res/public/1900000677.png")
