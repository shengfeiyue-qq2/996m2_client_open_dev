...
function ui.init(parent)
	...
	-- Create Text_p_num
	local Text_p_num = GUI:Text_Create(Panel_cell, "Text_p_num", 174.00, 35.00, 12, "#ffffff", [[数量]])
	...
	-- Create Text_single
	local Text_single = GUI:Text_Create(Panel_cell, "Text_single", 249.00, 35.00, 12, "#ffffff", [[单价]])
	...
	-- Create Text_total
	local Text_total = GUI:Text_Create(Panel_cell, "Text_total", 328.00, 35.00, 12, "#ffffff", [[总价]])
	...
	-- Create Text_coin
	local Text_coin = GUI:Text_Create(Panel_cell, "Text_coin", 408.00, 35.00, 12, "#ffffff", [[货币]])
