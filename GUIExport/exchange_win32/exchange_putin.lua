...
function ui.init(parent)
	...
	-- Create Panel_2
	local Panel_2 = GUI:Layout_Create(Scene, "Panel_2", 621.00, 326.00, 445.00, 430.00, false)
	...
	-- Create Image_bg
	local Image_bg = GUI:Image_Create(Panel_2, "Image_bg", 223.00, 215.00, "res/public/1900000601.png")
	GUI:Image_setScale9Slice(Image_bg, 15, 15, 16, 14)
	GUI:setContentSize(Image_bg, 445, 430)
	...
	-- Create Button_close
	local Button_close = GUI:Button_Create(Panel_2, "Button_close", 446.00, 403.00, "res/public/1900000510.png")
	...
	-- Create Text_title
	local Text_title = GUI:Text_Create(Panel_2, "Text_title", 215.00, 408.00, 12, "#f8e6c6", [[上架道具]])
	...
	-- Create Image_14
	local Image_14 = GUI:Image_Create(Panel_2, "Image_14", 225.00, 392.00, "res/public/1900000667.png")
	...
	-- Create Image_icon
	local Image_icon = GUI:Image_Create(Panel_2, "Image_icon", 87.00, 316.00, "res/public/1900000664.png")
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Panel_2, "Text_name", 87.00, 360.00, 12, "#ffffff", [[装备名称七个字]])
	...
	-- Create Image_16
	local Image_16 = GUI:Image_Create(Panel_2, "Image_16", 291.00, 255.00, "res/public/1900000668.png")
	GUI:Image_setScale9Slice(Image_16, 52, 52, 10, 11)
	GUI:setContentSize(Image_16, 170, 26)
	...
	-- Create Image_17
	local Image_17 = GUI:Image_Create(Image_16, "Image_17", 85.00, 13.00, "res/private/main/assist/1900000678.png")
	GUI:setContentSize(Image_17, 158, 26)
	...
	local Text_selectnum = GUI:Text_Create(Image_16, "Text_selectnum", 78.00, 13.00, 12, "#ffffff", [[1/10]])
	...
	-- Create Image_18
	local Image_18 = GUI:Image_Create(Panel_2, "Image_18", 114.00, 204.00, "res/public/1900000668.png")
	GUI:setContentSize(Image_18, 200, 32)
	...
	-- Create Text_1_0_1
	local Text_1_0_1 = GUI:Text_Create(Image_18, "Text_1_0_1", 90.00, 16.00, 12, "#ffffff", [[在售最低单价：]])
	...
	-- Create Text_price_1
	local Text_price_1 = GUI:Text_Create(Image_18, "Text_price_1", 196.00, 16.00, 12, "#ffffff", [[100元宝]])
	...
	-- Create Image_19
	local Image_19 = GUI:Image_Create(Panel_2, "Image_19", 114.00, 170.00, "res/public/1900000668.png")
	GUI:setContentSize(Image_19, 200, 32)
	...
	-- Create Text_1_0_2
	local Text_1_0_2 = GUI:Text_Create(Image_19, "Text_1_0_2", 90.00, 16.00, 12, "#ffffff", [[最新成交单价：]])
	...
	-- Create Text_price_2
	local Text_price_2 = GUI:Text_Create(Image_19, "Text_price_2", 196.00, 16.00, 12, "#ffffff", [[100元宝]])
	...
	-- Create Image_20
	local Image_20 = GUI:Image_Create(Panel_2, "Image_20", 114.00, 136.00, "res/public/1900000668.png")
	GUI:setContentSize(Image_20, 200, 32)
	...
	-- Create Text_1_0_3
	local Text_1_0_3 = GUI:Text_Create(Image_20, "Text_1_0_3", 90.00, 16.00, 12, "#ffffff", [[挂单最高单价：]])
	...
	-- Create Text_price_3
	local Text_price_3 = GUI:Text_Create(Image_20, "Text_price_3", 196.00, 16.00, 12, "#ffffff", [[1000元宝]])
	...
	-- Create Image_21
	local Image_21 = GUI:Image_Create(Panel_2, "Image_21", 114.00, 136.00, "res/public/1900000668.png")
	GUI:setContentSize(Image_21, 200, 32)
	...
	-- Create Text_1_0_4
	local Text_1_0_4 = GUI:Text_Create(Image_21, "Text_1_0_4", 90.00, 16.00, 12, "#ffffff", [[挂单最低限价：]])
	...
	-- Create Text_price_4
	local Text_price_4 = GUI:Text_Create(Image_21, "Text_price_4", 196.00, 16.00, 12, "#ffffff", [[10000元宝]])
	...
	-- Create Text_1_0
	local Text_1_0 = GUI:Text_Create(Panel_2, "Text_1_0", 78.00, 252.00, 12, "#ffffff", [[出售货币：]])
	...
	-- Create Text_5
	local Text_5 = GUI:Text_Create(Panel_2, "Text_5", 20.00, 62.00, 12, "#ffffff", [[扣除一定的费用作为手续费]])
	...
	local Button_countadd = GUI:Button_Create(Panel_2, "Button_countadd", 398.00, 256.00, "res/public_win32/1900000621.png")
	...
	GUI:setContentSize(Button_countadd, 26, 26)
	...
	local Button_countsub = GUI:Button_Create(Panel_2, "Button_countsub", 189.00, 254.00, "res/public_win32/1900000620.png")
	...
	GUI:setContentSize(Button_countsub, 26, 26)
	...
	local Button_cancel = GUI:Button_Create(Panel_2, "Button_cancel", 142.00, 28.00, "res/public_win32/1900000660.png")
	GUI:Button_setScale9Slice(Button_cancel, 26, 27, 10, 10)
	GUI:setContentSize(Button_cancel, 70, 30)
	...
	local Button_submit = GUI:Button_Create(Panel_2, "Button_submit", 278.00, 28.00, "res/public_win32/1900000660.png")
	...
	GUI:setContentSize(Button_submit, 70, 30)
	...
	local Node_currency = GUI:Node_Create(Panel_2, "Node_currency", 118.00, 254.00)
	...
	local Image_currency = GUI:Image_Create(Panel_2, "Image_currency", 119.00, 241.00, "res/public/1900000677.png")
	...
	local ListView_currency = GUI:ListView_Create(Panel_2, "ListView_currency", 119.00, 241.00, 150.00, 235.00, 1)
	...
	-- Create Text_6
	local Text_6 = GUI:Text_Create(Panel_2, "Text_6", 200.00, 355.00, 12, "#ffffff", [[数量]])
	...
	-- Create Image_22
	local Image_22 = GUI:Image_Create(Panel_2, "Image_22", 288.00, 356.00, "res/public/1900000668.png")
	...
	-- Create Image_23
	local Image_23 = GUI:Image_Create(Panel_2, "Image_23", 288.00, 356.00, "res/private/main/assist/1900000678.png")
	...
	-- Create Text_itemNum
	local Text_itemNum = GUI:Text_Create(Panel_2, "Text_itemNum", 224.00, 347.00, 12, "#ffffff", [[222222000000]])
	GUI:setTouchEnabled(Text_itemNum, false)
	GUI:setTag(Text_itemNum, 228)
	GUI:Text_enableOutline(Text_itemNum, "#000000", 1)

	-- Create Text_7
	local Text_7 = GUI:Text_Create(Panel_2, "Text_7", 200.00, 327.00, 12, "#ffffff", [[单价]])
	...
	-- Create Image_24
	local Image_24 = GUI:Image_Create(Panel_2, "Image_24", 288.00, 326.00, "res/public/1900000668.png")
	...
	-- Create Image_25
	local Image_25 = GUI:Image_Create(Panel_2, "Image_25", 288.00, 326.00, "res/private/main/assist/1900000678.png")
	GUI:setContentSize(Image_25, 140, 26)
	...
	local Node_money_single = GUI:Node_Create(Panel_2, "Node_money_single", 233.00, 326.00)
	...
	-- Create Text_single
	local Text_single = GUI:Text_Create(Panel_2, "Text_single", 262.00, 318.00, 12, "#ffffff", [[666]])
	GUI:setTouchEnabled(Text_single, false)
	GUI:setTag(Text_single, 260)
	GUI:Text_enableOutline(Text_single, "#000000", 1)

	-- Create Text_8
	local Text_8 = GUI:Text_Create(Panel_2, "Text_8", 200.00, 294.00, 12, "#ffffff", [[总价]])
	...
	-- Create Image_26
	local Image_26 = GUI:Image_Create(Panel_2, "Image_26", 288.00, 296.00, "res/public/1900000668.png")
	...
	-- Create Image_27
	local Image_27 = GUI:Image_Create(Panel_2, "Image_27", 288.00, 296.00, "res/private/main/assist/1900000678.png")
	...
	local Node_money_total = GUI:Node_Create(Panel_2, "Node_money_total", 233.00, 296.00)
	...
	-- Create Text_total
	local Text_total = GUI:Text_Create(Panel_2, "Text_total", 262.00, 288.00, 12, "#ffffff", [[66655]])
	GUI:setTouchEnabled(Text_total, false)
	GUI:setTag(Text_total, 262)
	GUI:Text_enableOutline(Text_total, "#000000", 1)

	-- Create Button_num
	local Button_num = GUI:Button_Create(Panel_2, "Button_num", 400.00, 356.00, "res/public_win32/1900000660.png")
	GUI:Button_loadTexturePressed(Button_num, "res/public_win32/1900000661.png")
	GUI:setContentSize(Button_num, 50, 26)
	...
	GUI:Button_setTitleFontSize(Button_num, 12)
	...
	local Button_single = GUI:Button_Create(Panel_2, "Button_single", 400.00, 326.00, "res/public_win32/1900000660.png")
	GUI:Button_loadTexturePressed(Button_single, "res/public_win32/1900000661.png")
	GUI:setContentSize(Button_single, 50, 26)
	...
	GUI:Button_setTitleFontSize(Button_single, 12)
	...
	-- Create Panel_num
	local Panel_num = GUI:Layout_Create(Panel_2, "Panel_num", 211.00, 50.00, 198.00, 184.00, false)
