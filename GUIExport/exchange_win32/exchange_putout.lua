...
function ui.init(parent)
	...
	GUI:setChineseName(Image_bg, "交易所_操作背景图")
	...
	GUI:setChineseName(Text_title, "交易所_下架道具_文本")
	...
	GUI:setChineseName(Image_14, "交易所_装饰条")
	GUI:setAnchorPoint(Image_14, 0.50, 0.50)
	GUI:setTouchEnabled(Image_14, false)
	GUI:setTag(Image_14, 229)

	-- Create Image_icon
	local Image_icon = GUI:Image_Create(Panel_2, "Image_icon", 177.00, 364.00, "res/public_win32/1900000664.png")
	GUI:setChineseName(Image_icon, "交易所_物品图标")
	GUI:setAnchorPoint(Image_icon, 0.50, 0.50)
	GUI:setTouchEnabled(Image_icon, false)
	GUI:setTag(Image_icon, 230)

	-- Create Text_name
	local Text_name = GUI:Text_Create(Panel_2, "Text_name", 177.00, 415.00, 12, "#ffffff", [[装备名称七个字]])
	GUI:setChineseName(Text_name, "交易所_物品名称")
	...
	-- Create Text_1_0_2
	local Text_1_0_2 = GUI:Text_Create(Panel_2, "Text_1_0_2", 110.00, 210.00, 12, "#ffffff", [[总价：]])
	GUI:setChineseName(Text_1_0_2, "交易所_总价_文本")
	...
	GUI:setChineseName(Button_cancel, "交易所_取消按钮")
	...
	GUI:setContentSize(Button_submit, 79, 36)
	...
	GUI:setChineseName(Button_submit, "交易所_下架道具按钮")
	...
	GUI:setChineseName(Image_16_0_0, "交易所_总价输入框_图片")
	...
	GUI:setChineseName(Node_money_bid, "交易所_出售货币_节点")
	GUI:setAnchorPoint(Node_money_bid, 0.50, 0.50)
	GUI:setTag(Node_money_bid, 251)

	-- Create Text_price
	local Text_price = GUI:Text_Create(Panel_2, "Text_price", 220.00, 210.00, 12, "#ffffff", [[9999]])
	GUI:setChineseName(Text_price, "交易所_价格_文本")
	GUI:setAnchorPoint(Text_price, 0.50, 0.50)
	GUI:setTouchEnabled(Text_price, false)
	GUI:setTag(Text_price, 124)
	...
	GUI:setChineseName(Text_remaining, "交易所_出售状态倒计时_文本")
	...
	GUI:setChineseName(Text_count, "交易所_数量_文本")
	...
	-- Create Text_status
	local Text_status = GUI:Text_Create(Panel_2, "Text_status", 177.00, 315.00, 12, "#ffffff", [[状态]])
	GUI:setChineseName(Text_status, "交易所_状态_文本")
