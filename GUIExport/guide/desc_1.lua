...
function ui.init(parent)
	...
	-- Create Image_arrow
	local Image_arrow = GUI:Image_Create(Panel_1, "Image_arrow", 169.62, 29.15, "res/private/guide/arrow_guide_1.png")
	...
	GUI:setTag(Image_arrow, 25.0)

	-- Create Image_desc
	local Image_desc = GUI:Image_Create(Panel_1, "Image_desc", 77.90, 29.16, "res/private/guide/btn_guide_1.png")
	...
	GUI:setTag(Image_desc, 26.0)

	-- Create Node_desc
	local Node_desc = GUI:Node_Create(Panel_1, "Node_desc", 77.90, 29.15)
	GUI:setAnchorPoint(Node_desc, 0.50, 0.50)
	GUI:setTag(Node_desc, 36.0)
end
return ui