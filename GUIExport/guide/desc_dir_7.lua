...
function ui.init(parent)
	...
	GUI:setRotation(Image_arrow, 270.00)
	GUI:setRotationSkewX(Image_arrow, 270.00)
	GUI:setRotationSkewY(Image_arrow, 270.00)
	GUI:setTouchEnabled(Image_arrow, false)
	GUI:setTag(Image_arrow, 54)

	-- Create Image_desc
	local Image_desc = GUI:Image_Create(Node, "Image_desc", 0.00, -60.00, "res/private/guide/btn_guide_1.png")
	...
	GUI:setTag(Image_desc, 53)

	-- Create Node_desc
	local Node_desc = GUI:Node_Create(Node, "Node_desc", 0.00, -60.00)
	GUI:setAnchorPoint(Node_desc, 0.50, 0.50)
	GUI:setTag(Node_desc, 52)
end
return ui