...
function ui.init(parent)
	...
	GUI:Layout_setBackGroundColorOpacity(CloseLayout, 150.0)
	...
	-- Create line_bg
	local line_bg = GUI:Image_Create(PMainUI, "line_bg", 348.00, 361.00, "res/public/bg_yyxsz_01.png")
	...
	-- Create Title1
	local Title1 = GUI:Text_Create(PMainUI, "Title1", 237.00, 380.00, 16.0, "#f2e7cf", [[申请详情]])
	...
	-- Create Title2
	local Title2 = GUI:Text_Create(PMainUI, "Title2", 567.00, 380.00, 16.0, "#f2e7cf", [[操作]])
	...
	-- Create CloseButton
	local CloseButton = GUI:Button_Create(PMainUI, "CloseButton", 697.00, 418.00, "res/public/1900000510.png")
	...
	-- Create ListView
	local ListView = GUI:ListView_Create(PMainUI, "ListView", 22.00, 22.00, 653.00, 333.00, 1.0)
