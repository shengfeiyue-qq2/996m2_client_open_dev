...
function ui.init(parent)
	...
	-- Create btmImage
	local btmImage = GUI:Image_Create(FrameLayout, "btmImage", 340.00, 43.00, "res/public/bg_hhdb_01.jpg")
	...
	-- Create Title1
	local Title1 = GUI:Text_Create(FrameLayout, "Title1", 90.00, 370.00, 16, "#f2e7cf", [[玩家名字]])
	...
	-- Create Title2
	local Title2 = GUI:Text_Create(FrameLayout, "Title2", 263.00, 370.00, 16, "#f2e7cf", [[等级]])
	...
	-- Create Title3
	local Title3 = GUI:Text_Create(FrameLayout, "Title3", 400.00, 370.00, 16, "#f2e7cf", [[职业]])
	...
	-- Create Title4
	local Title4 = GUI:Text_Create(FrameLayout, "Title4", 563.00, 370.00, 16, "#f2e7cf", [[操作]])
	...
	-- Create CheckBox
	local CheckBox = GUI:CheckBox_Create(FrameLayout, "CheckBox", 35.00, 42.00, "res/public/1900000654.png", "res/public/1900000655.png")
	...
	-- Create Label
	local Label = GUI:Text_Create(CheckBox, "Label", 25.00, 0.00, 16, "#41ca44", [[自动同意入会申请]])
	...
	-- Create Input_bg
	local Input_bg = GUI:Image_Create(FrameLayout, "Input_bg", 220.00, 42.00, "res/public/1900000668.png")
	GUI:setContentSize(Input_bg, 40, 30)
	...
	-- Create Input
	local Input = GUI:TextInput_Create(FrameLayout, "Input", 220.00, 42.00, 30.00, 20.00, 18)
	...
	-- Create text
	local text = GUI:Text_Create(FrameLayout, "text", 245.00, 42.00, 16, "#f2e7cf", [[级以上]])
	...
	-- Create BtnAll
	local BtnAll = GUI:Button_Create(FrameLayout, "BtnAll", 604.00, 42.00, "res/public/1900000660.png")
	GUI:Button_setTitleText(BtnAll, "一键通过")
	GUI:Button_setTitleColor(BtnAll, "#ffffff")
	GUI:Button_setTitleFontSize(BtnAll, 16)
	GUI:Button_titleEnableOutline(BtnAll, "#000000", 1)
	...
	-- Create List
	local List = GUI:ListView_Create(FrameLayout, "List", 13.00, 76.00, 653.00, 270.00, 1)
