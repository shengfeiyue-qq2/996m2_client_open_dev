...
function ui.init(parent)
	...
	GUI:setTag(bgTitle, 26.0)

	-- Create TitleText_1
	local TitleText_1 = GUI:Text_Create(PMainUI, "TitleText_1", 120.00, 200.00, 12.0, "#f8e6c6", [[行会名字]])
	GUI:setChineseName(TitleText_1, "创建行会_行会名字_文本")
	GUI:setAnchorPoint(TitleText_1, 0.50, 0.50)
	GUI:setTouchEnabled(TitleText_1, false)
	GUI:setTag(TitleText_1, 27.0)
	GUI:Text_enableOutline(TitleText_1, "#111111", 1.0)

	-- Create TitleText_2
	local TitleText_2 = GUI:Text_Create(PMainUI, "TitleText_2", 120.00, 125.00, 12.0, "#f8e6c6", [[需要道具]])
	GUI:setChineseName(TitleText_2, "创建行会_需要道具_文本")
	GUI:setAnchorPoint(TitleText_2, 0.50, 0.50)
	GUI:setTouchEnabled(TitleText_2, false)
	GUI:setTag(TitleText_2, -1.0)
	GUI:Text_enableOutline(TitleText_2, "#000000", 1.0)
	...
	GUI:Button_setScale9Slice(BtnCreate, 15, 15.0, 11, 11.0)
	GUI:setContentSize(BtnCreate, 79.0, 30.0)
	...
	GUI:Button_setTitleFontSize(BtnCreate, 14.0)
	GUI:Button_titleEnableOutline(BtnCreate, "#111111", 2.0)
	GUI:setChineseName(BtnCreate, "创建行会_创建行会_按钮")
	GUI:setAnchorPoint(BtnCreate, 0.50, 0.50)
	GUI:setTouchEnabled(BtnCreate, true)
	GUI:setTag(BtnCreate, 29.0)
	...
	GUI:setTag(TouchSize, 143.0)
	GUI:setVisible(TouchSize, false)

	-- Create Text_2
	local Text_2 = GUI:Text_Create(CheckBox, "Text_2", 30.00, 9.00, 12.0, "#28ef01", [[自动同意入会申请]])
	GUI:setChineseName(Text_2, "创建行会_自动同意_文本")
	GUI:setAnchorPoint(Text_2, 0.00, 0.50)
	GUI:setTouchEnabled(Text_2, false)
	GUI:setTag(Text_2, 32.0)
	GUI:Text_enableOutline(Text_2, "#111111", 1.0)
	...
	GUI:setContentSize(Input_level_bg, 40.0, 31.0)
	...
	GUI:setTag(Input_level_bg, 108.0)

	-- Create Input_level
	local Input_level = GUI:TextInput_Create(Input_level_bg, "Input_level", 20.00, 15.00, 30.00, 20.00, 13.0)
	GUI:TextInput_setInputMode(Input_level, 2.0)
