...
function ui.init(parent)
	...
	-- Create TitleText
	local TitleText = GUI:Text_Create(FrameLayout, "TitleText", 36.00, 498.00, 18, "#d8c8ae", [[]])
	...
	-- Create PageText
	local PageText = GUI:Text_Create(page_cell_1, "PageText", 13.00, 62.00, 16, "#807256", [[行
会]])
	...
	-- Create PageText
	local PageText = GUI:Text_Create(page_cell_2, "PageText", 13.00, 62.00, 16, "#807256", [[成
员]])
	...
	-- Create PageText
	local PageText = GUI:Text_Create(page_cell_3, "PageText", 13.00, 62.00, 16, "#807256", [[列
表]])
