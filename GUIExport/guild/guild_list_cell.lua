...
function ui.init(parent)
	...
	GUI:setTag(Image_line, 160.0)

	-- Create label_name
	local label_name = GUI:Text_Create(Panel_cell, "label_name", 68.00, 25.00, 16.0, "#ffffff", [[行会名字]])
	GUI:setChineseName(label_name, "行会操作_行会名称_文本")
	GUI:setAnchorPoint(label_name, 0.50, 0.50)
	GUI:setTouchEnabled(label_name, false)
	GUI:setTag(label_name, 82.0)
	GUI:Text_enableOutline(label_name, "#111111", 1.0)

	-- Create label_master
	local label_master = GUI:Text_Create(Panel_cell, "label_master", 244.00, 25.00, 16.0, "#ffffff", [[会长名字]])
	...
	GUI:setTag(label_master, 83.0)
	GUI:Text_enableOutline(label_master, "#111111", 1.0)

	-- Create label_count
	local label_count = GUI:Text_Create(Panel_cell, "label_count", 384.00, 25.00, 16.0, "#ffffff", [[100]])
	GUI:setChineseName(label_count, "行会操作_行会人数_文本")
	GUI:setAnchorPoint(label_count, 0.50, 0.50)
	GUI:setTouchEnabled(label_count, false)
	GUI:setTag(label_count, 84.0)
	GUI:Text_enableOutline(label_count, "#111111", 1.0)

	-- Create label_condition
	local label_condition = GUI:Text_Create(Panel_cell, "label_condition", 500.00, 25.00, 16.0, "#ffffff", [[100级以上]])
	...
	GUI:setTag(label_condition, 85.0)
	GUI:Text_enableOutline(label_condition, "#111111", 1.0)

	-- Create label_desc
	local label_desc = GUI:Text_Create(Panel_cell, "label_desc", 645.00, 25.00, 16.0, "#ffffff", [[已申请]])
	GUI:setChineseName(label_desc, "行会操作_申请状态_文本")
	GUI:setAnchorPoint(label_desc, 0.50, 0.50)
	GUI:setTouchEnabled(label_desc, false)
	GUI:setTag(label_desc, 86.0)
	GUI:Text_enableOutline(label_desc, "#111111", 1.0)
	...
	GUI:Button_setScale9Slice(Button_join, 16, 14.0, 13, 9.0)
	GUI:setContentSize(Button_join, 76.0, 33.0)
	...
	GUI:Button_setTitleFontSize(Button_join, 18.0)
	GUI:Button_titleEnableOutline(Button_join, "#111111", 2.0)
	GUI:setChineseName(Button_join, "行会操作_加入按钮")
	GUI:setAnchorPoint(Button_join, 0.50, 0.50)
	GUI:setTouchEnabled(Button_join, true)
	GUI:setTag(Button_join, 141.0)
	...
	GUI:Button_setScale9Slice(Button_war, 16, 14.0, 13, 9.0)
	GUI:setContentSize(Button_war, 76.0, 33.0)
	...
	GUI:Button_setTitleFontSize(Button_war, 18.0)
	GUI:Button_titleEnableOutline(Button_war, "#111111", 2.0)
	GUI:setChineseName(Button_war, "行会操作_宣战按钮")
	GUI:setAnchorPoint(Button_war, 0.50, 0.50)
	GUI:setTouchEnabled(Button_war, true)
	GUI:setTag(Button_war, 118.0)
	...
	GUI:Button_setScale9Slice(Button_ally, 16, 14.0, 13, 9.0)
	GUI:setContentSize(Button_ally, 76.0, 33.0)
	...
	GUI:Button_setTitleFontSize(Button_ally, 18.0)
	GUI:Button_titleEnableOutline(Button_ally, "#111111", 2.0)
	GUI:setChineseName(Button_ally, "行会操作_结盟按钮")
	GUI:setAnchorPoint(Button_ally, 0.50, 0.50)
	GUI:setTouchEnabled(Button_ally, true)
	GUI:setTag(Button_ally, 119.0)

	-- Create Button_cancel
	local Button_cancel = GUI:Button_Create(Panel_cell, "Button_cancel", 718.00, 26.00, "res/public/btn_gban_01.png")
	GUI:Button_loadTexturePressed(Button_cancel, "res/public/btn_gban_02.png")
	GUI:Button_setScale9Slice(Button_cancel, 7, 7.0, 11, 10.0)
	GUI:setContentSize(Button_cancel, 23.0, 22.0)
	...
	GUI:Button_setTitleFontSize(Button_cancel, 14.0)
