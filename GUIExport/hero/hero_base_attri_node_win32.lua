...
function ui.init(parent)
	...
	local ListView_base = GUI:ListView_Create(Panel_1, "ListView_base", 2.00, 2.00, 268.00, 345.00, 1.0)
	GUI:ListView_setGravity(ListView_base, 5.0)
	GUI:setChineseName(ListView_base, "玩家基本属性_列表")
	GUI:setTouchEnabled(ListView_base, true)
	GUI:setTag(ListView_base, 190.0)
end
return ui