...
function ui.init(parent)
	-- Create PMainUI
	local PMainUI = GUI:Layout_Create(parent, "PMainUI", 577.00, 293.00, 279.00, 220.00, false)
	...
	-- Create FrameBG
	local FrameBG = GUI:Image_Create(PMainUI, "FrameBG", -46.00, -91.00, "res/private/gui_edit/ImageFile.png")
	GUI:setContentSize(FrameBG, 0.0, 0.0)
	GUI:setIgnoreContentAdaptWithSize(FrameBG, false)
	GUI:setTouchEnabled(FrameBG, false)
	GUI:setTag(FrameBG, -1.0)

	-- Create line
	local line = GUI:Image_Create(PMainUI, "line", 138.00, 194.00, "res/public/word_sxbt_05.png")
	GUI:setAnchorPoint(line, 0.50, 0.50)
	GUI:setTouchEnabled(line, false)
	GUI:setTag(line, -1.0)

	-- Create ImageTitle
	local ImageTitle = GUI:Image_Create(PMainUI, "ImageTitle", 135.00, 194.00, "res/private/player_best_rings_ui/player_best_rings_ui_win32/word_jewelry_1.png")
	GUI:setAnchorPoint(ImageTitle, 0.50, 0.50)
	GUI:setTouchEnabled(ImageTitle, false)
	GUI:setTag(ImageTitle, -1.0)

	-- Create CloseButton
	local CloseButton = GUI:Button_Create(PMainUI, "CloseButton", 280.00, 218.00, "res/public/1900000510.png")
	...
	-- Create PanelItems
	local PanelItems = GUI:Layout_Create(PMainUI, "PanelItems", 15.00, 13.00, 250.00, 164.00, true)
	GUI:setTouchEnabled(PanelItems, false)
	GUI:setTag(PanelItems, -1.0)

	-- Create PanelPos30
	local PanelPos30 = GUI:Layout_Create(PanelItems, "PanelPos30", 29.00, 134.00, 47.00, 48.00, false)
	...
	GUI:Image_setScale9Slice(PanelBg, 19, 19.0, 20, 18.0)
	GUI:setContentSize(PanelBg, 47.0, 48.0)
	...
	-- Create DefaultIcon
	local DefaultIcon = GUI:Image_Create(PanelPos30, "DefaultIcon", 26.00, 26.00, "res/private/player_best_rings_ui/player_best_rings_ui_win32/word_shengxiao_1.png")
	...
	-- Create PanelPos31
	local PanelPos31 = GUI:Layout_Create(PanelItems, "PanelPos31", 91.33, 134.00, 47.00, 48.00, false)
	...
	-- Create DefaultIcon
	local DefaultIcon = GUI:Image_Create(PanelPos31, "DefaultIcon", 26.00, 26.00, "res/private/player_best_rings_ui/player_best_rings_ui_win32/word_shengxiao_2.png")
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	GUI:setTag(DefaultIcon, -1.0)
	...
	-- Create PanelPos32
	local PanelPos32 = GUI:Layout_Create(PanelItems, "PanelPos32", 153.66, 134.00, 47.00, 48.00, false)
	...
	-- Create DefaultIcon
	local DefaultIcon = GUI:Image_Create(PanelPos32, "DefaultIcon", 26.00, 26.00, "res/private/player_best_rings_ui/player_best_rings_ui_win32/word_shengxiao_3.png")
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	GUI:setTag(DefaultIcon, -1.0)
	...
	-- Create PanelPos33
	local PanelPos33 = GUI:Layout_Create(PanelItems, "PanelPos33", 215.99, 134.00, 47.00, 48.00, false)
	...
	-- Create DefaultIcon
	local DefaultIcon = GUI:Image_Create(PanelPos33, "DefaultIcon", 26.00, 26.00, "res/private/player_best_rings_ui/player_best_rings_ui_win32/word_shengxiao_4.png")
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	GUI:setTag(DefaultIcon, -1.0)
	...
	-- Create PanelPos34
	local PanelPos34 = GUI:Layout_Create(PanelItems, "PanelPos34", 29.00, 81.00, 47.00, 48.00, false)
	...
	-- Create DefaultIcon
	local DefaultIcon = GUI:Image_Create(PanelPos34, "DefaultIcon", 26.00, 26.00, "res/private/player_best_rings_ui/player_best_rings_ui_win32/word_shengxiao_5.png")
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	GUI:setTag(DefaultIcon, -1.0)
	...
	-- Create PanelPos35
	local PanelPos35 = GUI:Layout_Create(PanelItems, "PanelPos35", 91.33, 81.00, 47.00, 48.00, false)
	...
	-- Create DefaultIcon
	local DefaultIcon = GUI:Image_Create(PanelPos35, "DefaultIcon", 26.00, 26.00, "res/private/player_best_rings_ui/player_best_rings_ui_win32/word_shengxiao_6.png")
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	GUI:setTag(DefaultIcon, -1.0)
	...
	-- Create PanelPos36
	local PanelPos36 = GUI:Layout_Create(PanelItems, "PanelPos36", 153.66, 81.00, 47.00, 48.00, false)
	...
	-- Create DefaultIcon
	local DefaultIcon = GUI:Image_Create(PanelPos36, "DefaultIcon", 26.00, 26.00, "res/private/player_best_rings_ui/player_best_rings_ui_win32/word_shengxiao_7.png")
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	GUI:setTag(DefaultIcon, -1.0)
	...
	-- Create PanelPos37
	local PanelPos37 = GUI:Layout_Create(PanelItems, "PanelPos37", 216.00, 81.00, 47.00, 48.00, false)
	...
	-- Create DefaultIcon
	local DefaultIcon = GUI:Image_Create(PanelPos37, "DefaultIcon", 26.00, 26.00, "res/private/player_best_rings_ui/player_best_rings_ui_win32/word_shengxiao_8.png")
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	GUI:setTag(DefaultIcon, -1.0)
	...
	-- Create PanelPos38
	local PanelPos38 = GUI:Layout_Create(PanelItems, "PanelPos38", 29.00, 28.00, 47.00, 48.00, false)
	...
	-- Create DefaultIcon
	local DefaultIcon = GUI:Image_Create(PanelPos38, "DefaultIcon", 26.00, 26.00, "res/private/player_best_rings_ui/player_best_rings_ui_win32/word_shengxiao_9.png")
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	GUI:setTag(DefaultIcon, -1.0)
	...
	-- Create PanelPos39
	local PanelPos39 = GUI:Layout_Create(PanelItems, "PanelPos39", 91.33, 28.00, 47.00, 48.00, false)
	...
	-- Create DefaultIcon
	local DefaultIcon = GUI:Image_Create(PanelPos39, "DefaultIcon", 26.00, 26.00, "res/private/player_best_rings_ui/player_best_rings_ui_win32/word_shengxiao_10.png")
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	GUI:setTag(DefaultIcon, -1.0)
	...
	-- Create PanelPos40
	local PanelPos40 = GUI:Layout_Create(PanelItems, "PanelPos40", 153.66, 28.00, 47.00, 48.00, false)
	...
	-- Create DefaultIcon
	local DefaultIcon = GUI:Image_Create(PanelPos40, "DefaultIcon", 26.00, 26.00, "res/private/player_best_rings_ui/player_best_rings_ui_win32/word_shengxiao_11.png")
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	GUI:setTag(DefaultIcon, -1.0)
	...
	-- Create PanelPos41
	local PanelPos41 = GUI:Layout_Create(PanelItems, "PanelPos41", 216.00, 28.00, 47.00, 48.00, false)
	...
	-- Create DefaultIcon
	local DefaultIcon = GUI:Image_Create(PanelPos41, "DefaultIcon", 26.00, 26.00, "res/private/player_best_rings_ui/player_best_rings_ui_win32/word_shengxiao_12.png")
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	GUI:setTag(DefaultIcon, -1.0)
	...
	-- Create PanelTouch
	local PanelTouch = GUI:Layout_Create(PMainUI, "PanelTouch", 15.00, 13.00, 250.00, 164.00, true)
