...
function ui.init(parent)
	...
	-- Create topLayout
	local topLayout = GUI:Layout_Create(Panel_1, "topLayout", 191.00, 493.00, 164.00, 35.00, false)
	...
	local Panel_btnList = GUI:Layout_Create(Panel_1, "Panel_btnList", 380.00, 488.00, 32.00, 454.00, false)
...
装]])
	...
	local Panel_btnList_ng = GUI:Layout_Create(Panel_1, "Panel_btnList_ng", 380.00, 488.00, 32.00, 454.00, false)
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Button_1, "Text_name", 13.00, 85.00, 16, "#807256", [[状
态]])
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Button_2, "Text_name", 13.00, 85.00, 16, "#807256", [[技
能]])
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Button_3, "Text_name", 13.00, 85.00, 16, "#807256", [[经
络]])
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Button_4, "Text_name", 13.00, 85.00, 16, "#807256", [[连
击]])
