...
function ui.init(parent)
	...
	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(Scene, "Panel_1", 360.00, 380.00, 305.00, 438.00, false)
	...
	-- Create Text_Name
	local Text_Name = GUI:Text_Create(Panel_1, "Text_Name", 150.00, 400.00, 18.0, "#ffe400", [[]])
	...
	-- Create Text_1
	local Text_1 = GUI:Text_Create(base_btn, "Text_1", 27.00, 10.00, 13.0, "#807256", [[基础]])
	...
	-- Create Text_1
	local Text_1 = GUI:Text_Create(ng_btn, "Text_1", 27.00, 10.00, 13.0, "#807256", [[内功]])
...
备]])
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Button_102, "Text_name", 11.00, 62.00, 13.0, "#807256", [[状
态]])
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Button_103, "Text_name", 11.00, 62.00, 13.0, "#807256", [[属
性]])
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Button_104, "Text_name", 11.00, 62.00, 13.0, "#807256", [[技
能]])
...
装]])
	...
	GUI:setTag(Panel_btnList_ng, 130.0)
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Button_701, "Text_name", 11.00, 62.00, 13.0, "#807256", [[状
态]])
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Button_702, "Text_name", 11.00, 62.00, 13.0, "#807256", [[技
能]])
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Button_703, "Text_name", 11.00, 62.00, 13.0, "#807256", [[经
络]])
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Button_704, "Text_name", 11.00, 62.00, 13.0, "#807256", [[连
击]])
