...
function ui.init(parent)
	-- Create Hero_State
	local Hero_State = GUI:Layout_Create(parent, "Hero_State", 0.00, 0.00, 1136.00, 640.00, false)
	GUI:setChineseName(Hero_State, "英雄状态_组合")
	GUI:setTouchEnabled(Hero_State, false)
	GUI:setTag(Hero_State, -1.0)

	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(Hero_State, "Panel_1", 276.00, 614.00, 201.00, 94.00, false)
	GUI:setChineseName(Panel_1, "英雄状态_组合")
	GUI:setAnchorPoint(Panel_1, 0.00, 1.00)
	GUI:setTouchEnabled(Panel_1, true)
	GUI:setTag(Panel_1, 66.0)
	...
	GUI:setTag(Image_2, 67.0)

	-- Create LoadingBar_1
	local LoadingBar_1 = GUI:LoadingBar_Create(Panel_1, "LoadingBar_1", 135.00, 63.00, "res/private/player_hero/01061.png", 0.0)
	GUI:LoadingBar_setPercent(LoadingBar_1, 100.0)
	...
	GUI:setTag(LoadingBar_1, 68.0)

	-- Create LoadingBar_2
	local LoadingBar_2 = GUI:LoadingBar_Create(Panel_1, "LoadingBar_2", 138.00, 50.00, "res/private/player_hero/01062.png", 0.0)
	GUI:LoadingBar_setPercent(LoadingBar_2, 100.0)
	...
	GUI:setTag(LoadingBar_2, 69.0)

	-- Create LoadingBar_3
	local LoadingBar_3 = GUI:LoadingBar_Create(Panel_1, "LoadingBar_3", 140.00, 37.00, "res/private/player_hero/01064.png", 0.0)
	GUI:LoadingBar_setPercent(LoadingBar_3, 100.0)
	...
	GUI:setTag(Image_levelbg, 72.0)

	-- Create Text_level
	local Text_level = GUI:Text_Create(Panel_1, "Text_level", 15.00, 15.00, 15.0, "#ffffff", [[30]])
	GUI:setChineseName(Text_level, "英雄状态_等级_文本")
	GUI:setAnchorPoint(Text_level, 0.50, 0.50)
	GUI:setTouchEnabled(Text_level, false)
	GUI:setTag(Text_level, 73.0)
	...
	GUI:setTag(Image_z2, 75.0)

	-- Create Text_z
	local Text_z = GUI:Text_Create(Panel_1, "Text_z", 132.00, 20.00, 14.0, "#ffffff", [[100%]])
	GUI:setChineseName(Text_z, "英雄状态_忠诚度%_文本")
	GUI:setAnchorPoint(Text_z, 0.50, 0.50)
	GUI:setTouchEnabled(Text_z, false)
	GUI:setTag(Text_z, 76.0)
	GUI:Text_enableOutline(Text_z, "#000000", 1.0)

	-- Create Text_name
	local Text_name = GUI:Text_Create(Panel_1, "Text_name", 132.00, 79.00, 13.0, "#ffffff", [[哈等哈哈]])
	GUI:setChineseName(Text_name, "英雄状态_昵称_文本")
	GUI:setAnchorPoint(Text_name, 0.50, 0.50)
	GUI:setTouchEnabled(Text_name, false)
	GUI:setTag(Text_name, 77.0)
	...
	GUI:setTag(Image_state, 78.0)

	-- Create Text_state
	local Text_state = GUI:Text_Create(Panel_1, "Text_state", 180.00, 21.00, 15.0, "#ffffff", [[战斗]])
	GUI:setChineseName(Text_state, "英雄状态_状态_文本")
	GUI:setAnchorPoint(Text_state, 0.50, 0.50)
	GUI:setTouchEnabled(Text_state, false)
	GUI:setTag(Text_state, 79.0)
	...
	GUI:Button_setScale9Slice(Button_bag, 15, 15.0, 11, 11.0)
	GUI:setContentSize(Button_bag, 79.0, 27.0)
	...
	GUI:Button_setTitleFontSize(Button_bag, 15.0)
	GUI:Button_titleEnableOutline(Button_bag, "#000000", 1.0)
	GUI:setChineseName(Button_bag, "英雄状态_背包按钮")
	GUI:setAnchorPoint(Button_bag, 0.50, 0.50)
	GUI:setTouchEnabled(Button_bag, true)
	GUI:setTag(Button_bag, 84.0)
	...
	GUI:Button_setScale9Slice(Button_state, 15, 15.0, 11, 11.0)
	GUI:setContentSize(Button_state, 79.0, 27.0)
	...
	GUI:Button_setTitleFontSize(Button_state, 15.0)
	GUI:Button_titleEnableOutline(Button_state, "#000000", 1.0)
	GUI:setChineseName(Button_state, "英雄状态_状态按钮")
	GUI:setAnchorPoint(Button_state, 0.50, 0.50)
	GUI:setTouchEnabled(Button_state, true)
	GUI:setTag(Button_state, 85.0)

	-- Create Panel_ng
	local Panel_ng = GUI:Layout_Create(Hero_State, "Panel_ng", 276.00, 614.00, 201.00, 94.00, false)
	GUI:setChineseName(Panel_ng, "英雄状态_内功组合")
	GUI:setAnchorPoint(Panel_ng, 0.00, 1.00)
	GUI:setTouchEnabled(Panel_ng, true)
	GUI:setTag(Panel_ng, 66.0)
	...
	-- Create LoadingBar_1
	local LoadingBar_1 = GUI:LoadingBar_Create(Panel_ng, "LoadingBar_1", 136.00, 63.00, "res/private/player_hero/01061.png", 0.0)
	GUI:LoadingBar_setPercent(LoadingBar_1, 100.0)
	GUI:LoadingBar_setColor(LoadingBar_1, "#ffffff")
	...
	-- Create LoadingBar_2
	local LoadingBar_2 = GUI:LoadingBar_Create(Panel_ng, "LoadingBar_2", 139.00, 51.00, "res/private/player_hero/01062.png", 0.0)
	GUI:LoadingBar_setPercent(LoadingBar_2, 100.0)
	GUI:LoadingBar_setColor(LoadingBar_2, "#ffffff")
	...
	local LoadingBar_ng = GUI:LoadingBar_Create(Panel_ng, "LoadingBar_ng", 140.00, 39.00, "res/private/player_hero/01065.png", 0.0)
	GUI:LoadingBar_setPercent(LoadingBar_ng, 100.0)
	...
	GUI:setTag(LoadingBar_ng, 70.0)

	-- Create LoadingBar_3
	local LoadingBar_3 = GUI:LoadingBar_Create(Panel_ng, "LoadingBar_3", 140.00, 27.00, "res/private/player_hero/01064.png", 0.0)
	GUI:LoadingBar_setPercent(LoadingBar_3, 100.0)
	GUI:LoadingBar_setColor(LoadingBar_3, "#ffffff")
	...
	-- Create Image_bar_dz
	local Image_bar_dz = GUI:LoadingBar_Create(Panel_bar_dz, "Image_bar_dz", 0.00, 0.00, "res/private/player_hero/00511.png", 0.0)
	GUI:LoadingBar_setPercent(Image_bar_dz, 100.0)
	...
	-- Create Image_bar_zj
	local Image_bar_zj = GUI:LoadingBar_Create(Panel_bar_zj, "Image_bar_zj", 0.00, 0.00, "res/private/player_hero/00514.png", 0.0)
	GUI:LoadingBar_setPercent(Image_bar_zj, 100.0)
	...
	-- Create Text_level
	local Text_level = GUI:Text_Create(Panel_ng, "Text_level", 15.00, 15.00, 15.0, "#ffffff", [[30]])
	GUI:setChineseName(Text_level, "英雄状态_等级_文本")
	GUI:setAnchorPoint(Text_level, 0.50, 0.50)
	GUI:setTouchEnabled(Text_level, false)
	GUI:setTag(Text_level, 73.0)
	...
	-- Create Text_z
	local Text_z = GUI:Text_Create(Panel_ng, "Text_z", 124.00, 9.00, 14.0, "#ffffff", [[100%]])
	GUI:setChineseName(Text_z, "英雄状态_忠诚度%_文本")
	GUI:setAnchorPoint(Text_z, 0.50, 0.50)
	GUI:setTouchEnabled(Text_z, false)
	GUI:setTag(Text_z, 76.0)
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Panel_ng, "Text_name", 132.00, 79.00, 13.0, "#ffffff", [[哈等哈哈]])
	GUI:setChineseName(Text_name, "英雄状态_昵称_文本")
	GUI:setAnchorPoint(Text_name, 0.50, 0.50)
	GUI:setTouchEnabled(Text_name, false)
	GUI:setTag(Text_name, 77.0)
	...
	-- Create Text_state
	local Text_state = GUI:Text_Create(Panel_ng, "Text_state", 172.00, 10.00, 15.0, "#ffffff", [[战斗]])
	GUI:setChineseName(Text_state, "英雄状态_状态_文本")
	GUI:setAnchorPoint(Text_state, 0.50, 0.50)
	GUI:setTouchEnabled(Text_state, false)
	GUI:setTag(Text_state, 79.0)
	...
	GUI:Button_loadTexturePressed(Button_bag, "res/private/player_hero/btn_bag2.png")
	GUI:Button_setScale9Slice(Button_bag, 0, 0.0, 0, 0.0)
	GUI:setContentSize(Button_bag, 79.0, 27.0)
	GUI:setIgnoreContentAdaptWithSize(Button_bag, false)
	GUI:Button_setTitleText(Button_bag, "")
	GUI:Button_setTitleColor(Button_bag, "#ffffff")
	...
	GUI:Button_loadTexturePressed(Button_state, "res/private/player_hero/btn_state2.png")
	GUI:Button_setScale9Slice(Button_state, 0, 0.0, 0, 0.0)
	GUI:setContentSize(Button_state, 79.0, 27.0)
	GUI:setIgnoreContentAdaptWithSize(Button_state, false)
	GUI:Button_setTitleText(Button_state, "")
	GUI:Button_setTitleColor(Button_state, "#ffffff")
	...
	-- Create btnCallHerop
	local btnCallHerop = GUI:Button_Create(parent, "btnCallHerop", 863.00, 447.00, "res/private/player_hero/btn_login1.png")
	GUI:Button_loadTexturePressed(btnCallHerop, "res/private/player_hero/btn_login2.png")
	GUI:Button_setScale9Slice(btnCallHerop, 15, 15.0, 11, 11.0)
	GUI:setContentSize(btnCallHerop, 79.0, 27.0)
	GUI:setIgnoreContentAdaptWithSize(btnCallHerop, false)
	GUI:Button_setTitleText(btnCallHerop, "")
	GUI:Button_setTitleColor(btnCallHerop, "#ffffff")
	GUI:Button_setTitleFontSize(btnCallHerop, 15.0)
	GUI:Button_titleEnableOutline(btnCallHerop, "#000000", 1.0)
	GUI:setChineseName(btnCallHerop, "英雄状态_召唤按钮")
	GUI:setAnchorPoint(btnCallHerop, 0.50, 0.50)
	GUI:setTouchEnabled(btnCallHerop, true)
	GUI:setTag(btnCallHerop, 107.0)
end
return ui