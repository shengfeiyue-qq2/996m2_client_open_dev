...
function ui.init(parent)
	...
	-- Create Panel_pos17
	local Panel_pos17 = GUI:Layout_Create(EquipUI, "Panel_pos17", 136.00, 120.00, 103.50, 144.00, false)
	GUI:setChineseName(Panel_pos17, "玩家时装_衣服位置")
	GUI:setAnchorPoint(Panel_pos17, 0.50, 0.50)
	GUI:setTouchEnabled(Panel_pos17, true)
	GUI:setTag(Panel_pos17, 140.0)

	-- Create Panel_pos18
	local Panel_pos18 = GUI:Layout_Create(EquipUI, "Panel_pos18", 65.00, 190.00, 80.73, 120.00, false)
	GUI:setChineseName(Panel_pos18, "玩家时装_武器位置")
	GUI:setAnchorPoint(Panel_pos18, 0.50, 0.50)
	GUI:setTouchEnabled(Panel_pos18, true)
	GUI:setTag(Panel_pos18, 141.0)
	...
	GUI:setTag(Node_43, 183.0)

	-- Create Text_shizhuang
	local Text_shizhuang = GUI:Text_Create(EquipUI, "Text_shizhuang", 198.00, 324.00, 12.0, "#ffe400", [[时装外显示]])
	...
	GUI:setTag(Text_shizhuang, 349.0)
	...
	GUI:setTag(CheckBox_shizhuang, 350.0)
end
return ui