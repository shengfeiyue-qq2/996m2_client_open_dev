...
function ui.init(parent)
	...
	GUI:Button_setScale9Slice(Button_curTitle, 15, 15.0, 12, 10.0)
	GUI:setContentSize(Button_curTitle, 56.0, 58.0)
	...
	GUI:setTag(Button_curTitle, 18.0)
	...
	GUI:setTag(Image_11, 34.0)

	-- Create Text_curTitle
	local Text_curTitle = GUI:Text_Create(Image_11, "Text_curTitle", 10.00, 23.00, 16.0, "#00b300", [[]])
	...
	GUI:setTag(Image_12, 36.0)

	-- Create ListView_cells
	local ListView_cells = GUI:ListView_Create(Panel_1, "ListView_cells", 0.00, 5.00, 348.00, 350.00, 1.0)
