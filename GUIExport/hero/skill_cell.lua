...
function ui.init(parent)
	...
	-- Create Image_3
	local Image_3 = GUI:Image_Create(Panel_skill_cell, "Image_3", 70.00, 35.00, "res/private/player_skill/1900015004.png")
	GUI:Image_setScale9Slice(Image_3, 19, 19.0, 9, 9.0)
	GUI:setContentSize(Image_3, 270.0, 60.0)
	...
	-- Create Image_icon
	local Image_icon = GUI:Image_Create(Panel_skill_cell, "Image_icon", 35.00, 35.00, "res/private/player_skill/1900015031.png")
	...
	-- Create Image_1
	local Image_1 = GUI:Image_Create(Panel_skill_cell, "Image_1", 158.00, 50.00, "res/private/player_skill/1900015021.png")
	...
	-- Create Image_2
	local Image_2 = GUI:Image_Create(Panel_skill_cell, "Image_2", 75.00, 20.00, "res/private/player_skill/1900015020.png")
	...
	local Text_skillName = GUI:Text_Create(Panel_skill_cell, "Text_skillName", 75.00, 51.00, 16.0, "#ffffff", [[技能名称]])
	...
	local Text_skillLevel = GUI:Text_Create(Panel_skill_cell, "Text_skillLevel", 194.00, 50.00, 16.0, "#ffff0f", [[0]])
	...
	local Text_skillTrain = GUI:Text_Create(Panel_skill_cell, "Text_skillTrain", 125.00, 22.00, 16.0, "#ffffff", [[123]])
	...
	-- Create Text_levelup
	local Text_levelup = GUI:Text_Create(Panel_skill_cell, "Text_levelup", 75.00, 22.00, 16.0, "#ffffff", [[强化一重]])
	GUI:setChineseName(Text_levelup, "玩家技能_强化等级")
	GUI:setAnchorPoint(Text_levelup, 0.00, 0.50)
	GUI:setTouchEnabled(Text_levelup, false)
	GUI:setTag(Text_levelup, 18.0)
	GUI:Text_enableOutline(Text_levelup, "#111111", 1.0)

	-- Create btnOffon
	local btnOffon = GUI:Button_Create(Panel_skill_cell, "btnOffon", 298.00, 35.00, "res/private/player_hero/btn_on.png")
