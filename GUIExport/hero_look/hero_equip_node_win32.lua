...
function ui.init(parent)
	...
	GUI:setTag(Node_playerModel, 139.0)

	-- Create Panel_pos0
	local Panel_pos0 = GUI:Layout_Create(EquipUI, "Panel_pos0", 136.00, 120.00, 80.00, 144.00, false)
	GUI:setChineseName(Panel_pos0, "玩家装备_裸模位置")
	GUI:setAnchorPoint(Panel_pos0, 0.50, 0.50)
	GUI:setTouchEnabled(Panel_pos0, true)
	GUI:setTag(Panel_pos0, 140.0)

	-- Create Panel_pos1
	local Panel_pos1 = GUI:Layout_Create(EquipUI, "Panel_pos1", 80.00, 190.00, 60.00, 120.00, false)
	GUI:setChineseName(Panel_pos1, "玩家装备_武器位置")
	GUI:setAnchorPoint(Panel_pos1, 0.50, 0.50)
	GUI:setTouchEnabled(Panel_pos1, true)
	GUI:setTag(Panel_pos1, 141.0)
	...
	GUI:setTag(Node_9, 183.0)

	-- Create Text_guildinfo
	local Text_guildinfo = GUI:Text_Create(EquipUI, "Text_guildinfo", 9.00, 335.00, 18.0, "#ffffff", [[]])
	...
	GUI:setTag(Text_guildinfo, 138.0)
