...
function ui.init(parent)
	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(parent, "Panel_1", 360.00, 340.00, 382.00, 572.00, false)
	...
	-- Create Text_Name
	local Text_Name = GUI:Text_Create(Panel_1, "Text_Name", 191.00, 526.00, 18, "#ffe400", [[色积极]])
