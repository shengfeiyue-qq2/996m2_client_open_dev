...
function ui.init(parent)
	...
	GUI:setChineseName(Node_title, "通用消耗_标题_节点")
	...
	GUI:setChineseName(Node_icon, "通用消耗_图标_节点")
	...
	GUI:setChineseName(Node_count, "通用消耗_数量_节点")
