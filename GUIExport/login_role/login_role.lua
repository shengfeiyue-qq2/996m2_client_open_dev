...
function ui.init(parent)
	...
	-- Create lock_player
	local lock_player = GUI:Image_Create(Panel_role_1, "lock_player", 175.00, 230.00, "res/public/1900000651_2.png")
	GUI:Image_setScale9Slice(lock_player, 21, 22, 21, 22)
	GUI:setContentSize(lock_player, 312, 24)
	GUI:setIgnoreContentAdaptWithSize(lock_player, false)
	GUI:setAnchorPoint(lock_player, 0.50, 0.00)
	GUI:setTouchEnabled(lock_player, false)
	GUI:setTag(lock_player, -1)
	GUI:setVisible(lock_player, false)

	-- Create Text_lock
	local Text_lock = GUI:Text_Create(lock_player, "Text_lock", 2.00, 2.00, 16, "#00de00", [==========[[[寄售中，如需取回角色，请点击下方按钮]]]==========])
	GUI:setTouchEnabled(Text_lock, false)
	GUI:setTag(Text_lock, -1)
	GUI:Text_enableOutline(Text_lock, "#000000", 1)

	-- Create backBtn
	local backBtn = GUI:Button_Create(lock_player, "backBtn", 156.00, -20.00, "res/public/1900000662.png")
	GUI:Button_setTitleText(backBtn, "取回角色")
	GUI:Button_setTitleColor(backBtn, "#ffffff")
	GUI:Button_setTitleFontSize(backBtn, 18)
	GUI:Button_titleEnableOutline(backBtn, "#000000", 1)
	GUI:setAnchorPoint(backBtn, 0.50, 0.50)
	GUI:setTouchEnabled(backBtn, true)
	GUI:setTag(backBtn, -1)

	-- Create new_player
	local new_player = GUI:Image_Create(Panel_role_1, "new_player", 180.00, 370.00, "res/private/TradingBankLayer/word_jiaoyh_03.png")
	GUI:setAnchorPoint(new_player, 0.50, 0.50)
	GUI:setTouchEnabled(new_player, false)
	GUI:setTag(new_player, -1)
	GUI:setVisible(new_player, false)
	...
	-- Create lock_player
	local lock_player = GUI:Image_Create(Panel_role_2, "lock_player", 175.00, 230.00, "res/public/1900000651_2.png")
	GUI:Image_setScale9Slice(lock_player, 21, 22, 21, 22)
	GUI:setContentSize(lock_player, 312, 24)
	GUI:setIgnoreContentAdaptWithSize(lock_player, false)
	GUI:setAnchorPoint(lock_player, 0.50, 0.00)
	...
	-- Create new_player
	local new_player = GUI:Image_Create(Panel_role_2, "new_player", 180.00, 370.00, "res/private/TradingBankLayer/word_jiaoyh_03.png")
	GUI:setAnchorPoint(new_player, 0.50, 0.50)
	GUI:setTouchEnabled(new_player, false)
	GUI:setTag(new_player, -1)
	GUI:setVisible(new_player, false)
	...
	-- Create Text_name_1
	local Text_name_1 = GUI:Text_Create(Panel_info_1, "Text_name_1", 70.00, 106.00, 16, "#ffffff", [[传奇经典]])
	...
	-- Create Text_level_1
	local Text_level_1 = GUI:Text_Create(Panel_info_1, "Text_level_1", 70.00, 77.00, 16, "#ffffff", [[9级]])
	...
	-- Create Text_job_1
	local Text_job_1 = GUI:Text_Create(Panel_info_1, "Text_job_1", 70.00, 50.00, 16, "#ffffff", [[战士]])
	...
	-- Create Text_name_2
	local Text_name_2 = GUI:Text_Create(Panel_info_2, "Text_name_2", 70.00, 106.00, 16, "#ffffff", [[传奇经典]])
	...
	-- Create Text_level_2
	local Text_level_2 = GUI:Text_Create(Panel_info_2, "Text_level_2", 70.00, 77.00, 16, "#ffffff", [[9级]])
	...
	-- Create Text_job_2
	local Text_job_2 = GUI:Text_Create(Panel_info_2, "Text_job_2", 70.00, 50.00, 16, "#ffffff", [[战士]])
