...
function ui.init(parent)
	...
	-- Create Image_name
	local Image_name = GUI:Image_Create(enemy_cell, "Image_name", 116.00, 33.00, "res/private/main/assist/1900012531.png")
	GUI:setAnchorPoint(Image_name, 0.50, 1.00)
	GUI:setTouchEnabled(Image_name, false)
	GUI:setTag(Image_name, -1)

	-- Create Text_name
	local Text_name = GUI:Text_Create(enemy_cell, "Text_name", 116.00, 25.00, 16, "#ffffff", [[xxxxx]])
	...
	-- Create Image_hp
	local Image_hp = GUI:Image_Create(enemy_cell, "Image_hp", 116.00, 10.00, "res/private/main/assist/1900012531.png")
	...
	local LoadingBar_hp = GUI:LoadingBar_Create(enemy_cell, "LoadingBar_hp", 116.00, 10.00, "res/private/main/assist/1900012532.png", 0)
