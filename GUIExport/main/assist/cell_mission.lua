...
function ui.init(parent)
	-- Create mission_cell
	local mission_cell = GUI:Layout_Create(parent, "mission_cell", 0.00, 0.00, 200.00, 60.00, false)
	GUI:setTouchEnabled(mission_cell, true)
	GUI:setTag(mission_cell, -1)

	-- Create Button_act
	local Button_act = GUI:Button_Create(mission_cell, "Button_act", 100.00, 30.00, "res/public/0.png")
	...
	-- Create Node_1
	local Node_1 = GUI:Node_Create(mission_cell, "Node_1", 10.00, 55.00)
	GUI:setTag(Node_1, -1)

	-- Create Node_2
	local Node_2 = GUI:Node_Create(mission_cell, "Node_2", 10.00, 30.00)
	GUI:setTag(Node_2, -1)
