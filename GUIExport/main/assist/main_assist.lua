...
function ui.init(parent)
	...
	local ListView_member = GUI:ListView_Create(Panel_member, "ListView_member", 101.00, 187.00, 200.00, 157.00, 1.0)
	GUI:ListView_setGravity(ListView_member, 5.0)
	...
	GUI:setTag(ListView_member, -1.0)
	...
	GUI:Button_setTitleFontSize(Button_invite, 14.0)
	GUI:Button_titleEnableOutline(Button_invite, "#000000", 1.0)
	...
	GUI:Button_setTitleFontSize(Button_member, 14.0)
	GUI:Button_titleEnableOutline(Button_member, "#000000", 1.0)
	GUI:setChineseName(Button_member, "队伍_队伍列表_按钮")
	GUI:setTouchEnabled(Button_member, true)
	GUI:setTag(Button_member, -1.0)
	...
	GUI:Button_setTitleFontSize(Button_create, 16.0)
	GUI:Button_titleEnableOutline(Button_create, "#000000", 1.0)
	...
	GUI:Button_setTitleFontSize(Button_near, 16.0)
	GUI:Button_titleEnableOutline(Button_near, "#000000", 1.0)
	GUI:setChineseName(Button_near, "队伍_附近队伍_按钮")
	GUI:setAnchorPoint(Button_near, 0.50, 0.50)
	GUI:setTouchEnabled(Button_near, true)
	GUI:setTag(Button_near, -1.0)
	...
	GUI:setTag(Panel_player, -1.0)

	-- Create ListView_player
	local ListView_player = GUI:ListView_Create(Panel_player, "ListView_player", 101.00, 94.00, 200.00, 185.00, 1.0)
	GUI:ListView_setGravity(ListView_player, 5.0)
	...
	GUI:setTag(ListView_player, -1.0)
	...
	GUI:setTag(Panel_monster, -1.0)

	-- Create ListView_monster
	local ListView_monster = GUI:ListView_Create(Panel_monster, "ListView_monster", 101.00, 94.00, 200.00, 185.00, 1.0)
	GUI:ListView_setGravity(ListView_monster, 5.0)
	...
	GUI:setTag(ListView_monster, -1.0)
	...
	GUI:setTag(Panel_hero_in, -1.0)

	-- Create ListView_hero
	local ListView_hero = GUI:ListView_Create(Panel_hero_in, "ListView_hero", 101.00, 94.00, 200.00, 185.00, 1.0)
	GUI:ListView_setGravity(ListView_hero, 5.0)
	GUI:setChineseName(ListView_hero, "英雄_列表")
	GUI:setAnchorPoint(ListView_hero, 0.50, 0.50)
	GUI:setTouchEnabled(ListView_hero, true)
	GUI:setTag(ListView_hero, -1.0)
	...
	GUI:setTag(BtnG_content, -1.0)

	-- Create Button_task
	local Button_task = GUI:Button_Create(BtnG_content, "Button_task", 21.00, 104.00, "res/private/main/assist/1900012554.png")
	...
	GUI:Button_setTitleFontSize(Button_task, 10.0)
	GUI:Button_titleEnableOutline(Button_task, "#000000", 1.0)
	GUI:setChineseName(Button_task, "任务_按钮")
	GUI:setAnchorPoint(Button_task, 0.50, 0.00)
	GUI:setTouchEnabled(Button_task, true)
	GUI:setTag(Button_task, -1.0)
	...
	GUI:Button_setTitleFontSize(Button_team, 10.0)
	GUI:Button_titleEnableOutline(Button_team, "#000000", 1.0)
	GUI:setChineseName(Button_team, "队伍_按钮")
	GUI:setAnchorPoint(Button_team, 0.50, 1.00)
	GUI:setTouchEnabled(Button_team, true)
	GUI:setTag(Button_team, -1.0)
	...
	GUI:Button_setTitleFontSize(Button_player, 10.0)
	GUI:Button_titleEnableOutline(Button_player, "#000000", 1.0)
	GUI:setChineseName(Button_player, "玩家_按钮")
	GUI:setAnchorPoint(Button_player, 0.50, 0.00)
	GUI:setTouchEnabled(Button_player, true)
	GUI:setTag(Button_player, -1.0)
	...
	GUI:Button_setTitleFontSize(Button_monster, 10.0)
	GUI:Button_titleEnableOutline(Button_monster, "#000000", 1.0)
	...
	GUI:Button_setTitleFontSize(Button_hero, 10.0)
	GUI:Button_titleEnableOutline(Button_hero, "#000000", 1.0)
	GUI:setChineseName(Button_hero, "英雄_按钮")
	GUI:setAnchorPoint(Button_hero, 0.50, 0.00)
	GUI:setTouchEnabled(Button_hero, true)
	GUI:setTag(Button_hero, -1.0)
	...
	GUI:Button_setTitleFontSize(Button_empty, 10.0)
	GUI:Button_titleEnableOutline(Button_empty, "#000000", 1.0)
	GUI:setChineseName(Button_empty, "空_按钮")
	GUI:setAnchorPoint(Button_empty, 0.50, 1.00)
	GUI:setTouchEnabled(Button_empty, true)
	GUI:setTag(Button_empty, -1.0)
	...
	GUI:Button_setTitleFontSize(Button_change, 10.0)
	GUI:Button_titleEnableOutline(Button_change, "#000000", 1.0)
	...
	GUI:Button_setTitleFontSize(Button_hide, 10.0)
	GUI:Button_titleEnableOutline(Button_hide, "#000000", 1.0)
	GUI:setChineseName(Button_hide, "任务伸缩_缩进")
	GUI:setAnchorPoint(Button_hide, 0.50, 0.50)
	GUI:setTouchEnabled(Button_hide, true)
	GUI:setTag(Button_hide, -1.0)
end
return ui