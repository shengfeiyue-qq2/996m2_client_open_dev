...
function ui.init(parent)
	...
	GUI:setTag(Image_target, -1.0)

	-- Create Image_icon
	local Image_icon = GUI:Image_Create(enemy_cell, "Image_icon", 31.00, 20.00, "res/private/main/assist/1900012534.png")
	GUI:setContentSize(Image_icon, 28.0, 28.0)
	...
	-- Create Image_name
	local Image_name = GUI:Image_Create(enemy_cell, "Image_name", 118.00, 33.00, "res/private/main/assist/1900012531.png")
	GUI:setChineseName(Image_name, "选中目标_目标昵称_背景图")
	GUI:setAnchorPoint(Image_name, 0.50, 1.00)
	GUI:setTouchEnabled(Image_name, false)
	GUI:setTag(Image_name, -1.0)

	-- Create Text_name
	local Text_name = GUI:Text_Create(enemy_cell, "Text_name", 118.00, 25.00, 16.0, "#ffffff", [[xxxxx]])
	...
	-- Create Image_hp
	local Image_hp = GUI:Image_Create(enemy_cell, "Image_hp", 118.00, 10.00, "res/private/main/assist/1900012531.png")
	GUI:setContentSize(Image_hp, 132.0, 8.0)
	...
	local LoadingBar_hp = GUI:LoadingBar_Create(enemy_cell, "LoadingBar_hp", 118.00, 10.00, "res/private/main/assist/1900012532.png", 0.0)
	GUI:setContentSize(LoadingBar_hp, 130.0, 6.0)
