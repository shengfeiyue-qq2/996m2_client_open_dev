...
function ui.init(parent)
	...
	-- Create Text_1
	local Text_1 = GUI:Text_Create(Main_Collect, "Text_1", 40.00, 10.00, 16, "#ffffff", [[采集]])
	...
	GUI:Layout_setBackGroundImageScale9Slice(Layout_BG, 16, 16, 16, 16)
	GUI:setTouchEnabled(Layout_BG, false)
	GUI:setTag(Layout_BG, -1)

	-- Create List_Collect_Select
	local List_Collect_Select = GUI:ListView_Create(Main_Collect, "List_Collect_Select", 68.00, 50.00, 200.00, 120.00, 1)
