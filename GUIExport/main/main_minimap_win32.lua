...
function ui.init(parent)
	...
	GUI:setTag(Text_mouse_pos, 60.0)
	GUI:Text_enableOutline(Text_mouse_pos, "#000000", 1.0)
	...
	GUI:setTag(Image_mapFlag, 65.0)
	GUI:setVisible(Image_mapFlag, false)

	-- Create Image_mapFlag_1
	local Image_mapFlag_1 = GUI:Image_Create(Main_Minimap, "Image_mapFlag_1", 0.00, 0.00, "res/private/main-win32/00150.png")
	...
	GUI:setTag(Image_mapFlag_1, 65.0)
