...
function ui.init(parent)
	...
	GUI:Button_setTitleFontSize(btn_rein_add, 10.0)
	GUI:Button_titleEnableOutline(btn_rein_add, "#000000", 1.0)
	...
	GUI:setTag(Image_19, -1.0)

	-- Create LoadingBar_exp
	local LoadingBar_exp = GUI:LoadingBar_Create(Panel_bg, "LoadingBar_exp", 895.00, 11.00, "res/private/main/1900012010.png", 0.0)
	...
	GUI:setTag(Image_battery, -1.0)

	-- Create LoadingBar_battery
	local LoadingBar_battery = GUI:LoadingBar_Create(Panel_bg, "LoadingBar_battery", 146.00, 11.00, "res/private/main/Other/1900012503.png", 0.0)
	GUI:LoadingBar_setPercent(LoadingBar_battery, 100.0)
	...
	GUI:setTag(LoadingBar_battery, -1.0)

	-- Create Text_FPS
	local Text_FPS = GUI:Text_Create(Panel_bg, "Text_FPS", 230.00, 11.00, 16.0, "#ffffff", [[FPS:60]])
	GUI:setChineseName(Text_FPS, "主界面操作_帧数_文本")
	GUI:setAnchorPoint(Text_FPS, 0.50, 0.50)
	GUI:setTouchEnabled(Text_FPS, false)
	GUI:setTag(Text_FPS, -1.0)
	GUI:Text_enableOutline(Text_FPS, "#000000", 1.0)
	...
	GUI:setTag(Image_divide, -1.0)

	-- Create LoadingBar_hp
	local LoadingBar_hp = GUI:LoadingBar_Create(Panel_hp, "LoadingBar_hp", 29.00, 52.00, "res/private/main/1900012032.png", 0.0)
	...
	GUI:setTag(LoadingBar_hp, -1.0)

	-- Create LoadingBar_mp
	local LoadingBar_mp = GUI:LoadingBar_Create(Panel_hp, "LoadingBar_mp", 71.00, 53.00, "res/private/main/1900012033.png", 0.0)
	...
	GUI:setTag(LoadingBar_mp, -1.0)

	-- Create LoadingBar_fhp
	local LoadingBar_fhp = GUI:LoadingBar_Create(Panel_hp, "LoadingBar_fhp", 52.00, 52.00, "res/private/main/1900012504.png", 0.0)
	...
	GUI:setTag(Image_1, -1.0)

	-- Create Text_hp
	local Text_hp = GUI:Text_Create(Panel_bg, "Text_hp", 350.00, 12.00, 16.0, "#ffffff", [[11/11]])
	GUI:setChineseName(Text_hp, "主界面操作_Hp_文本")
	GUI:setAnchorPoint(Text_hp, 0.50, 0.50)
	GUI:setTouchEnabled(Text_hp, false)
	GUI:setTag(Text_hp, -1.0)
	GUI:Text_enableOutline(Text_hp, "#000000", 1.0)

	-- Create Text_mp
	local Text_mp = GUI:Text_Create(Panel_bg, "Text_mp", 457.00, 12.00, 16.0, "#ffffff", [[11/11]])
	GUI:setChineseName(Text_mp, "主界面操作_Mp_文本")
	GUI:setAnchorPoint(Text_mp, 0.50, 0.50)
	GUI:setTouchEnabled(Text_mp, false)
	GUI:setTag(Text_mp, -1.0)
	GUI:Text_enableOutline(Text_mp, "#000000", 1.0)

	-- Create Text_level
	local Text_level = GUI:Text_Create(Panel_bg, "Text_level", 650.00, 12.00, 16.0, "#ffffff", [[1级]])
	GUI:setChineseName(Text_level, "主界面操作_等级_文本")
	GUI:setAnchorPoint(Text_level, 0.50, 0.50)
	GUI:setTouchEnabled(Text_level, false)
	GUI:setTag(Text_level, -1.0)
	GUI:Text_enableOutline(Text_level, "#000000", 1.0)

	-- Create Text_time
	local Text_time = GUI:Text_Create(Panel_bg, "Text_time", 1080.00, 12.00, 16.0, "#ffffff", [[-]])
	GUI:setChineseName(Text_time, "主界面操作_时间_文本")
	GUI:setAnchorPoint(Text_time, 0.50, 0.50)
	GUI:setTouchEnabled(Text_time, false)
	GUI:setTag(Text_time, -1.0)
	GUI:Text_enableOutline(Text_time, "#000000", 1.0)

	-- Create Text_exp
	local Text_exp = GUI:Text_Create(Panel_bg, "Text_exp", 895.00, 12.00, 16.0, "#ffffff", [[0%]])
	GUI:setChineseName(Text_exp, "主界面操作_经验百分比_文本")
	GUI:setAnchorPoint(Text_exp, 0.50, 0.50)
	GUI:setTouchEnabled(Text_exp, false)
	GUI:setTag(Text_exp, -1.0)
	GUI:Text_enableOutline(Text_exp, "#000000", 1.0)
	...
	GUI:setTag(Image_17_0, -1.0)

	-- Create Panel_mini_chat
	local Panel_mini_chat = GUI:Layout_Create(Main_Property, "Panel_mini_chat", -50.00, 25.00, 316.00, 108.00, false)
	GUI:setChineseName(Panel_mini_chat, "主界面操作袖珍聊天组合")
	GUI:setTouchEnabled(Panel_mini_chat, false)
	GUI:setTag(Panel_mini_chat, -1.0)
	...
	GUI:Image_setScale9Slice(Image_minichat_bg, 69, 69.0, 22, 22.0)
	GUI:setContentSize(Image_minichat_bg, 316.0, 108.0)
	...
	GUI:setTag(Image_minichat_bg, -1.0)

	-- Create ListView_minichat
	local ListView_minichat = GUI:ListView_Create(Panel_mini_chat, "ListView_minichat", 158.00, 0.00, 310.00, 105.00, 1.0)
	GUI:ListView_setGravity(ListView_minichat, 5.0)
	...
	GUI:setTag(ListView_minichat, -1.0)

	-- Create ListView_chat_ex
	local ListView_chat_ex = GUI:ListView_Create(Panel_mini_chat, "ListView_chat_ex", 158.00, 105.00, 310.00, 25.00, 1.0)
	...
	GUI:setTag(ListView_chat_ex, -1.0)
	...
	GUI:setTag(Panel_mini_chat_touch, -1.0)

	-- Create Image_barbg
	local Image_barbg = GUI:Image_Create(Main_Property, "Image_barbg", -55.00, 25.00, "res/private/main/angerBg2.png")
	GUI:setChineseName(Image_barbg, "主界面操作_怒气组合")
	GUI:setAnchorPoint(Image_barbg, 0.50, 0.00)
	GUI:setTouchEnabled(Image_barbg, false)
	GUI:setTag(Image_barbg, -1.0)
	...
	GUI:setTag(Image_bar, -1.0)

	-- Create Image_barbg_dz
	local Image_barbg_dz = GUI:Image_Create(Main_Property, "Image_barbg_dz", 274.00, 25.00, "res/private/main/douzhi_00.png")
	...
	GUI:setTag(bar_dz, -1.0)

	-- Create Image_barbg_zj
	local Image_barbg_zj = GUI:Image_Create(Main_Property, "Image_barbg_zj", 291.00, 25.00, "res/private/main/douzhi_00.png")
	...
	GUI:setTag(bar_zj, -1.0)

	-- Create Panel_quick
	local Panel_quick = GUI:Layout_Create(Main_Property, "Panel_quick", -50.00, 137.00, 316.00, 50.00, false)
	GUI:setChineseName(Panel_quick, "主界面快捷操作栏组合")
	GUI:setTouchEnabled(Panel_quick, false)
	GUI:setTag(Panel_quick, -1.0)

	-- Create Panel_quick_use_1
	local Panel_quick_use_1 = GUI:Layout_Create(Panel_quick, "Panel_quick_use_1", 0.00, 0.00, 50.00, 50.00, false)
	GUI:setChineseName(Panel_quick_use_1, "主界面_快捷操作栏1")
	GUI:setTouchEnabled(Panel_quick_use_1, true)
	GUI:setTag(Panel_quick_use_1, -1.0)

	-- Create Panel_quick_use_2
	local Panel_quick_use_2 = GUI:Layout_Create(Panel_quick, "Panel_quick_use_2", 53.00, 0.00, 50.00, 50.00, false)
	GUI:setChineseName(Panel_quick_use_2, "主界面_快捷操作栏2")
	GUI:setTouchEnabled(Panel_quick_use_2, true)
	GUI:setTag(Panel_quick_use_2, -1.0)

	-- Create Panel_quick_use_3
	local Panel_quick_use_3 = GUI:Layout_Create(Panel_quick, "Panel_quick_use_3", 106.00, 0.00, 50.00, 50.00, false)
	GUI:setChineseName(Panel_quick_use_3, "主界面_快捷操作栏3")
	GUI:setTouchEnabled(Panel_quick_use_3, true)
	GUI:setTag(Panel_quick_use_3, -1.0)

	-- Create Panel_quick_use_4
	local Panel_quick_use_4 = GUI:Layout_Create(Panel_quick, "Panel_quick_use_4", 159.00, 0.00, 50.00, 50.00, false)
	GUI:setChineseName(Panel_quick_use_4, "主界面_快捷操作栏4")
	GUI:setTouchEnabled(Panel_quick_use_4, true)
	GUI:setTag(Panel_quick_use_4, -1.0)

	-- Create Panel_quick_use_5
	local Panel_quick_use_5 = GUI:Layout_Create(Panel_quick, "Panel_quick_use_5", 212.00, 0.00, 50.00, 50.00, false)
	GUI:setChineseName(Panel_quick_use_5, "主界面_快捷操作栏5")
	GUI:setTouchEnabled(Panel_quick_use_5, true)
	GUI:setTag(Panel_quick_use_5, -1.0)

	-- Create Panel_quick_use_6
	local Panel_quick_use_6 = GUI:Layout_Create(Panel_quick, "Panel_quick_use_6", 265.00, 0.00, 50.00, 50.00, false)
	GUI:setChineseName(Panel_quick_use_6, "主界面_快捷操作栏6")
	GUI:setTouchEnabled(Panel_quick_use_6, true)
	GUI:setTag(Panel_quick_use_6, -1.0)

	-- Create Panel_bubble_tips
	local Panel_bubble_tips = GUI:Layout_Create(Main_Property, "Panel_bubble_tips", -172.00, 210.00, 150.00, 50.00, false)
	...
	GUI:setTag(Panel_bubble_tips, -1.0)
	...
	GUI:setTag(ListView_bubble_tips, -1.0)

	-- Create Panel_auto_tips
	local Panel_auto_tips = GUI:Layout_Create(Main_Property, "Panel_auto_tips", -50.00, 190.00, 316.00, 60.00, false)
	GUI:setChineseName(Panel_auto_tips, "主界面_自动挂机_提示")
	GUI:setTouchEnabled(Panel_auto_tips, false)
	GUI:setTag(Panel_auto_tips, -1.0)

	-- Create Button_chat_hide
	local Button_chat_hide = GUI:Button_Create(Main_Property, "Button_chat_hide", -75.00, 120.00, "res/private/main/chat_hide.png")
	...
	GUI:Button_setTitleFontSize(Button_chat_hide, 10.0)
	GUI:Button_titleEnableOutline(Button_chat_hide, "#000000", 1.0)
	GUI:setChineseName(Button_chat_hide, "主界面操作_聊天框隐藏_按钮")
	GUI:setTouchEnabled(Button_chat_hide, true)
	GUI:setTag(Button_chat_hide, -1.0)

	-- Create Node_quit_tip
	local Node_quit_tip = GUI:Node_Create(Main_Property, "Node_quit_tip", 0.00, 237.00)
	GUI:setChineseName(Node_quit_tip, "主界面_退出提示_节点")
	GUI:setTag(Node_quit_tip, -1.0)
end
return ui