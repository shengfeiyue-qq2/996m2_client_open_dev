...
function ui.init(parent)
	...
	-- Create Image_4
	local Image_4 = GUI:Image_Create(Panel_bg, "Image_4", 429.00, 25.00, "res/private/main/1900012000.png")
	...
	-- Create Panel_hp
	local Panel_hp = GUI:Layout_Create(Panel_bg, "Panel_hp", 464.00, 88.00, 104.00, 104.00, false)
	...
	local LoadingBar_hp = GUI:LoadingBar_Create(Panel_hp, "LoadingBar_hp", 28.00, 52.00, "res/private/main/1900012032.png", 0)
	...
	local LoadingBar_mp = GUI:LoadingBar_Create(Panel_hp, "LoadingBar_mp", 70.00, 52.00, "res/private/main/1900012033.png", 0)
	...
	-- Create Image_divide
	local Image_divide = GUI:Image_Create(Panel_hp, "Image_divide", 49.00, 52.00, "res/private/main/1900012507.png")
	...
	-- Create Text_mp
	local Text_mp = GUI:Text_Create(Panel_bg, "Text_mp", 456.00, 12.00, 16, "#ffffff", [[11/11]])
	...
	-- Create Text_exp
	local Text_exp = GUI:Text_Create(Panel_bg, "Text_exp", 894.00, 12.00, 16, "#ffffff", [[0%]])
