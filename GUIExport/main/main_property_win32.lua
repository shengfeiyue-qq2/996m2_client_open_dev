...
function ui.init(parent)
	...
	local Main_Property = GUI:Node_Create(parent, "Main_Property", 0.00, 0.00)
	GUI:setChineseName(Main_Property, "主界面操作节点")
	GUI:setAnchorPoint(Main_Property, 0.50, 0.50)
	GUI:setTag(Main_Property, -1.0)

	-- Create Panel_bg
	local Panel_bg = GUI:Layout_Create(Main_Property, "Panel_bg", 0.00, 0.00, 1024.00, 150.00, false)
	GUI:setChineseName(Panel_bg, "主界面操作_背景图")
	GUI:setAnchorPoint(Panel_bg, 0.50, 0.00)
	GUI:setTouchEnabled(Panel_bg, false)
	GUI:setTag(Panel_bg, 222.0)
	...
	GUI:setTag(Image_hp_bg, 228.0)

	-- Create LoadingBar_hp
	local LoadingBar_hp = GUI:LoadingBar_Create(Panel_hp, "LoadingBar_hp", 60.00, 112.00, "res/private/main-win32/1900000502.png", 0.0)
	GUI:LoadingBar_setPercent(LoadingBar_hp, 100.0)
	...
	GUI:setTag(LoadingBar_hp, 22.0)

	-- Create LoadingBar_mp
	local LoadingBar_mp = GUI:LoadingBar_Create(Panel_hp, "LoadingBar_mp", 108.00, 112.00, "res/private/main-win32/1900000503.png", 0.0)
	GUI:LoadingBar_setPercent(LoadingBar_mp, 100.0)
	...
	GUI:setTag(Image_fhp_bg, 25.0)

	-- Create LoadingBar_fhp
	local LoadingBar_fhp = GUI:LoadingBar_Create(Panel_hp, "LoadingBar_fhp", 85.00, 112.00, "res/private/main-win32/1900000501.png", 0.0)
	GUI:LoadingBar_setPercent(LoadingBar_fhp, 100.0)
	...
	GUI:setTag(LoadingBar_fhp, 24.0)
	...
	GUI:setTag(Panel_fhp_sfx, 197.0)
	...
	GUI:Button_setScale9Slice(Button_chat_1, 5, 5.0, 6, 4.0)
	GUI:setContentSize(Button_chat_1, 18.0, 17.0)
	...
	GUI:Button_setTitleFontSize(Button_chat_1, 14.0)
	...
	GUI:Button_setScale9Slice(Button_chat_2, 5, 5.0, 6, 4.0)
	GUI:setContentSize(Button_chat_2, 18.0, 17.0)
	...
	GUI:Button_setTitleFontSize(Button_chat_2, 14.0)
	...
	GUI:Button_setScale9Slice(Button_chat_3, 5, 5.0, 6, 4.0)
	GUI:setContentSize(Button_chat_3, 18.0, 17.0)
	...
	GUI:Button_setTitleFontSize(Button_chat_3, 14.0)
	...
	GUI:Button_setScale9Slice(Button_chat_4, 5, 5.0, 6, 4.0)
	GUI:setContentSize(Button_chat_4, 18.0, 17.0)
	...
	GUI:Button_setTitleFontSize(Button_chat_4, 14.0)
	...
	GUI:Button_setScale9Slice(Button_chat_5, 5, 5.0, 6, 4.0)
	GUI:setContentSize(Button_chat_5, 18.0, 17.0)
	...
	GUI:Button_setTitleFontSize(Button_chat_5, 14.0)
	...
	GUI:Button_setScale9Slice(Button_chat_6, 5, 5.0, 6, 4.0)
	GUI:setContentSize(Button_chat_6, 18.0, 17.0)
	...
	GUI:Button_setTitleFontSize(Button_chat_6, 14.0)
	...
	GUI:Button_setScale9Slice(Button_chat_7, 5, 5.0, 6, 4.0)
	GUI:setContentSize(Button_chat_7, 18.0, 17.0)
	...
	GUI:Button_setTitleFontSize(Button_chat_7, 14.0)
	...
	GUI:Image_setScale9Slice(Image_chat_bg, 25, 25.0, 72, 71.0)
	GUI:setContentSize(Image_chat_bg, 636.0, 155.0)
	...
	GUI:setTag(Image_chat_bg, 238.0)
	...
	GUI:setTag(Panel_chat_touch, 47.0)
	...
	GUI:setTag(Panel_chat_funcs, 33.0)
	...
	GUI:Button_setScale9Slice(Button_map, 8, 8.0, 4, 4.0)
	GUI:setContentSize(Button_map, 27.0, 13.0)
	...
	GUI:Button_setTitleFontSize(Button_map, 14.0)
	...
	GUI:Button_setScale9Slice(Button_trade, 8, 8.0, 4, 4.0)
	GUI:setContentSize(Button_trade, 27.0, 13.0)
	...
	GUI:Button_setTitleFontSize(Button_trade, 14.0)
	...
	GUI:Button_setScale9Slice(Button_guild, 8, 8.0, 4, 4.0)
	GUI:setContentSize(Button_guild, 27.0, 13.0)
	...
	GUI:Button_setTitleFontSize(Button_guild, 14.0)
	...
	GUI:Button_setScale9Slice(Button_near, 8, 8.0, 4, 4.0)
	GUI:setContentSize(Button_near, 27.0, 13.0)
	...
	GUI:Button_setScale9Slice(Button_rank, 8, 8.0, 4, 4.0)
	GUI:setContentSize(Button_rank, 27.0, 13.0)
	...
	GUI:Button_setTitleFontSize(Button_rank, 14.0)
	...
	GUI:Button_setScale9Slice(Button_private, 8, 8.0, 4, 4.0)
	GUI:setContentSize(Button_private, 28.0, 13.0)
	...
	GUI:Button_setTitleFontSize(Button_private, 14.0)
	...
	GUI:setTag(Button_private, 227.0)
	...
	GUI:Button_setScale9Slice(Button_drop, 9, 9.0, 4, 5.0)
	GUI:setContentSize(Button_drop, 28.0, 13.0)
	...
	GUI:Button_setTitleFontSize(Button_drop, 14.0)
	GUI:Button_titleEnableOutline(Button_drop, "#000000", 1.0)
	GUI:setChineseName(Button_drop, "聊天_掉落_按钮")
	GUI:setAnchorPoint(Button_drop, 0.50, 0.50)
	GUI:setTouchEnabled(Button_drop, true)
	GUI:setTag(Button_drop, 227.0)
	...
	GUI:Button_setScale9Slice(btn_rein_add, 4, 4.0, 4, 4.0)
	GUI:setContentSize(btn_rein_add, 27.0, 13.0)
	...
	GUI:Button_setTitleFontSize(btn_rein_add, 14.0)
	...
	GUI:setTag(Panel_exit_funcs, 38.0)
	...
	GUI:Button_setScale9Slice(Button_out, 8, 8.0, 4, 4.0)
	GUI:setContentSize(Button_out, 27.0, 13.0)
	...
	GUI:Button_setTitleFontSize(Button_out, 14.0)
	...
	GUI:Button_setScale9Slice(Button_end, 8, 8.0, 4, 4.0)
	GUI:setContentSize(Button_end, 27.0, 13.0)
	...
	GUI:Button_setTitleFontSize(Button_end, 14.0)
	...
	GUI:setTag(Button_end, 42.0)

	-- Create ListView_chat
	local ListView_chat = GUI:ListView_Create(Panel_chat, "ListView_chat", 318.00, 23.00, 608.00, 105.00, 1.0)
	GUI:ListView_setGravity(ListView_chat, 5.0)
	GUI:setChineseName(ListView_chat, "聊天_内容列表")
	GUI:setAnchorPoint(ListView_chat, 0.50, 0.00)
	GUI:setTouchEnabled(ListView_chat, true)
	GUI:setTag(ListView_chat, 239.0)
	...
	GUI:Button_setScale9Slice(Button_channel, 15, 15.0, 5, 5.0)
	GUI:setContentSize(Button_channel, 49.0, 16.0)
	...
	GUI:Button_setTitleFontSize(Button_channel, 14.0)
	...
	GUI:setTag(Button_channel, 143.0)
	...
	GUI:setTag(Text_channel, 144.0)

	-- Create TextField_input
	local TextField_input = GUI:TextInput_Create(Panel_chat, "TextField_input", 64.00, 6.00, 560.00, 15.00, 12.0)
	GUI:TextInput_setString(TextField_input, "")
	GUI:TextInput_setFontColor(TextField_input, "#000000")
	GUI:TextInput_setMaxLength(TextField_input, 10.0)
	GUI:setChineseName(TextField_input, "聊天_输入内容")
	GUI:setTouchEnabled(TextField_input, true)
	GUI:setTag(TextField_input, 17.0)

	-- Create ListView_chat_ex
	local ListView_chat_ex = GUI:ListView_Create(Panel_chat, "ListView_chat_ex", 318.00, 130.00, 608.00, 50.00, 1.0)
	GUI:ListView_setGravity(ListView_chat_ex, 5.0)
	...
	GUI:setTag(ListView_chat_ex, 48.0)
	...
	GUI:setTag(Panel_channel_s, 145.0)
	...
	GUI:Image_setScale9Slice(Image_channel_bg, 21, 21.0, 37, 29.0)
	GUI:setContentSize(Image_channel_bg, 52.0, 108.0)
	...
	GUI:setTag(Image_channel_bg, 147.0)

	-- Create ListView_channel
	local ListView_channel = GUI:ListView_Create(Panel_channel_s, "ListView_channel", 26.00, 3.00, 48.00, 102.00, 1.0)
	GUI:ListView_setGravity(ListView_channel, 2.0)
	...
	GUI:setTag(ListView_channel, 146.0)
	...
	GUI:setContentSize(Image_selected, 55.0, 16.0)
	...
	GUI:setTag(Image_selected, 149.0)
	...
	GUI:Button_setScale9Slice(Button_role, 1, 0.0, 1, 0.0)
	GUI:setContentSize(Button_role, 24.0, 24.0)
	...
	GUI:Button_setTitleFontSize(Button_role, 14.0)
	...
	GUI:Button_setScale9Slice(Button_bag, 1, 0.0, 1, 0.0)
	GUI:setContentSize(Button_bag, 24.0, 24.0)
	...
	GUI:Button_setTitleFontSize(Button_bag, 14.0)
	...
	GUI:Button_setScale9Slice(Button_skill, 1, 0.0, 1, 0.0)
	GUI:setContentSize(Button_skill, 24.0, 24.0)
	...
	GUI:Button_setTitleFontSize(Button_skill, 14.0)
	...
	GUI:Button_setScale9Slice(Button_voice, 1, 0.0, 1, 0.0)
	GUI:setContentSize(Button_voice, 24.0, 24.0)
	...
	GUI:Button_setTitleFontSize(Button_voice, 14.0)
	...
	GUI:Button_setScale9Slice(Button_store, 7, 7.0, 4, 4.0)
	GUI:setContentSize(Button_store, 28.0, 26.0)
	...
	GUI:Button_setTitleFontSize(Button_store, 14.0)
	...
	GUI:setTag(Image_time, 235.0)

	-- Create LoadingBar_exp
	local LoadingBar_exp = GUI:LoadingBar_Create(Panel_act, "LoadingBar_exp", 97.00, 64.00, "res/private/main-win32/00000041.png", 0.0)
	GUI:LoadingBar_setPercent(LoadingBar_exp, 100.0)
	...
	GUI:setTag(LoadingBar_exp, 282.0)

	-- Create LoadingBar_weight
	local LoadingBar_weight = GUI:LoadingBar_Create(Panel_act, "LoadingBar_weight", 97.00, 31.00, "res/private/main-win32/00000041.png", 0.0)
	GUI:LoadingBar_setPercent(LoadingBar_weight, 100.0)
	...
	GUI:setTag(LoadingBar_weight, 285.0)
	...
	GUI:Button_setScale9Slice(Button_herostate, 7, 7.0, 6, 6.0)
	GUI:setContentSize(Button_herostate, 23.0, 19.0)
	...
	GUI:Button_setTitleFontSize(Button_herostate, 14.0)
	...
	GUI:setTag(Button_herostate, 68.0)
	...
	GUI:Button_setScale9Slice(Button_heroinfo, 7, 7.0, 13, 9.0)
	GUI:setContentSize(Button_heroinfo, 23.0, 19.0)
	...
	GUI:Button_setTitleFontSize(Button_heroinfo, 14.0)
	...
	GUI:setTag(Button_heroinfo, 69.0)
	...
	GUI:Button_setScale9Slice(Button_herobag, 7, 7.0, 13, 9.0)
	GUI:setContentSize(Button_herobag, 23.0, 19.0)
	...
	GUI:Button_setTitleFontSize(Button_herobag, 14.0)
	...
	GUI:setTag(Button_herobag, 70.0)
	...
	GUI:Image_setScale9Slice(Image_laodBarbg, 6, 6.0, 45, 43.0)
	GUI:setContentSize(Image_laodBarbg, 20.0, 154.0)
	...
	GUI:setTag(Image_laodBarbg, 67.0)
	...
	GUI:Image_setScale9Slice(Image_loadbar1, 6, 6.0, 45, 43.0)
	GUI:setContentSize(Image_loadbar1, 20.0, 154.0)
	...
	GUI:setTag(Image_loadbar1, 68.0)
	...
	GUI:Image_setScale9Slice(Image_loadbar2, 6, 6.0, 45, 43.0)
	GUI:setContentSize(Image_loadbar2, 20.0, 155.0)
	...
	GUI:setTag(Image_loadbar2, 69.0)
	...
	GUI:setTag(Panel_channel, 237.0)
	...
	GUI:Button_setScale9Slice(Button_channel_0, 5, 5.0, 5, 5.0)
	GUI:setContentSize(Button_channel_0, 48.0, 23.0)
	...
	GUI:Button_setTitleFontSize(Button_channel_0, 14.0)
	...
	GUI:setTag(Button_channel_0, 238.0)
	...
	GUI:Button_setScale9Slice(Button_channel_1, 5, 5.0, 5, 5.0)
	GUI:setContentSize(Button_channel_1, 24.0, 23.0)
	...
	GUI:Button_setTitleFontSize(Button_channel_1, 14.0)
	...
	GUI:setTag(Button_channel_1, 239.0)
	...
	GUI:Button_setScale9Slice(Button_channel_2, 5, 5.0, 5, 5.0)
	GUI:setContentSize(Button_channel_2, 24.0, 23.0)
	...
	GUI:Button_setTitleFontSize(Button_channel_2, 14.0)
	...
	GUI:setTag(Button_channel_2, 240.0)
	...
	GUI:Button_setScale9Slice(Button_channel_3, 5, 5.0, 5, 5.0)
	GUI:setContentSize(Button_channel_3, 24.0, 23.0)
	...
	GUI:Button_setTitleFontSize(Button_channel_3, 14.0)
	...
	GUI:setTag(Button_channel_3, 241.0)
	...
	GUI:Button_setScale9Slice(Button_channel_4, 5, 5.0, 5, 5.0)
	GUI:setContentSize(Button_channel_4, 24.0, 23.0)
	...
	GUI:Button_setTitleFontSize(Button_channel_4, 14.0)
	...
	GUI:setTag(Button_channel_4, 242.0)
	...
	GUI:Button_setScale9Slice(Button_channel_5, 5, 5.0, 5, 5.0)
	GUI:setContentSize(Button_channel_5, 24.0, 23.0)
	...
	GUI:Button_setTitleFontSize(Button_channel_5, 14.0)
	...
	GUI:setTag(Button_channel_5, 243.0)
	...
	GUI:Button_setScale9Slice(Button_channel_6, 5, 5.0, 5, 5.0)
	GUI:setContentSize(Button_channel_6, 24.0, 23.0)
	...
	GUI:Button_setTitleFontSize(Button_channel_6, 14.0)
	...
	GUI:setTag(Button_channel_6, 244.0)
	...
	GUI:Button_setScale9Slice(Button_channel_7, 5, 5.0, 5, 5.0)
	GUI:setContentSize(Button_channel_7, 24.0, 23.0)
	...
	GUI:Button_setTitleFontSize(Button_channel_7, 14.0)
	...
	GUI:setTag(Button_channel_7, 245.0)
	...
	GUI:Button_setScale9Slice(Button_channel_8, 5, 5.0, 5, 5.0)
	GUI:setContentSize(Button_channel_8, 24.0, 23.0)
	...
	GUI:Button_setTitleFontSize(Button_channel_8, 14.0)
	...
	GUI:setTag(Button_channel_8, 246.0)

	-- Create Button_pick
	local Button_pick = GUI:Button_Create(Panel_act, "Button_pick", 194.00, 330.00, "res/private/main-win32/btn_zhijiemian_05.png")
	GUI:Button_setScale9Slice(Button_pick, 15, 15.0, 12, 10.0)
	GUI:setContentSize(Button_pick, 59.0, 59.0)
	...
	GUI:Button_setTitleFontSize(Button_pick, 14.0)
	...
	GUI:Layout_setBackGroundColorOpacity(Panel_ng_show, 140.0)
	GUI:setChineseName(Panel_ng_show, "主界面_连击组合")
	GUI:setTouchEnabled(Panel_ng_show, false)
	GUI:setTag(Panel_ng_show, -1.0)
	...
	GUI:setTag(Panel_bubble_tips, 55.0)

	-- Create ListView_bubble_tips
	local ListView_bubble_tips = GUI:ListView_Create(Panel_bubble_tips, "ListView_bubble_tips", 0.00, 0.00, 150.00, 50.00, 2.0)
	GUI:ListView_setGravity(ListView_bubble_tips, 3.0)
	GUI:setChineseName(ListView_bubble_tips, "提示信息列表(邮件/交易等)")
	GUI:setTouchEnabled(ListView_bubble_tips, false)
	GUI:setTag(ListView_bubble_tips, 56.0)

	-- Create Panel_mid
	local Panel_mid = GUI:Layout_Create(Main_Property, "Panel_mid", 0.00, 4.00, 500.00, 300.00, false)
	GUI:setChineseName(Panel_mid, "主界面_内功_背景图")
	GUI:setAnchorPoint(Panel_mid, 0.50, 0.00)
	GUI:setTouchEnabled(Panel_mid, false)
	GUI:setTag(Panel_mid, -1.0)
	...
	GUI:Image_setScale9Slice(Image_quick_bg, 69, 69.0, 22, 22.0)
	GUI:setContentSize(Image_quick_bg, 440.0, 54.0)
	...
	GUI:setTag(Image_quick_bg, 60.0)
	...
	GUI:setTag(Panel_quick_use_1, 46.0)
	...
	GUI:setTag(Panel_quick_use_2, 47.0)
	...
	GUI:setTag(Panel_quick_use_3, 48.0)
	...
	GUI:setTag(Panel_quick_use_4, 49.0)
	...
	GUI:setTag(Panel_quick_use_5, 50.0)
	...
	GUI:setTag(Panel_quick_use_6, 51.0)
	...
	GUI:setTag(Node_quit_tip, 305.0)
	...
	GUI:setTag(Panel_auto_tips, 58.0)

	-- Create Panel_hide_drop
	local Panel_hide_drop = GUI:Layout_Create(Main_Property, "Panel_hide_drop", 0.00, 0.00, 1024.00, 200.00, false)
	GUI:setAnchorPoint(Panel_hide_drop, 0.50, 0.00)
	GUI:setTouchEnabled(Panel_hide_drop, false)
	GUI:setTag(Panel_hide_drop, -1.0)

	-- Create Panel_drop
	local Panel_drop = GUI:Layout_Create(Main_Property, "Panel_drop", 227.00, 144.00, 88.00, 108.00, false)
	GUI:setChineseName(Panel_drop, "聊天_掉落屏蔽_组合")
	GUI:setAnchorPoint(Panel_drop, 0.50, 0.00)
	GUI:setTouchEnabled(Panel_drop, false)
	GUI:setTag(Panel_drop, 145.0)
	...
	GUI:Image_setScale9Slice(Image_drop_bg, 21, 21.0, 37, 29.0)
	GUI:setContentSize(Image_drop_bg, 88.0, 108.0)
	...
	GUI:setTag(Image_drop_bg, 147.0)

	-- Create ListView_drop
	local ListView_drop = GUI:ListView_Create(Panel_drop, "ListView_drop", 44.00, 3.00, 86.00, 102.00, 1.0)
	GUI:ListView_setClippingEnabled(ListView_drop, false)
	GUI:ListView_setGravity(ListView_drop, 2.0)
	...
	GUI:setTag(ListView_drop, 146.0)
end
return ui