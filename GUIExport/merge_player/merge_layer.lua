...
function ui.init(parent)
	...
	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(Scene, "Panel_1", 900.00, 330.00, 465.00, 598.00, false)
	...
	-- Create Image_1
	local Image_1 = GUI:Image_Create(Panel_1, "Image_1", 227.00, 300.00, "res/private/player_hero/img_bg1.png")
	...
	-- Create ButtonClose
	local ButtonClose = GUI:Button_Create(Image_1, "ButtonClose", 420.00, 486.00, "res/public/1900000510.png")
	...
	-- Create topLayout
	local topLayout = GUI:Layout_Create(Image_1, "topLayout", 215.00, 494.00, 164.00, 35.00, false)
	...
	local Panel_btnList = GUI:Layout_Create(Image_1, "Panel_btnList", 406.00, 462.00, 32.00, 454.00, false)
...
装]])
	...
	local Panel_btnList_ng = GUI:Layout_Create(Image_1, "Panel_btnList_ng", 406.00, 462.00, 32.00, 454.00, false)
...
击]])
	...
	-- Create Node_panel
	local Node_panel = GUI:Node_Create(Image_1, "Node_panel", 42.00, 20.00)
	GUI:setChineseName(Node_panel, "二合一_节点_面板")
	GUI:setAnchorPoint(Node_panel, 0.50, 0.50)
	GUI:setTag(Node_panel, 77)

	-- Create Text_Name
	local Text_Name = GUI:Text_Create(Image_1, "Text_Name", 215.00, 528.00, 18, "#ffe400", [[]])
