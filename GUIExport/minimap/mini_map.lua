...
function ui.init(parent)
	...
	local Image_mapNameBG = GUI:Image_Create(Panel_1, "Image_mapNameBG", 395.00, 525.00, "res/private/minimap/1900012107.png")
	GUI:setAnchorPoint(Image_mapNameBG, 0.50, 1.00)
	GUI:setTouchEnabled(Image_mapNameBG, false)
	GUI:setTag(Image_mapNameBG, -1)

	-- Create Text_mapName
	local Text_mapName = GUI:Text_Create(Panel_1, "Text_mapName", 395.00, 522.00, 16, "#ffffff", [[地图]])
