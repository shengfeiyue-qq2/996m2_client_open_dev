...
function ui.init(parent)
	...
	local Node_system_tips = GUI:Node_Create(Node_notice, "Node_system_tips", 568.00, 640.00)
	...
	-- Create Node_xy_tips
	local Node_xy_tips = GUI:Node_Create(Node_notice, "Node_xy_tips", 0.00, 0.00)
	GUI:setAnchorPoint(Node_xy_tips, 0.50, 0.50)
	GUI:setTag(Node_xy_tips, 8)
