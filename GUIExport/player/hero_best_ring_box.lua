...
function ui.init(parent)
	-- Create PMainUI
	local PMainUI = GUI:Layout_Create(parent, "PMainUI", 850.00, 384.00, 353.00, 325.00, false)
	GUI:setAnchorPoint(PMainUI, 0.50, 0.50)
	GUI:setTouchEnabled(PMainUI, true)
	GUI:setTag(PMainUI, -1)

	-- Create FrameBG
	local FrameBG = GUI:Image_Create(PMainUI, "FrameBG", 0.00, 0.00, "res/private/best_rings/bg_jewelry_1.png")
	GUI:setTouchEnabled(FrameBG, false)
	GUI:setTag(FrameBG, -1)

	-- Create line
	local line = GUI:Image_Create(PMainUI, "line", 176.00, 280.00, "res/public/word_sxbt_05.png")
	GUI:setAnchorPoint(line, 0.50, 0.50)
	GUI:setTouchEnabled(line, false)
	GUI:setTag(line, -1)

	-- Create ImageTitle
	local ImageTitle = GUI:Image_Create(PMainUI, "ImageTitle", 176.00, 280.00, "res/private/best_rings/img_jewelry_title.png")
	GUI:setAnchorPoint(ImageTitle, 0.50, 0.50)
	GUI:setTouchEnabled(ImageTitle, false)
	GUI:setTag(ImageTitle, -1)

	-- Create CloseButton
	local CloseButton = GUI:Button_Create(PMainUI, "CloseButton", 353.00, 325.00, "res/public/1900000510.png")
	...
	-- Create PanelItems
	local PanelItems = GUI:Layout_Create(PMainUI, "PanelItems", 30.00, 25.00, 292.00, 219.00, true)
	...
	-- Create DefaultIcon
	local DefaultIcon = GUI:Image_Create(PanelPos30, "DefaultIcon", 26.00, 26.00, "res/private/best_rings/shengxiao_1.png")
	...
	-- Create DefaultIcon
	local DefaultIcon = GUI:Image_Create(PanelPos31, "DefaultIcon", 26.00, 26.00, "res/private/best_rings/shengxiao_2.png")
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	GUI:setTag(DefaultIcon, -1)
	...
	-- Create DefaultIcon
	local DefaultIcon = GUI:Image_Create(PanelPos32, "DefaultIcon", 26.00, 26.00, "res/private/best_rings/shengxiao_3.png")
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	GUI:setTag(DefaultIcon, -1)
	...
	-- Create DefaultIcon
	local DefaultIcon = GUI:Image_Create(PanelPos33, "DefaultIcon", 26.00, 26.00, "res/private/best_rings/shengxiao_4.png")
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	GUI:setTag(DefaultIcon, -1)
	...
	-- Create DefaultIcon
	local DefaultIcon = GUI:Image_Create(PanelPos34, "DefaultIcon", 26.00, 26.00, "res/private/best_rings/shengxiao_5.png")
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	GUI:setTag(DefaultIcon, -1)
	...
	-- Create DefaultIcon
	local DefaultIcon = GUI:Image_Create(PanelPos35, "DefaultIcon", 26.00, 26.00, "res/private/best_rings/shengxiao_6.png")
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	GUI:setTag(DefaultIcon, -1)
	...
	-- Create DefaultIcon
	local DefaultIcon = GUI:Image_Create(PanelPos36, "DefaultIcon", 26.00, 26.00, "res/private/best_rings/shengxiao_7.png")
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	GUI:setTag(DefaultIcon, -1)
	...
	-- Create DefaultIcon
	local DefaultIcon = GUI:Image_Create(PanelPos37, "DefaultIcon", 26.00, 26.00, "res/private/best_rings/shengxiao_8.png")
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	GUI:setTag(DefaultIcon, -1)
	...
	-- Create DefaultIcon
	local DefaultIcon = GUI:Image_Create(PanelPos38, "DefaultIcon", 26.00, 26.00, "res/private/best_rings/shengxiao_9.png")
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	GUI:setTag(DefaultIcon, -1)
	...
	-- Create DefaultIcon
	local DefaultIcon = GUI:Image_Create(PanelPos39, "DefaultIcon", 26.00, 26.00, "res/private/best_rings/shengxiao_10.png")
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	GUI:setTag(DefaultIcon, -1)
	...
	-- Create DefaultIcon
	local DefaultIcon = GUI:Image_Create(PanelPos40, "DefaultIcon", 26.00, 26.00, "res/private/best_rings/shengxiao_11.png")
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	GUI:setTag(DefaultIcon, -1)
	...
	-- Create DefaultIcon
	local DefaultIcon = GUI:Image_Create(PanelPos41, "DefaultIcon", 26.00, 26.00, "res/private/best_rings/shengxiao_12.png")
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	GUI:setTag(DefaultIcon, -1)
	...
	-- Create PanelTouch
	local PanelTouch = GUI:Layout_Create(PMainUI, "PanelTouch", 30.00, 25.00, 292.00, 219.00, true)
