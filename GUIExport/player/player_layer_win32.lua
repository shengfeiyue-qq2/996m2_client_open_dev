...
function ui.init(parent)
	...
	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(Scene, "Panel_1", 900.00, 380.00, 305.00, 438.00, false)
	...
	-- Create Image_bg
	local Image_bg = GUI:Image_Create(Panel_1, "Image_bg", 152.00, 219.00, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015000.png")
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Button_101, "Text_name", 11.00, 62.00, 13, "#807256", [[装
备]])
	...
	-- Create Button_102
	local Button_102 = GUI:Button_Create(Panel_btnList, "Button_102", 0.00, 283.00, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015011.png")
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Button_102, "Text_name", 11.00, 62.00, 13, "#807256", [[状
态]])
	...
	-- Create Button_103
	local Button_103 = GUI:Button_Create(Panel_btnList, "Button_103", 0.00, 226.00, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015011.png")
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Button_103, "Text_name", 11.00, 62.00, 13, "#807256", [[属
性]])
	...
	-- Create Button_104
	local Button_104 = GUI:Button_Create(Panel_btnList, "Button_104", 0.00, 169.00, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015011.png")
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Button_104, "Text_name", 11.00, 62.00, 13, "#807256", [[技
能]])
	...
	-- Create Button_105
	local Button_105 = GUI:Button_Create(Panel_btnList, "Button_105", 0.00, 112.00, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015011.png")
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Button_105, "Text_name", 11.00, 62.00, 13, "#807256", [[称
号]])
	...
	-- Create Button_106
	local Button_106 = GUI:Button_Create(Panel_btnList, "Button_106", 0.00, 55.00, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015011.png")
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Button_106, "Text_name", 11.00, 62.00, 13, "#807256", [[时
装]])
	...
	-- Create Button_701
	local Button_701 = GUI:Button_Create(Panel_btnList_ng, "Button_701", 0.00, 340.00, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015011.png")
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Button_701, "Text_name", 11.00, 62.00, 13, "#807256", [[状
态]])
	...
	-- Create Button_702
	local Button_702 = GUI:Button_Create(Panel_btnList_ng, "Button_702", 0.00, 283.00, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015011.png")
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Button_702, "Text_name", 11.00, 62.00, 13, "#807256", [[技
能]])
	...
	-- Create Button_703
	local Button_703 = GUI:Button_Create(Panel_btnList_ng, "Button_703", 0.00, 226.00, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015011.png")
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Button_703, "Text_name", 11.00, 62.00, 13, "#807256", [[经
络]])
	...
	-- Create Button_704
	local Button_704 = GUI:Button_Create(Panel_btnList_ng, "Button_704", 0.00, 169.00, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015011.png")
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Button_704, "Text_name", 11.00, 62.00, 13, "#807256", [[连
击]])
	...
	-- Create Button_112
	local Button_112 = GUI:Button_Create(Panel_btnList_left, "Button_112", 0.00, 340.00, "res/public_win32/1900000683_1_f.png")
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Button_112, "Text_name", 14.00, 62.00, 13, "#807256", [[天
赋]])
