...
function ui.init(parent)
	...
	-- Create PanelBg
	local PanelBg = GUI:Image_Create(Panel_pos21, "PanelBg", 25.00, 25.00, "res/private/player_main_layer_ui/player_main_layer_ui_mobile/icon_chenghd_03.png")
	...
	-- Create DefaultIcon
	local DefaultIcon = GUI:Image_Create(Panel_pos21, "DefaultIcon", 25.00, 25.00, "res/private/gui_edit/ImageFile.png")
	...
	-- Create Panel_pos19
	local Panel_pos19 = GUI:Layout_Create(EquipUI, "Panel_pos19", 174.00, 322.00, 50.00, 50.00, false)
	...
	-- Create PanelBg
	local PanelBg = GUI:Image_Create(Panel_pos19, "PanelBg", 25.00, 25.00, "res/private/player_main_layer_ui/player_main_layer_ui_mobile/icon_chenghd_03.png")
	GUI:Image_setScale9Slice(PanelBg, 17, 17, 16, 14)
	GUI:setContentSize(PanelBg, 52, 52)
	GUI:setIgnoreContentAdaptWithSize(PanelBg, false)
	...
	-- Create DefaultIcon
	local DefaultIcon = GUI:Image_Create(Panel_pos19, "DefaultIcon", 25.00, 25.00, "res/private/gui_edit/ImageFile.png")
	...
	-- Create Node_19
	local Node_19 = GUI:Node_Create(EquipUI, "Node_19", 174.00, 324.00)
	GUI:setAnchorPoint(Node_19, 0.50, 0.50)
	GUI:setTag(Node_19, 51)

	-- Create Node_21
	local Node_21 = GUI:Node_Create(EquipUI, "Node_21", 174.00, 324.00)
	...
	local Text_shizhuang = GUI:Text_Create(EquipUI, "Text_shizhuang", 264.00, 453.00, 16, "#ffe400", [[时装外显示]])
