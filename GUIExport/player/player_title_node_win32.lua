...
function ui.init(parent)
	...
	GUI:setTag(Image_cur, 26.0)

	-- Create Button_curTitle
	local Button_curTitle = GUI:Button_Create(Image_cur, "Button_curTitle", 17.00, 17.00, "res/private/title_layer_ui_win32/title_3.png")
	GUI:Button_setScale9Slice(Button_curTitle, 15, 15.0, 11, 11.0)
	GUI:setContentSize(Button_curTitle, 40.0, 40.0)
	...
	GUI:Button_setTitleFontSize(Button_curTitle, 14.0)
	...
	GUI:setTag(Button_curTitle, 27.0)

	-- Create Image_11
	local Image_11 = GUI:Image_Create(Image_cur, "Image_11", 50.00, 17.00, "res/private/title_layer_ui_win32/title_1.png")
	GUI:setChineseName(Image_11, "玩家称号_背景框")
	GUI:setAnchorPoint(Image_11, 0.00, 0.50)
	GUI:setTouchEnabled(Image_11, false)
	GUI:setTag(Image_11, 28.0)

	-- Create Text_curTitle
	local Text_curTitle = GUI:Text_Create(Image_11, "Text_curTitle", 10.00, 15.00, 16.0, "#00b300", [[]])
	...
	GUI:setTag(Text_curTitle, 29.0)
	GUI:Text_enableOutline(Text_curTitle, "#111111", 1.0)
	...
	GUI:setTag(Image_12, 25.0)

	-- Create ListView_cells
	local ListView_cells = GUI:ListView_Create(Panel_1, "ListView_cells", 0.00, 5.00, 272.00, 260.00, 1.0)
	...
	GUI:setTag(ListView_cells, 24.0)
end
return ui