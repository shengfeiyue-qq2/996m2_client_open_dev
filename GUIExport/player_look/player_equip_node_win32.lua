...
function ui.init(parent)
	...
	-- Create Panel_pos101
	local Panel_pos101 = GUI:Layout_Create(Panel_1, "Panel_pos101", 24.00, 205.00, 42.00, 42.00, false)
	GUI:setAnchorPoint(Panel_pos101, 0.50, 0.50)
	GUI:setTouchEnabled(Panel_pos101, false)
	GUI:setTag(Panel_pos101, 144)
	GUI:setVisible(Panel_pos101, false)

	-- Create Image_bg
	local Image_bg = GUI:Image_Create(Panel_pos101, "Image_bg", 21.00, 21.00, "res/private/player_main_layer_ui/player_main_layer_ui_win32/icon_chenghd_03.png")
	GUI:setAnchorPoint(Image_bg, 0.50, 0.50)
	GUI:setTouchEnabled(Image_bg, false)
	GUI:setTag(Image_bg, 145)

	-- Create Image_icon
	local Image_icon = GUI:Image_Create(Panel_pos101, "Image_icon", 21.00, 21.00, "res/public/0.png")
	GUI:setAnchorPoint(Image_icon, 0.50, 0.50)
	GUI:setTouchEnabled(Image_icon, false)
	GUI:setTag(Image_icon, 146)

	-- Create Panel_pos100
	local Panel_pos100 = GUI:Layout_Create(Panel_1, "Panel_pos100", 24.00, 160.00, 42.00, 42.00, false)
	GUI:setAnchorPoint(Panel_pos100, 0.50, 0.50)
	GUI:setTouchEnabled(Panel_pos100, false)
	GUI:setTag(Panel_pos100, 144)
	GUI:setVisible(Panel_pos100, false)

	-- Create Image_bg
	local Image_bg = GUI:Image_Create(Panel_pos100, "Image_bg", 21.00, 21.00, "res/private/player_main_layer_ui/player_main_layer_ui_win32/icon_chenghd_03.png")
	GUI:setAnchorPoint(Image_bg, 0.50, 0.50)
	GUI:setTouchEnabled(Image_bg, false)
	GUI:setTag(Image_bg, 145)

	-- Create Image_icon
	local Image_icon = GUI:Image_Create(Panel_pos100, "Image_icon", 21.00, 21.00, "res/public/0.png")
	GUI:setAnchorPoint(Image_icon, 0.50, 0.50)
	GUI:setTouchEnabled(Image_icon, false)
	GUI:setTag(Image_icon, 146)
	...
	-- Create Node_101
	local Node_101 = GUI:Node_Create(Panel_1, "Node_101", 24.00, 205.00)
	GUI:setAnchorPoint(Node_101, 0.50, 0.50)
	GUI:setTag(Node_101, 147)
	GUI:setVisible(Node_101, false)

	-- Create Node_100
	local Node_100 = GUI:Node_Create(Panel_1, "Node_100", 24.00, 160.00)
	GUI:setAnchorPoint(Node_100, 0.50, 0.50)
	GUI:setTag(Node_100, 147)
