...
function ui.init(parent)
	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(parent, "Panel_1", 900.00, 340.00, 382.00, 571.00, false)
...
装]])
	...
	GUI:setTag(Button_112, -1.0)
	GUI:setVisible(Button_112, false)

	-- Create Text_name
	local Text_name = GUI:Text_Create(Button_112, "Text_name", 13.00, 78.00, 16.0, "#807256", [[天
赋]])
