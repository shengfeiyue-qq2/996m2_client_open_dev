...
function ui.init(parent)
	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(parent, "Panel_1", 900.00, 340.00, 382.00, 572.00, false)
	...
	-- Create Text_Name
	local Text_Name = GUI:Text_Create(Panel_1, "Text_Name", 191.00, 528.00, 18, "#ffe400", [[]])
	...
	-- Create Node_panel
	local Node_panel = GUI:Node_Create(Panel_1, "Node_panel", 18.00, 18.00)
...
装]])
	...
	-- Create Button_112
	local Button_112 = GUI:Button_Create(Panel_btnList, "Button_112", 0.00, 238.00, "res/public/1900000641.png")
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Button_112, "Text_name", 13.00, 78.00, 16, "#807256", [[天
赋]])
