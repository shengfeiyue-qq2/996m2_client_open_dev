...
function ui.init(parent)
	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(parent, "Panel_1", 900.00, 325.00, 305.00, 428.00, false)
...
装]])
	...
	-- Create Button_112
	local Button_112 = GUI:Button_Create(Panel_btnList, "Button_112", 0.00, 170.00, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015011.png")
	...
	GUI:Button_setTitleFontSize(Button_112, 14.0)
	GUI:Button_titleEnableOutline(Button_112, "#000000", 1.0)
	GUI:setChineseName(Button_112, "玩家面板_buff_按钮")
	GUI:setAnchorPoint(Button_112, 0.00, 1.00)
	GUI:setTouchEnabled(Button_112, true)
	GUI:setTag(Button_112, 127.0)
	GUI:setVisible(Button_112, false)

	-- Create Text_name
	local Text_name = GUI:Text_Create(Button_112, "Text_name", 11.00, 62.00, 13.0, "#807256", [[天
赋]])
