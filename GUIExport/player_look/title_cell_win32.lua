...
function ui.init(parent)
	-- Create Cell_title
	local Cell_title = GUI:Layout_Create(parent, "Cell_title", 0.00, 0.00, 278.00, 42.00, false)
	GUI:setChineseName(Cell_title, "玩家称号_组合")
	GUI:setTouchEnabled(Cell_title, true)
	GUI:setTag(Cell_title, 40.0)

	-- Create Image_bg
	local Image_bg = GUI:Image_Create(Cell_title, "Image_bg", 25.00, 21.00, "res/private/title_layer_ui_win32/title_6.png")
	GUI:setChineseName(Image_bg, "玩家称号_图标背景框")
	GUI:setAnchorPoint(Image_bg, 0.50, 0.50)
	GUI:setTouchEnabled(Image_bg, false)
	GUI:setTag(Image_bg, 41.0)
	...
	GUI:setContentSize(Button_icon, 32.0, 32.0)
	...
	GUI:setTag(Button_icon, 42.0)

	-- Create Text_name
	local Text_name = GUI:Text_Create(Image_bg, "Text_name", 50.00, 14.00, 16.0, "#00b300", [[Text Label]])
	...
	-- Create Image_3
	local Image_3 = GUI:Image_Create(Cell_title, "Image_3", 139.00, 3.00, "res/public/1900000667.png")
	GUI:setContentSize(Image_3, 278.0, 2.0)
