...
function ui.init(parent)
	...
	GUI:Image_setScale9Slice(Image_bg, 17, 17.0, 16, 14.0)
	GUI:setContentSize(Image_bg, 52.0, 52.0)
	GUI:setIgnoreContentAdaptWithSize(Image_bg, false)
	GUI:setChineseName(Image_bg, "玩家时装_右手镯_物品框")
	GUI:setAnchorPoint(Image_bg, 0.50, 0.50)
	GUI:setTouchEnabled(Image_bg, false)
	GUI:setTag(Image_bg, 50.0)
	...
	GUI:setContentSize(Image_icon, 47.0, 37.0)
	...
	GUI:setContentSize(Image_icon, 47.0, 43.0)
	GUI:setIgnoreContentAdaptWithSize(Image_icon, false)
	GUI:setChineseName(Image_icon, "玩家时装_勋章_图标")
	GUI:setAnchorPoint(Image_icon, 0.50, 0.50)
	GUI:setTouchEnabled(Image_icon, false)
	GUI:setTag(Image_icon, 76.0)
