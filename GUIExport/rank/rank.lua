...
function ui.init(parent)
	...
	local Panel_btnList = GUI:Layout_Create(Panel_1, "Panel_btnList", 10.00, 46.00, 60.00, 370.00, false)
	...
	-- Create Button_close
	local Button_close = GUI:Button_Create(Panel_1, "Button_close", 778.00, 446.00, "res/public/1900000510.png")
