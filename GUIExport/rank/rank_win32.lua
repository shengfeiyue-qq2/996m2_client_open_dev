...
function ui.init(parent)
	...
	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(Scene, "Panel_1", 568.00, 359.00, 838.00, 444.00, false)
	...
	-- Create Panel_bg
	local Panel_bg = GUI:Layout_Create(Panel_1, "Panel_bg", 0.00, 226.00, 838.00, 444.00, false)
	...
	-- Create Image_bg
	local Image_bg = GUI:Image_Create(Panel_bg, "Image_bg", 419.00, 222.00, "res/private/rank_ui/rank_ui_win32/1900020020.png")
	GUI:Image_setScale9Slice(Image_bg, 340, 340, 204, 204)
	GUI:setContentSize(Image_bg, 838, 444)
	...
	-- Create Panel_type
	local Panel_type = GUI:Layout_Create(Panel_1, "Panel_type", 136.00, 392.00, 185.00, 45.00, false)
	...
	-- Create Button_1
	local Button_1 = GUI:Button_Create(Panel_player, "Button_1", 44.00, 16.00, "res/private/rank_ui/rank_ui_win32/1900012110.png")
	...
	-- Create Button_2
	local Button_2 = GUI:Button_Create(Panel_hero, "Button_2", 44.00, 16.00, "res/private/rank_ui/rank_ui_win32/1900012110.png")
	...
	local Panel_btnList = GUI:Layout_Create(Panel_1, "Panel_btnList", 72.00, 27.00, 110.00, 354.00, false)
	GUI:setChineseName(Panel_btnList, "排行榜_排行分类组合")
	GUI:setTouchEnabled(Panel_btnList, true)
	GUI:setTag(Panel_btnList, 33)

	-- Create ListView_btn
	local ListView_btn = GUI:ListView_Create(Panel_btnList, "ListView_btn", 0.00, 354.00, 112.00, 354.00, 1)
	...
	local Panel_content = GUI:Layout_Create(Panel_1, "Panel_content", 190.00, 27.00, 590.00, 354.00, false)
	GUI:setTouchEnabled(Panel_content, false)
	GUI:setTag(Panel_content, -1)

	-- Create ListView_list
	local ListView_list = GUI:ListView_Create(Panel_content, "ListView_list", 5.00, 41.00, 370.00, 307.00, 1)
	...
	-- Create Node_model
	local Node_model = GUI:Node_Create(Panel_content, "Node_model", 512.00, 158.00)
	GUI:setChineseName(Node_model, "排行榜_模型_节点")
	GUI:setAnchorPoint(Node_model, 0.50, 0.50)
	GUI:setTag(Node_model, 47)

	-- Create Button_looks
	local Button_looks = GUI:Button_Create(Panel_content, "Button_looks", 516.00, 36.00, "res/public_win32/1900000679.png")
	...
	-- Create Panel_myInfo
	local Panel_myInfo = GUI:Layout_Create(Panel_content, "Panel_myInfo", 5.00, 14.00, 370.00, 26.00, false)
	...
	-- Create Image_title
	local Image_title = GUI:Image_Create(Panel_1, "Image_title", 422.00, 405.00, "res/private/rank_ui/rank_ui_win32/1900020024.png")
	...
	-- Create Button_close
	local Button_close = GUI:Button_Create(Panel_1, "Button_close", 797.00, 375.00, "res/public_win32/1900000530.png")
