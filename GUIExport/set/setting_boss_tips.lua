...
function ui.init(parent)
	...
	-- Create Panel_cancel
	local Panel_cancel = GUI:Layout_Create(Scene, "Panel_cancel", 0.00, 0.00, 3000.00, 3000.00, false)
	...
	GUI:setChineseName(Panel_cancel, "BOSS提示_范围点击关闭")
	GUI:setTouchEnabled(Panel_cancel, true)
	GUI:setTag(Panel_cancel, 68)
