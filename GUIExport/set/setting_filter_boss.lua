...
function ui.init(parent)
	...
	-- Create Image_10
	local Image_10 = GUI:Image_Create(Panel_1, "Image_10", 14.00, 34.00, "res/private/setting/textBg.png")
	...
	local Button_addMonster = GUI:Button_Create(Panel_1, "Button_addMonster", 267.00, 33.00, "res/private/setting/btnbg.png")
