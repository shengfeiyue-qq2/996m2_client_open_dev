...
function ui.init(parent)
	...
	-- Create FrameBG
	local FrameBG = GUI:Image_Create(PMainUI, "FrameBG", 0.00, 0.00, "res/public/1900000610.png")
	...
	-- Create TitleText
	local TitleText = GUI:Text_Create(PMainUI, "TitleText", 36.00, 498.00, 20, "#d8c8ae", [[]])
	...
	-- Create AttachLayout
	local AttachLayout = GUI:Layout_Create(PMainUI, "AttachLayout", 30.00, 40.00, 732.00, 445.00, false)
	GUI:setChineseName(AttachLayout, "内挂主界面_设置面板")
	GUI:setTouchEnabled(AttachLayout, false)
	GUI:setTag(AttachLayout, -1)

	-- Create CloseButton
	local CloseButton = GUI:Button_Create(PMainUI, "CloseButton", 780.00, 492.00, "res/public/1900000510.png")
	...
	-- Create PageText
	local PageText = GUI:Text_Create(page_cell_1, "PageText", 13.00, 62.00, 16, "#807256", [[基
础]])
	...
	-- Create PageText
	local PageText = GUI:Text_Create(page_cell_2, "PageText", 13.00, 62.00, 16, "#807256", [[视
距]])
	...
	-- Create PageText
	local PageText = GUI:Text_Create(page_cell_3, "PageText", 13.00, 62.00, 16, "#807256", [[战
斗]])
	...
	-- Create PageText
	local PageText = GUI:Text_Create(page_cell_4, "PageText", 13.00, 62.00, 16, "#807256", [[保
护]])
	...
	-- Create PageText
	local PageText = GUI:Text_Create(page_cell_5, "PageText", 13.00, 62.00, 16, "#807256", [[挂
机]])
	...
	-- Create PageText
	local PageText = GUI:Text_Create(page_cell_6, "PageText", 13.00, 62.00, 16, "#807256", [[帮
助]])
	...
	-- Create TouchSize
	local TouchSize = GUI:Layout_Create(page_cell_6, "TouchSize", 0.00, 92.00, 33.00, 75.00, false)
