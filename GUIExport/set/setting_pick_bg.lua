...
function ui.init(parent)
	...
	-- Create Text_type
	local Text_type = GUI:Text_Create(Panel_title, "Text_type", 66.00, 18.00, 16, "#ffffff", [[类型]])
	...
	-- Create Text_drop
	local Text_drop = GUI:Text_Create(Panel_title, "Text_drop", 188.00, 18.00, 16, "#ffffff", [[显示名字]])
	...
	-- Create Text_pick
	local Text_pick = GUI:Text_Create(Panel_title, "Text_pick", 316.00, 18.00, 16, "#ffffff", [[手动拾取]])
	...
	local Text_pick_hang_up = GUI:Text_Create(Panel_title, "Text_pick_hang_up", 444.00, 18.00, 16, "#ffffff", [[挂机拾取]])
	...
	-- Create Text_jp_pick
	local Text_jp_pick = GUI:Text_Create(Panel_title, "Text_jp_pick", 572.00, 18.00, 16, "#ffffff", [[极品拾取]])
	GUI:setAnchorPoint(Text_jp_pick, 0.50, 0.50)
	GUI:setTouchEnabled(Text_jp_pick, false)
	GUI:setTag(Text_jp_pick, -1)
	GUI:Text_enableOutline(Text_jp_pick, "#000000", 1)

	-- Create Text_desc
	local Text_desc = GUI:Text_Create(Panel_title, "Text_desc", 678.00, 18.00, 16, "#ffffff", [[详细信息]])
