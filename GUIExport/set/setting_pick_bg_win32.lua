...
function ui.init(parent)
	...
	-- Create Text_type
	local Text_type = GUI:Text_Create(Panel_title, "Text_type", 60.00, 17.00, 14, "#ffffff", [[类型]])
	...
	-- Create Text_drop
	local Text_drop = GUI:Text_Create(Panel_title, "Text_drop", 170.00, 17.00, 14, "#ffffff", [[显示名字]])
	...
	-- Create Text_pick
	local Text_pick = GUI:Text_Create(Panel_title, "Text_pick", 270.00, 17.00, 14, "#ffffff", [[手动拾取]])
	...
	local Text_pick_hang_up = GUI:Text_Create(Panel_title, "Text_pick_hang_up", 370.00, 17.00, 14, "#ffffff", [[挂机拾取]])
	...
	-- Create Text_pick_jp
	local Text_pick_jp = GUI:Text_Create(Panel_title, "Text_pick_jp", 470.00, 17.00, 14, "#ffffff", [[极品拾取]])
	GUI:setChineseName(Text_pick_jp, "拾取设置_极品拾取_文本")
	GUI:setAnchorPoint(Text_pick_jp, 0.50, 0.50)
	GUI:setTouchEnabled(Text_pick_jp, false)
	GUI:setTag(Text_pick_jp, 15)
	GUI:Text_enableOutline(Text_pick_jp, "#000000", 1)

	-- Create Text_desc
	local Text_desc = GUI:Text_Create(Panel_title, "Text_desc", 556.00, 17.00, 14, "#ffffff", [[详细信息]])
