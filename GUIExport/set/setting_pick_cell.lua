...
function ui.init(parent)
	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(parent, "Panel_1", 0.00, 0.00, 476.00, 60.00, false)
	GUI:setChineseName(Panel_1, "拾取设置_组合")
	GUI:setTouchEnabled(Panel_1, true)
	GUI:setTag(Panel_1, 45)

	-- Create Text_name
	local Text_name = GUI:Text_Create(Panel_1, "Text_name", 70.00, 30.00, 16, "#ffffff", [[类型]])
	...
	-- Create Image_3
	local Image_3 = GUI:Image_Create(Panel_1, "Image_3", 238.00, 0.00, "res/public/1900000667.png")
	GUI:setContentSize(Image_3, 476, 2)
	...
	-- Create Panel_drop
	local Panel_drop = GUI:Layout_Create(Panel_1, "Panel_drop", 176.00, 8.00, 80.00, 40.00, false)
	...
	-- Create Panel_pick
	local Panel_pick = GUI:Layout_Create(Panel_1, "Panel_pick", 262.00, 8.00, 80.00, 40.00, false)
	...
	local Panel_pick_hang_up = GUI:Layout_Create(Panel_1, "Panel_pick_hang_up", 346.00, 8.00, 80.00, 40.00, false)
	...
	local Panel_pick_jp = GUI:Layout_Create(Panel_1, "Panel_pick_jp", 432.00, 8.00, 80.00, 40.00, false)
	...
	local CheckBox_pick_jp = GUI:CheckBox_Create(Panel_pick_jp, "CheckBox_pick_jp", 42.00, 21.00, "res/public/1900000550.png", "res/public/1900000551.png")
	GUI:CheckBox_setSelected(CheckBox_pick_jp, true)
	GUI:setChineseName(CheckBox_pick_jp, "拾取设置_极品拾取")
