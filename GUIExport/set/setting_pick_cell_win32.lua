...
function ui.init(parent)
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Panel_1, "Text_name", 64.00, 31.00, 12, "#ffffff", [[类型]])
	...
	-- Create Panel_drop
	local Panel_drop = GUI:Layout_Create(Panel_1, "Panel_drop", 146.00, 8.00, 68.00, 40.00, false)
	...
	local CheckBox_drop = GUI:CheckBox_Create(Panel_drop, "CheckBox_drop", 34.00, 20.00, "res/public/1900000550.png", "res/public/1900000551.png")
	...
	-- Create Panel_pick
	local Panel_pick = GUI:Layout_Create(Panel_1, "Panel_pick", 220.00, 8.00, 68.00, 40.00, false)
	...
	local CheckBox_pick = GUI:CheckBox_Create(Panel_pick, "CheckBox_pick", 34.00, 20.00, "res/public/1900000550.png", "res/public/1900000551.png")
	...
	local Panel_pick_hang_up = GUI:Layout_Create(Panel_1, "Panel_pick_hang_up", 294.00, 8.00, 68.00, 40.00, false)
	...
	local CheckBox_pick_hang_up = GUI:CheckBox_Create(Panel_pick_hang_up, "CheckBox_pick_hang_up", 34.00, 20.00, "res/public/1900000550.png", "res/public/1900000551.png")
	...
	local Panel_pick_jp = GUI:Layout_Create(Panel_1, "Panel_pick_jp", 368.00, 8.00, 68.00, 40.00, false)
	GUI:setChineseName(Panel_pick_jp, "拾取设置_极品拾取组合")
	...
	local CheckBox_pick_jp = GUI:CheckBox_Create(Panel_pick_jp, "CheckBox_pick_jp", 34.00, 20.00, "res/public/1900000550.png", "res/public/1900000551.png")
	GUI:CheckBox_setSelected(CheckBox_pick_jp, true)
	GUI:setChineseName(CheckBox_pick_jp, "拾取设置_手动拾取")
	GUI:setAnchorPoint(CheckBox_pick_jp, 0.50, 0.50)
	GUI:setTouchEnabled(CheckBox_pick_jp, false)
	GUI:setTag(CheckBox_pick_jp, 48)
end
return ui