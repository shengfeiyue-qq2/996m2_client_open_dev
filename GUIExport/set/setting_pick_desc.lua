...
function ui.init(parent)
	...
	-- Create Panel_2
	local Panel_2 = GUI:Layout_Create(Panel_PickDesc, "Panel_2", 366.00, 222.00, 476.00, 448.00, false)
	...
	GUI:setContentSize(Image_4, 476, 448)
	...
	-- Create Panel_title
	local Panel_title = GUI:Layout_Create(Panel_2, "Panel_title", 0.00, 442.00, 476.00, 50.00, false)
	...
	-- Create Text_type
	local Text_type = GUI:Text_Create(Panel_title, "Text_type", 66.00, 25.00, 16, "#ffffff", [[类型]])
	...
	-- Create Text_drop
	local Text_drop = GUI:Text_Create(Panel_title, "Text_drop", 176.00, 25.00, 16, "#ffffff", [[显示名字]])
	...
	-- Create Text_pick
	local Text_pick = GUI:Text_Create(Panel_title, "Text_pick", 262.00, 25.00, 16, "#ffffff", [[手动拾取]])
	...
	local Text_pick_hang_up = GUI:Text_Create(Panel_title, "Text_pick_hang_up", 346.00, 25.00, 16, "#ffffff", [[挂机拾取]])
	...
	-- Create Text_pick_jp
	local Text_pick_jp = GUI:Text_Create(Panel_title, "Text_pick_jp", 432.00, 25.00, 16, "#ffffff", [[极品拾取]])
	GUI:setChineseName(Text_pick_jp, "查看_极品拾取_文本")
	GUI:setAnchorPoint(Text_pick_jp, 0.50, 0.50)
	GUI:setTouchEnabled(Text_pick_jp, false)
	GUI:setTag(Text_pick_jp, 59)
	GUI:Text_enableOutline(Text_pick_jp, "#000000", 1)

	-- Create Image_5
	local Image_5 = GUI:Image_Create(Panel_title, "Image_5", 238.00, 0.00, "res/public/1900000667.png")
	GUI:setContentSize(Image_5, 476, 2)
	...
	-- Create ListView_1
	local ListView_1 = GUI:ListView_Create(Panel_2, "ListView_1", 238.00, 390.00, 476.00, 388.00, 1)
