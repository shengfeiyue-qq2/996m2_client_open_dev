...
function ui.init(parent)
	...
	-- Create Text_type
	local Text_type = GUI:Text_Create(Panel_title, "Text_type", 64.00, 24.00, 14, "#ffffff", [[类型]])
	...
	-- Create Text_drop
	local Text_drop = GUI:Text_Create(Panel_title, "Text_drop", 146.00, 24.00, 14, "#ffffff", [[显示名字]])
	...
	-- Create Text_pick
	local Text_pick = GUI:Text_Create(Panel_title, "Text_pick", 220.00, 24.00, 14, "#ffffff", [[手动拾取]])
	...
	local Text_pick_hang_up = GUI:Text_Create(Panel_title, "Text_pick_hang_up", 294.00, 24.00, 14, "#ffffff", [[挂机拾取]])
	...
	-- Create Text_pick_jp
	local Text_pick_jp = GUI:Text_Create(Panel_title, "Text_pick_jp", 368.00, 24.00, 14, "#ffffff", [[极品拾取]])
	...
	-- Create ListView_1
	local ListView_1 = GUI:ListView_Create(Panel_2, "ListView_1", 215.00, 337.00, 430.00, 335.00, 1)
