...
function ui.init(parent)
	...
	-- Create Text_type
	local Text_type = GUI:Text_Create(Panel_1, "Text_type", 68.00, 22.00, 16, "#ffffff", [[1-25级装备]])
	...
	-- Create Text_desc
	local Text_desc = GUI:Text_Create(Panel_1, "Text_desc", 678.00, 22.00, 16, "#ebf291", [[查看]])
	...
	-- Create Panel_drop
	local Panel_drop = GUI:Layout_Create(Panel_1, "Panel_drop", 188.00, 4.00, 100.00, 36.00, false)
	...
	-- Create Panel_pick
	local Panel_pick = GUI:Layout_Create(Panel_1, "Panel_pick", 316.00, 4.00, 100.00, 36.00, false)
	...
	local Panel_pick_hang_up = GUI:Layout_Create(Panel_1, "Panel_pick_hang_up", 444.00, 3.00, 100.00, 36.00, false)
	...
	local Panel_pick_jp = GUI:Layout_Create(Panel_1, "Panel_pick_jp", 572.00, 3.00, 100.00, 36.00, false)
	...
	local CheckBox_pick_jp = GUI:CheckBox_Create(Panel_pick_jp, "CheckBox_pick_jp", 50.00, 18.00, "res/public/1900000550.png", "res/public/1900000551.png")
	...
	GUI:setTag(CheckBox_pick_jp, 24)
end
return ui