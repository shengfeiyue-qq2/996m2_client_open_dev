...
function ui.init(parent)
	...
	-- Create Text_desc
	local Text_desc = GUI:Text_Create(Panel_1, "Text_desc", 556.00, 22.00, 12, "#ebf291", [[查看]])
	...
	-- Create Panel_drop
	local Panel_drop = GUI:Layout_Create(Panel_1, "Panel_drop", 170.00, 4.00, 96.00, 35.00, false)
	...
	local CheckBox_drop = GUI:CheckBox_Create(Panel_drop, "CheckBox_drop", 48.00, 17.00, "res/public/1900000550.png", "res/public/1900000551.png")
	...
	-- Create Panel_pick
	local Panel_pick = GUI:Layout_Create(Panel_1, "Panel_pick", 270.00, 4.00, 96.00, 35.00, false)
	GUI:setChineseName(Panel_pick, "拾取设置_手动拾取_组合")
	GUI:setAnchorPoint(Panel_pick, 0.50, 0.00)
	GUI:setTouchEnabled(Panel_pick, true)
	GUI:setTag(Panel_pick, -1)

	-- Create CheckBox_pick
	local CheckBox_pick = GUI:CheckBox_Create(Panel_pick, "CheckBox_pick", 48.00, 17.00, "res/public/1900000550.png", "res/public/1900000551.png")
	...
	local Panel_pick_hang_up = GUI:Layout_Create(Panel_1, "Panel_pick_hang_up", 370.00, 4.00, 96.00, 35.00, false)
	GUI:setChineseName(Panel_pick_hang_up, "拾取设置_挂机拾取_组合")
	GUI:setAnchorPoint(Panel_pick_hang_up, 0.50, 0.00)
	GUI:setTouchEnabled(Panel_pick_hang_up, true)
	GUI:setTag(Panel_pick_hang_up, -1)

	-- Create CheckBox_pick_hang_up
	local CheckBox_pick_hang_up = GUI:CheckBox_Create(Panel_pick_hang_up, "CheckBox_pick_hang_up", 48.00, 17.00, "res/public/1900000550.png", "res/public/1900000551.png")
	...
	-- Create Panel_pick_jp
	local Panel_pick_jp = GUI:Layout_Create(Panel_1, "Panel_pick_jp", 470.00, 4.00, 96.00, 35.00, false)
	GUI:setChineseName(Panel_pick_jp, "拾取设置_极品拾取_组合")
	GUI:setAnchorPoint(Panel_pick_jp, 0.50, 0.00)
	GUI:setTouchEnabled(Panel_pick_jp, true)
	GUI:setTag(Panel_pick_jp, -1)

	-- Create CheckBox_pick_jp
	local CheckBox_pick_jp = GUI:CheckBox_Create(Panel_pick_jp, "CheckBox_pick_jp", 48.00, 17.00, "res/public/1900000550.png", "res/public/1900000551.png")
	GUI:CheckBox_setSelected(CheckBox_pick_jp, true)
	GUI:setChineseName(CheckBox_pick_jp, "拾取设置_极品拾取_勾选")
	GUI:setAnchorPoint(CheckBox_pick_jp, 0.50, 0.50)
	GUI:setTouchEnabled(CheckBox_pick_jp, false)
	GUI:setTag(CheckBox_pick_jp, 25)
end
return ui