...
function ui.init(parent)
	...
	-- Create Image_7
	local Image_7 = GUI:Image_Create(Panel_1, "Image_7", 167.00, 407.00, "res/private/setting/textBg.png")
	GUI:Image_setScale9Slice(Image_7, 34, 34, 9, 10)
	...
	-- Create ListView_1
	local ListView_1 = GUI:ListView_Create(Panel_1, "ListView_1", 12.00, 46.00, 312.00, 345.00, 1)
	...
	-- Create Image_10
	local Image_10 = GUI:Image_Create(Panel_time1, "Image_10", 126.00, 17.00, "res/private/setting/textBg.png")
	GUI:setContentSize(Image_10, 90, 28)
	...
	local TextField_input = GUI:TextInput_Create(Image_10, "TextField_input", 6.00, 14.00, 79.00, 25.00, 18)
	...
	-- Create Panel_touch
	local Panel_touch = GUI:Layout_Create(Panel_1, "Panel_touch", 10.00, 46.00, 315.00, 345.00, false)
