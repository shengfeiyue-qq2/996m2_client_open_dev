...
function ui.init(parent)
	...
	-- Create TitleText
	local TitleText = GUI:Text_Create(FrameLayout, "TitleText", 32.00, 498.00, 20, "#d8c8ae", [[]])
	GUI:setTouchEnabled(TitleText, false)
	GUI:setTag(TitleText, -1)
	GUI:Text_enableOutline(TitleText, "#000000", 1)

	-- Create CloseButton
	local CloseButton = GUI:Button_Create(FrameLayout, "CloseButton", 794.00, 514.00, "res/public/1900000510.png")
	...
	-- Create PMainUI
	local PMainUI = GUI:Layout_Create(FrameLayout, "PMainUI", 396.00, 264.00, 732.00, 445.00, false)
