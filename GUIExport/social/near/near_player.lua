...
function ui.init(parent)
	-- Create Layer
	local Layer = GUI:Layout_Create(parent, "nearPlayerLayer", 0.00, 0.00, 732.00, 445.00, false)
	GUI:setChineseName(Layer, "附近组合")
	GUI:setTouchEnabled(Layer, true)
	GUI:setTag(Layer, 36)

	-- Create CheckBox_add
	local CheckBox_add = GUI:CheckBox_Create(Layer, "CheckBox_add", 20.00, 410.00, "res/public/1900000654.png", "res/public/1900000655.png")
	...
	local CheckBox_team = GUI:CheckBox_Create(Layer, "CheckBox_team", 20.00, 380.00, "res/public/1900000654.png", "res/public/1900000655.png")
	...
	local CheckBox_deal = GUI:CheckBox_Create(Layer, "CheckBox_deal", 20.00, 350.00, "res/public/1900000654.png", "res/public/1900000655.png")
	...
	local CheckBox_challenge = GUI:CheckBox_Create(Layer, "CheckBox_challenge", 20.00, 320.00, "res/public/1900000654.png", "res/public/1900000655.png")
	...
	local CheckBox_show = GUI:CheckBox_Create(Layer, "CheckBox_show", 20.00, 290.00, "res/public/1900000654.png", "res/public/1900000655.png")
	...
	-- Create Panel_near
	local Panel_near = GUI:Layout_Create(Layer, "Panel_near", 0.00, 0.00, 732.00, 445.00, false)
