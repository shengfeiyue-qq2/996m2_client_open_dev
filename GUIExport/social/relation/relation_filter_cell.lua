...
function ui.init(parent)
	...
	-- Create Image_1
	local Image_1 = GUI:Image_Create(Panel_1, "Image_1", 62.00, 21.00, "res/public/1900000678.png")
	GUI:setAnchorPoint(Image_1, 0.50, 0.50)
	GUI:setTouchEnabled(Image_1, false)
	GUI:setTag(Image_1, 255)

	-- Create Text_name
	local Text_name = GUI:Text_Create(Panel_1, "Text_name", 62.00, 21.00, 16, "#ffffff", [[全部]])
