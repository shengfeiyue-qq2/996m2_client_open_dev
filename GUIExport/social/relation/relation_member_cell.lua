...
function ui.init(parent)
	...
	-- Create Button_del
	local Button_del = GUI:Button_Create(member_cell, "Button_del", 576.00, 10.00, "res/public/btn_gban_01.png")
	GUI:Button_loadTexturePressed(Button_del, "res/public/btn_gban_02.png")
	GUI:Button_setTitleText(Button_del, "")
	GUI:Button_setTitleColor(Button_del, "#ffffff")
	GUI:Button_setTitleFontSize(Button_del, 14)
	GUI:Button_titleEnableOutline(Button_del, "#000000", 1)
	GUI:setTouchEnabled(Button_del, true)
	GUI:setTag(Button_del, -1)
	GUI:setVisible(Button_del, false)
end
return ui