...
function ui.init(parent)
	...
	-- Create PageText
	local PageText = GUI:Text_Create(page_cell_1, "PageText", 13.00, 62.00, 16, "#807256", [[附
近]])
	...
	-- Create PageText
	local PageText = GUI:Text_Create(page_cell_2, "PageText", 13.00, 62.00, 16, "#807256", [[组
队]])
	GUI:setAnchorPoint(PageText, 0.50, 0.50)
	GUI:setTouchEnabled(PageText, false)
	GUI:setTag(PageText, -1)
	...
	-- Create PageText
	local PageText = GUI:Text_Create(page_cell_3, "PageText", 13.00, 62.00, 16, "#807256", [[好
友]])
	GUI:setAnchorPoint(PageText, 0.50, 0.50)
	GUI:setTouchEnabled(PageText, false)
	GUI:setTag(PageText, -1)
	...
	-- Create PageText
	local PageText = GUI:Text_Create(page_cell_4, "PageText", 13.00, 62.00, 16, "#807256", [[邮
件]])
	GUI:setAnchorPoint(PageText, 0.50, 0.50)
	GUI:setTouchEnabled(PageText, false)
	GUI:setTag(PageText, -1)
