...
function ui.init(parent)
	...
	GUI:setContentSize(Button_myTeam, 115.0, 37.0)
	...
	GUI:Button_setTitleFontSize(Button_myTeam, 18.0)
	...
	GUI:setContentSize(Button_nearTeam, 115.0, 37.0)
	...
	GUI:Button_setTitleFontSize(Button_nearTeam, 18.0)
	...
	GUI:setContentSize(Button_createTeam, 106.0, 40.0)
	...
	GUI:Button_setTitleFontSize(Button_createTeam, 16.0)
	...
	GUI:setContentSize(Button_applyList, 106.0, 40.0)
	...
	GUI:Button_setTitleFontSize(Button_applyList, 16.0)
	...
	GUI:setContentSize(Button_call, 106.0, 40.0)
	...
	GUI:Button_setTitleFontSize(Button_call, 16.0)
	...
	GUI:setContentSize(Button_invite, 106.0, 40.0)
	...
	GUI:Button_setTitleFontSize(Button_invite, 16.0)
	...
	GUI:setContentSize(Button_exit, 106.0, 40.0)
	...
	GUI:Button_setTitleFontSize(Button_exit, 16.0)
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Panel_myTeam, "Text_name", 215.00, 432.00, 16.0, "#ffffff", [[名字]])
	...
	-- Create Text_job
	local Text_job = GUI:Text_Create(Panel_myTeam, "Text_job", 346.00, 432.00, 16.0, "#ffffff", [[职业]])
	...
	-- Create Text_level
	local Text_level = GUI:Text_Create(Panel_myTeam, "Text_level", 427.00, 432.00, 16.0, "#ffffff", [[等级]])
	...
	-- Create Text_guild
	local Text_guild = GUI:Text_Create(Panel_myTeam, "Text_guild", 528.00, 432.00, 16.0, "#ffffff", [[行会]])
	...
	-- Create Text_map
	local Text_map = GUI:Text_Create(Panel_myTeam, "Text_map", 660.00, 432.00, 16.0, "#ffffff", [[所在地图]])
	...
	-- Create Text_exp
	local Text_exp = GUI:Text_Create(Panel_myTeam, "Text_exp", 150.00, 27.00, 16.0, "#ffffff", [[经验加成]])
	...
	-- Create Text_permit
	local Text_permit = GUI:Text_Create(CheckBox_permit, "Text_permit", 25.00, 9.00, 16.0, "#ffffff", [[允许组队]])
	...
	local ListView_member = GUI:ListView_Create(Panel_myTeam, "ListView_member", 131.00, 55.00, 600.00, 360.00, 1.0)
	...
	-- Create Text_team
	local Text_team = GUI:Text_Create(Panel_nearTeam, "Text_team", 215.00, 432.00, 16.0, "#ffffff", [[队伍]])
	...
	-- Create Text_guild1
	local Text_guild1 = GUI:Text_Create(Panel_nearTeam, "Text_guild1", 383.00, 432.00, 16.0, "#ffffff", [[行会]])
	...
	-- Create Text_number
	local Text_number = GUI:Text_Create(Panel_nearTeam, "Text_number", 540.00, 432.00, 16.0, "#ffffff", [[人数]])
	...
	local Text_operation = GUI:Text_Create(Panel_nearTeam, "Text_operation", 660.00, 432.00, 16.0, "#ffffff", [[操作]])
	...
	local ListView_near = GUI:ListView_Create(Panel_nearTeam, "ListView_near", 131.00, 55.00, 600.00, 360.00, 1.0)
