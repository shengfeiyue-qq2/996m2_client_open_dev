...
function ui.init(parent)
	...
	GUI:Image_setScale9Slice(Image_title, 115, 131.0, 13, 27.0)
	GUI:setContentSize(Image_title, 350.0, 41.0)
	...
	GUI:setTag(Image_title, 28.0)

	-- Create Text_titleName
	local Text_titleName = GUI:Text_Create(PMainUI, "Text_titleName", 22.00, 503.00, 15.0, "#ffffff", [[]])
	...
	GUI:setTag(Text_titleName, 29.0)
	GUI:Text_enableOutline(Text_titleName, "#111111", 1.0)

	-- Create Text_itemName
	local Text_itemName = GUI:Text_Create(PMainUI, "Text_itemName", 235.00, 151.00, 16.0, "#ffffff", [[]])
	...
	GUI:setTag(Text_itemName, 68.0)
	GUI:Text_enableOutline(Text_itemName, "#111111", 1.0)

	-- Create Text_price
	local Text_price = GUI:Text_Create(PMainUI, "Text_price", 235.00, 104.00, 16.0, "#ffffff", [[]])
	GUI:setChineseName(Text_price, "摆摊_出售价格_文本")
	GUI:setAnchorPoint(Text_price, 0.50, 0.50)
	GUI:setTouchEnabled(Text_price, false)
	GUI:setTag(Text_price, 69.0)
	GUI:Text_enableOutline(Text_price, "#111111", 1.0)
	...
	GUI:setTag(Panel_addItem, 49.0)

	-- Create Button_close
	local Button_close = GUI:Button_Create(PMainUI, "Button_close", 367.00, 500.00, "res/public/btn_sifud_01.png")
	GUI:Button_setScale9Slice(Button_close, 15, 15.0, 12, 10.0)
	GUI:setContentSize(Button_close, 66.0, 62.0)
	...
	GUI:setTag(Button_close, 48.0)

	-- Create Button_cancel
	local Button_cancel = GUI:Button_Create(PMainUI, "Button_cancel", 100.00, 38.00, "res/public/btn_sifud_02.png")
	GUI:Button_setScale9Slice(Button_cancel, 15, 15.0, 12, 10.0)
	GUI:setContentSize(Button_cancel, 139.0, 59.0)
	...
	GUI:Button_setTitleFontSize(Button_cancel, 18.0)
	GUI:Button_titleEnableOutline(Button_cancel, "#111111", 2.0)
	...
	GUI:setTag(Button_cancel, 44.0)

	-- Create Button_do
	local Button_do = GUI:Button_Create(PMainUI, "Button_do", 257.00, 38.00, "res/public/btn_sifud_02.png")
	GUI:Button_setScale9Slice(Button_do, 15, 15.0, 12, 10.0)
	GUI:setContentSize(Button_do, 139.0, 59.0)
	...
	GUI:Button_setTitleFontSize(Button_do, 18.0)
	GUI:Button_titleEnableOutline(Button_do, "#111111", 2.0)
	GUI:setChineseName(Button_do, "摆摊_摆摊_按钮")
	GUI:setAnchorPoint(Button_do, 0.50, 0.50)
	GUI:setTouchEnabled(Button_do, true)
	GUI:setTag(Button_do, 45.0)
end
return ui