...
function ui.init(parent)
	...
	-- Create Image_title
	local Image_title = GUI:Image_Create(PMainUI, "Image_title", 176.00, 499.00, "res/private/baitan_ui/baitan_ui_mobile/bg_baitanzy03.png")
	...
	-- Create Button_close
	local Button_close = GUI:Button_Create(PMainUI, "Button_close", 369.00, 502.00, "res/public/btn_sifud_01.png")
