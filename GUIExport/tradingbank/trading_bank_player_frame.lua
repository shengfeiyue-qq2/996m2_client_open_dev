...
function ui.init(parent)
	...
	GUI:Button_setTitleText(Button_4, "货币")
...
能]])
	...
	-- Create Button_page5
	local Button_page5 = GUI:Button_Create(Panel_btnList, "Button_page5", 0.00, 222.00, "res/private/trading_bank/btn_select1.png")
	GUI:Button_loadTexturePressed(Button_page5, "res/private/trading_bank/btn_select2.png")
	GUI:Button_loadTextureDisabled(Button_page5, "res/private/trading_bank/btn_select2.png")
	...
	GUI:Button_titleDisableOutLine(Button_page5)
	GUI:setAnchorPoint(Button_page5, 0.00, 1.00)
	GUI:setTouchEnabled(Button_page5, true)
	GUI:setTag(Button_page5, -1)

	-- Create Text_name
	local Text_name = GUI:Text_Create(Button_page5, "Text_name", 12.00, 48.00, 16, "#807256", [[称
号]])
	GUI:setAnchorPoint(Text_name, 0.50, 1.00)
	GUI:setTouchEnabled(Text_name, false)
	GUI:setTag(Text_name, -1)
	...
	-- Create Button_page6
	local Button_page6 = GUI:Button_Create(Panel_btnList, "Button_page6", 0.00, 164.00, "res/private/trading_bank/btn_select1.png")
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Button_page6, "Text_name", 12.00, 48.00, 16, "#807256", [[时
装]])
	GUI:setAnchorPoint(Text_name, 0.50, 1.00)
	GUI:setTouchEnabled(Text_name, false)
	GUI:setTag(Text_name, -1)
	...
	-- Create Button_page7
	local Button_page7 = GUI:Button_Create(Panel_btnList, "Button_page7", 0.00, 106.00, "res/private/trading_bank/btn_select1.png")
	GUI:Button_loadTexturePressed(Button_page7, "res/private/trading_bank/btn_select2.png")
	GUI:Button_loadTextureDisabled(Button_page7, "res/private/trading_bank/btn_select2.png")
	GUI:Button_setTitleText(Button_page7, "")
	GUI:Button_setTitleColor(Button_page7, "#ffffff")
	GUI:Button_setTitleFontSize(Button_page7, 14)
	GUI:Button_titleDisableOutLine(Button_page7)
	GUI:setAnchorPoint(Button_page7, 0.00, 1.00)
	GUI:setTouchEnabled(Button_page7, true)
	GUI:setTag(Button_page7, -1)

	-- Create Text_name
	local Text_name = GUI:Text_Create(Button_page7, "Text_name", 12.00, 48.00, 16, "#807256", [[背
包]])
	GUI:setAnchorPoint(Text_name, 0.50, 1.00)
	GUI:setTouchEnabled(Text_name, false)
	GUI:setTag(Text_name, -1)
	...
	-- Create Button_page8
	local Button_page8 = GUI:Button_Create(Panel_btnList, "Button_page8", 0.00, 48.00, "res/private/trading_bank/btn_select1.png")
	GUI:Button_loadTexturePressed(Button_page8, "res/private/trading_bank/btn_select2.png")
	GUI:Button_loadTextureDisabled(Button_page8, "res/private/trading_bank/btn_select2.png")
	GUI:Button_setTitleText(Button_page8, "")
	GUI:Button_setTitleColor(Button_page8, "#ffffff")
	GUI:Button_setTitleFontSize(Button_page8, 14)
	GUI:Button_titleDisableOutLine(Button_page8)
	GUI:setAnchorPoint(Button_page8, 0.00, 1.00)
	GUI:setTouchEnabled(Button_page8, true)
	GUI:setTag(Button_page8, -1)

	-- Create Text_name
	local Text_name = GUI:Text_Create(Button_page8, "Text_name", 12.00, 48.00, 16, "#807256", [[仓
库]])
	GUI:setAnchorPoint(Text_name, 0.50, 1.00)
	GUI:setTouchEnabled(Text_name, false)
	GUI:setTag(Text_name, -1)
