...
function ChatExtend.main(parent)
    ...
    for irow = 1, row do
        for icol = 1, col do
            ...
            local function createCell(parent)
                ...
                GUI:setAnchorPoint(good_image, cc.p(0.5, 0.5))
