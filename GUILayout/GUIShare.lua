...
------------------------------------------------------------------------------------------------------------------------------------
-- 内挂技能优先级设置
local setOtherSkilllPriority = function (setID, groupID)
    if  SL:CheckSet(setID) == 1 then
        SL:ResetSkillPriorityByGroup(groupID)
    else
        SL:SetSkillPriorityByGroup(groupID, 0)
    end
end
...
-- 单体、群体、加血治疗、召唤 优先级
local setSkillPriority = function (skills, setID)
    ...
    for _, skill in pairs(skills) do
        if skill.skillgroup == skillgroup and not enabled and not condition then
            SL:SetSkillPriorityByGroup(skill.skillgroup, 0)
        else
            SL:ResetSkillPriorityByGroup(skill.skillgroup)
        end
    end
end
...
local checkSetSkills = function (setID)
    if setID == 47 then
        setSkillPriority(GUIShare.FindSkills(1), setID)         -- 单体技能
    elseif setID == 21 then
        setSkillPriority(GUIShare.FindSkills(2), setID)         -- 群体技能
    elseif setID == 25 then
        setSkillPriority(GUIShare.FindSkills(3), setID)         -- 治疗加血
    elseif setID == 26 then
        setSkillPriority(GUIShare.FindSkills(4), setID)         -- 自动召唤
    end
end
