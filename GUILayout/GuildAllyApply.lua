...
function GuildAllyApply.RegisterEvent()
    SL:RegisterLUAEvent(LUA_EVENT_GUILDE_ALLY_APPLY_UPDATE, "GuildAllyApply", GuildAllyApply.onRefreshAllyApply)
end

function GuildAllyApply.RemoveEvent()
    SL:UnRegisterLUAEvent(LUA_EVENT_GUILDE_ALLY_APPLY_UPDATE, "GuildAllyApply")
end