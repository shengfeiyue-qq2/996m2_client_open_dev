    ...
    for i, v in ipairs(TitleDatas) do
        ...
        local function onEditEvent(sender, eventType)
            if eventType == 1 or eventType == 4 then
                ...
                SL:CheckSensitive(inputStr, function () GUI:TextInput_setString(sender, inputStr) end, function () GUI:TextInput_setString(sender, "xxx") end)
            end
        end
        GUI:TextInput_addOnEvent(ui_EditInput, onEditEvent)
    end
end
