...
HeroEquip_Look_TradingBank.samePosDiff = {} --相同部位分开
...
function HeroEquip_Look_TradingBank.main(data)
    HeroEquip_Look_TradingBank.posSetting = {-- 13 斗笠位置比较特殊 属于和头盔位置同部位
...
function HeroEquip_Look_TradingBank.InitEquipCells()
    ...
    if showExtra then
        ...
        local pos10x = (GUI:getPositionX(HeroEquip_Look_TradingBank._ui.Panel_pos9) + GUI:getPositionX(HeroEquip_Look_TradingBank._ui.Panel_pos10)) / 2 + 10
        local pos12x = (GUI:getPositionX(HeroEquip_Look_TradingBank._ui.Panel_pos11) + GUI:getPositionX(HeroEquip_Look_TradingBank._ui.Panel_pos12)) / 2 - 10
        local pos15x = GUI:getPositionX(HeroEquip_Look_TradingBank._ui.Panel_pos15)
        local pos14x = GUI:getPositionX(HeroEquip_Look_TradingBank._ui.Panel_pos14)
        GUI:setPositionX(HeroEquip_Look_TradingBank._ui.Panel_pos10, pos10x)
        GUI:setPositionX(HeroEquip_Look_TradingBank._ui.Panel_pos11, pos12x)
        GUI:setPositionX(HeroEquip_Look_TradingBank._ui.Panel_pos12, pos15x)
        GUI:setPositionX(HeroEquip_Look_TradingBank._ui.Panel_pos9, pos14x)

        GUI:setPositionX(HeroEquip_Look_TradingBank._ui.Node_10, pos10x)
        GUI:setPositionX(HeroEquip_Look_TradingBank._ui.Node_11, pos12x)
        GUI:setPositionX(HeroEquip_Look_TradingBank._ui.Node_12, pos15x)
        GUI:setPositionX(HeroEquip_Look_TradingBank._ui.Node_9, pos14x)
    end
end
...
function HeroEquip_Look_TradingBank.RefreshBestRingBox()
    ...
    function()
        if self and HeroEquip_Look_TradingBank._ui.Best_ringBox then
