...
function HeroEquip_Look.InitEquipCells()
    ...
    if showExtra then
        ...
        local pos10x = (GUI:getPositionX(HeroEquip_Look._ui.Panel_pos9) + GUI:getPositionX(HeroEquip_Look._ui.Panel_pos10)) / 2 + 8
        local pos12x = (GUI:getPositionX(HeroEquip_Look._ui.Panel_pos11) + GUI:getPositionX(HeroEquip_Look._ui.Panel_pos12)) / 2 - 8
...
function HeroEquip_Look.RefreshPlayerBestRingsOpenState(data)
    ...
    local function mouseMoveCallBack(touchPos)
        ...
        if SL:CheckNodeCanCallBack(HeroEquip_Look._ui.Best_ringBox, touchPos) and bestRingsName ~= "" then
            ...
            GUI:setPosition(tips,GUI:getContentSize(HeroEquip_Look._ui.Best_ringBox).width/2, 10)
            GUI:setName(tips,"TIPS")
            GUI:addChild(HeroEquip_Look._ui.Best_ringBox,tips)
        end
    end
