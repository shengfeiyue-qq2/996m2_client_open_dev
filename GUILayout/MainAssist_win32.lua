...
function MainAssist.ChangeHideStatus(status)
    ...
    if MainAssist._hideAssist then
        ...
        GUI:Timeline_EaseSineIn_MoveTo(MainAssist._Panel_assist, { x = assitX, y = assitY }, 0.2)
    end
end
