...
function MainPropertyWin32.UpdatePkMode()
    ...
    if Text_pkmode then
        ...
        GUI:Text_setString(Text_pkmode, GUIShare.GetHumanModeStr(pkMode))
    end
end
...
function MainPropertyWin32.OnClickChangePkMode()
    local pkModeTB = GUIShare.GetHumanModeDatas()
    local modes = {}
    ...
    local nextPKMode = modes[(index >= #modes and 1 or index+1)]
