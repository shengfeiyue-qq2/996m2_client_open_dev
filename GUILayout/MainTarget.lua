...
function MainTarget.createCommonLayout(parent)
    local CommonPanel = GUI:Layout_Create(parent, "CommonPanel", 3, -225, 210, 37, false)
    ...
    local cleanBtn = GUI:Button_Create(CommonPanel, "cleanBtn", 190, 18.5, "res/private/main/Target/btn_gban_01.png")
