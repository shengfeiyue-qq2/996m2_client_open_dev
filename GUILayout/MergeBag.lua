...
function MergeBag.main( type,page )
    ...
    SL:RegisterLUAEvent(LUA_EVENT_REF_ITEM_LIST, "MergeBag", MergeBag.RefreshItemList)
    SL:RegisterLUAEvent(LUA_EVENT_ITEM_POS_CHANGE, "MergeBag", MergeBag.ItemPosChange)
    SL:RegisterLUAEvent(LUA_EVENT_PLAYER_EQUIP_CHANGE, "MergeBag", MergeBag.RefItemBeStrongMask)
    SL:RegisterLUAEvent(LUA_EVENT_BAG_ITEM_CHANGE, "MergeBag", MergeBag.BagItemChange)

    SL:RegisterLUAEvent(LUA_EVENT_HERO_EQUIP_CHANGE, "MergeBag", MergeBag.RefItemBeStrongMask)
    SL:RegisterLUAEvent(LUA_EVENT_REF_HERO_ITEM_LIST, "MergeBag", MergeBag.RefreshItemList)
    SL:RegisterLUAEvent(LUA_EVENT_HERO_ITEM_POS_CHANGE, "MergeBag", MergeBag.ItemPosChange)
    SL:RegisterLUAEvent(LUA_EVENT_HERO_BAG_ITEM_CAHNGE, "MergeBag", MergeBag.BagItemChange)
