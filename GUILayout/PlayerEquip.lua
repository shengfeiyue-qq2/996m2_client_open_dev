...
function PlayerEquip.InitEquipCells()
    ...
    if showExtra then
        ...
        local pos10x = (GUI:getPositionX(PlayerEquip._ui.Panel_pos9) + GUI:getPositionX(PlayerEquip._ui.Panel_pos10)) / 2 + 10
        local pos12x = (GUI:getPositionX(PlayerEquip._ui.Panel_pos11) + GUI:getPositionX(PlayerEquip._ui.Panel_pos12)) / 2 - 10
