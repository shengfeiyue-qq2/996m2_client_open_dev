...
PlayerEquip_Look.samePosDiff = {} --相同部位分开 -- 13 斗笠位置比较特殊 属于和头盔位置同部位
...
function PlayerEquip_Look.InitEquipCells()
    ...
    if showExtra then
        ...
        local pos10x = (GUI:getPositionX(PlayerEquip_Look._ui.Panel_pos9) + GUI:getPositionX(PlayerEquip_Look._ui.Panel_pos10)) / 2 + 10
        local pos12x = (GUI:getPositionX(PlayerEquip_Look._ui.Panel_pos11) + GUI:getPositionX(PlayerEquip_Look._ui.Panel_pos12)) / 2 - 10
