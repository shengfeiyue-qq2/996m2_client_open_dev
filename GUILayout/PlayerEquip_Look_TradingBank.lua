...
PlayerEquip_Look_TradingBank.samePosDiff = {} --相同部位分开
...
function PlayerEquip_Look_TradingBank.InitEquipCells()
    ...
    if showExtra then
        ...
        local pos10x = (GUI:getPositionX(PlayerEquip_Look_TradingBank._ui.Panel_pos9) + GUI:getPositionX(PlayerEquip_Look_TradingBank._ui.Panel_pos10)) / 2 + 10
        local pos12x = (GUI:getPositionX(PlayerEquip_Look_TradingBank._ui.Panel_pos11) + GUI:getPositionX(PlayerEquip_Look_TradingBank._ui.Panel_pos12)) / 2 - 10
        local pos15x = GUI:getPositionX(PlayerEquip_Look_TradingBank._ui.Panel_pos15)
        local pos14x = GUI:getPositionX(PlayerEquip_Look_TradingBank._ui.Panel_pos14)
        GUI:setPositionX(PlayerEquip_Look_TradingBank._ui.Panel_pos10, pos10x)
        GUI:setPositionX(PlayerEquip_Look_TradingBank._ui.Panel_pos11, pos12x)
        GUI:setPositionX(PlayerEquip_Look_TradingBank._ui.Panel_pos12, pos15x)
        GUI:setPositionX(PlayerEquip_Look_TradingBank._ui.Panel_pos9, pos14x)

        GUI:setPositionX(PlayerEquip_Look_TradingBank._ui.Node_10, pos10x)
        GUI:setPositionX(PlayerEquip_Look_TradingBank._ui.Node_11, pos12x)
        GUI:setPositionX(PlayerEquip_Look_TradingBank._ui.Node_12, pos15x)
        GUI:setPositionX(PlayerEquip_Look_TradingBank._ui.Node_9, pos14x)
    end
end
...
function PlayerEquip_Look_TradingBank.RefreshBestRingBox()
    ...
    function()
        if self and PlayerEquip_Look_TradingBank._ui.Best_ringBox then
