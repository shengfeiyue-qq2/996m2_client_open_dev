...
PlayerExtraAtt_Look_TradingBank._Attribute = GUIShare.BaseAttTypeTable--属性
...
function PlayerExtraAtt_Look_TradingBank.UpdateBaseAttri()
    ...
    local firstList = GUIShare.GetAttDataShow(showList, nil)
    ...
    local behindList = GUIShare.GetAttDataShow(showListBehind, nil)
...
function PlayerExtraAtt_Look_TradingBank.RefreshFixedAttr(attrs)
    local list = PlayerExtraAtt_Look_TradingBank._ui.ListView_extraAtt
    local attrList = GUIShare.GetAttDataShow(attrs or {})
