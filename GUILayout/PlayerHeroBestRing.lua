...
function PlayerHeroBestRing.RegistEvent()
    SL:RegisterLUAEvent(LUA_EVENT_EQUIP_STATE_CHANGE_HERO, "PlayerHeroBestRing", PlayerHeroBestRing.UpdateEquipPanelState)
...
function PlayerHeroBestRing.UnRegisterEvent()
    SL:UnRegisterLUAEvent(LUA_EVENT_EQUIP_STATE_CHANGE_HERO, "PlayerHeroBestRing")
