...
function PlayerHeroEquip.RegistEvent()
    ...
    SL:RegisterLUAEvent(LUA_EVENT_EQUIP_STATE_CHANGE_HERO, "PlayerHeroEquip", PlayerHeroEquip.UpdateEquipPanelState)
end
...
function PlayerHeroEquip.UnRegisterEvent()
    ...
    SL:UnRegisterLUAEvent(LUA_EVENT_EQUIP_STATE_CHANGE_HERO, "PlayerHeroEquip")
end
