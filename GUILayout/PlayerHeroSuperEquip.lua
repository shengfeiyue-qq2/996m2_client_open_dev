...
function PlayerHeroSuperEquip.RegistEvent()
    ...
    SL:RegisterLUAEvent(LUA_EVENT_EQUIP_STATE_CHANGE_HERO, "PlayerHeroSuperEquip", PlayerHeroSuperEquip.UpdateEquipPanelState)
end

-- 取消事件
function PlayerHeroSuperEquip.UnRegisterEvent()
    SL:UnRegisterLUAEvent(LUA_EVENT_HERO_EQUIP_CHANGE, "PlayerHeroSuperEquip")
    SL:UnRegisterLUAEvent(LUA_EVENT_EQUIP_STATE_CHANGE_HERO, "PlayerHeroSuperEquip")
end
