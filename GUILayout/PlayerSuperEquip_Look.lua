...
function PlayerSuperEquip_Look.InitEquipCells()
    ...
    if showExtra then
        ...
        local offDic = 10
        local pos10x = (GUI:getPositionX(PlayerSuperEquip_Look._ui.Panel_pos43) + GUI:getPositionX(PlayerSuperEquip_Look._ui.Panel_pos27)) / 2 + offDic
        local pos12x = (GUI:getPositionX(PlayerSuperEquip_Look._ui.Panel_pos28) + GUI:getPositionX(PlayerSuperEquip_Look._ui.Panel_pos29)) / 2 - offDic
        GUI:setPositionX(PlayerSuperEquip_Look._ui.Panel_pos27, pos10x)
        GUI:setPositionX(PlayerSuperEquip_Look._ui.Panel_pos28, pos12x)
        GUI:setPositionX(PlayerSuperEquip_Look._ui.Panel_pos29, GUI:getPositionX(PlayerSuperEquip_Look._ui.Panel_pos42))
        GUI:setPositionX(PlayerSuperEquip_Look._ui.Panel_pos43, GUI:getPositionX(PlayerSuperEquip_Look._ui.Panel_pos44))
    end
end
