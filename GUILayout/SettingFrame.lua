...
function SettingFrame.main()
    ...
    -- 挂机
    local Page7 = GUI:Button_Create(FrameLayout, "Page7", 780, posY, "res/public/1900000641.png")
    GUI:Button_loadTextureDisabled(Page7, "res/public/1900000640.png")
    GUI:Button_loadTexturePressed(Page7, "res/public/1900000640.png")
    GUI:setTouchEnabled(Page7, true)
    GUI:addOnClickEvent(Page7, function()
        SettingFrame.PageTo(7)
    end)
    posY = posY - distance
    local PageText7 = GUI:Text_Create(Page7, "PageText", 13, 60, 18, "#ffffff", "挂\n机")
    GUI:setAnchorPoint(PageText7, {x=0.5, y=0.5})
