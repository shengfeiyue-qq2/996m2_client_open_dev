...
function SettingProtocol.main()
    ...
    local attachH = GUIShare.WinView.Height - 50

    -- listview 容器
    local FrameList = GUI:ScrollView_Create(parent, "FrameList", 0, 50, attachW, attachH, 1)
    ...
    local ICP_Button = GUI:Button_Create(parent, "ICP_Button", attachW - 100, 10, "res/public/btn_fanye_03.png")
