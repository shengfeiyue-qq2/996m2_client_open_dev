...
function TradePlayerMain.main( skipPage )
    ...
    -- 背景图
    local FrameBG = GUI:Image_Create(PMainUI, "FrameBG", 0, 0, "res/private/trading_bank/bg_jiaoyh_012.png")
    ...
    -- 装备
    local Page1 = GUI:Button_Create(PMainUI, "Page1", layoutW, posY, "res/private/trading_bank/brn_select1.png")
    GUI:Button_loadTextureDisabled(Page1, "res/private/trading_bank/brn_select2.png")
    GUI:Button_loadTexturePressed(Page1, "res/private/trading_bank/brn_select2.png")
    ...
    -- 状态
    local Page2 = GUI:Button_Create(PMainUI, "Page2", layoutW, posY, "res/private/trading_bank/brn_select1.png")
    GUI:Button_loadTextureDisabled(Page2, "res/private/trading_bank/brn_select2.png")
    GUI:Button_loadTexturePressed(Page2, "res/private/trading_bank/brn_select2.png")
    ...
    -- 属性
    local Page3 = GUI:Button_Create(PMainUI, "Page3", layoutW, posY, "res/private/trading_bank/brn_select1.png")
    GUI:Button_loadTextureDisabled(Page3, "res/private/trading_bank/brn_select2.png")
    GUI:Button_loadTexturePressed(Page3, "res/private/trading_bank/brn_select2.png")
    ...
    -- 技能
    local Page4 = GUI:Button_Create(PMainUI, "Page4", layoutW, posY, "res/private/trading_bank/brn_select1.png")
    GUI:Button_loadTextureDisabled(Page4, "res/private/trading_bank/brn_select2.png")
    GUI:Button_loadTexturePressed(Page4, "res/private/trading_bank/brn_select2.png")
    ...
    -- 称号
    local Page5 = GUI:Button_Create(PMainUI, "Page5", layoutW, posY, "res/private/trading_bank/brn_select1.png")
    GUI:Button_loadTextureDisabled(Page5, "res/private/trading_bank/brn_select2.png")
    GUI:Button_loadTexturePressed(Page5, "res/private/trading_bank/brn_select2.png")
    ...
    -- 神装
    local Page6 = GUI:Button_Create(PMainUI, "Page6", layoutW, posY, "res/private/trading_bank/brn_select1.png")
    GUI:Button_loadTextureDisabled(Page6, "res/private/trading_bank/brn_select2.png")
    GUI:Button_loadTexturePressed(Page6, "res/private/trading_bank/brn_select2.png")
    ...
    -- 背包
    local Page7 = GUI:Button_Create(PMainUI, "Page7", layoutW, posY, "res/private/trading_bank/brn_select1.png")
    GUI:Button_loadTextureDisabled(Page7, "res/private/trading_bank/brn_select2.png")
    GUI:Button_loadTexturePressed(Page7, "res/private/trading_bank/brn_select2.png")
    ...
    -- 仓库
    local Page8 = GUI:Button_Create(PMainUI, "Page8", layoutW, posY, "res/private/trading_bank/brn_select1.png")
    GUI:Button_loadTextureDisabled(Page8, "res/private/trading_bank/brn_select2.png")
    GUI:Button_loadTexturePressed(Page8, "res/private/trading_bank/brn_select2.png")
