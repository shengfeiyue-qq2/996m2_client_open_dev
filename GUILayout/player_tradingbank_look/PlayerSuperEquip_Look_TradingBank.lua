...
function PlayerSuperEquip_Look_TradingBank.GetLooks(pos)
    ...
    -- 通过唯一ID MakeIndex 获取装备数据
    if pos == EquipPosCfg.Equip_Type_Super_Dress and equipData and PlayerSuperEquip_Look_TradingBank._feature.showNodeModel and equipData.shonourSell and tonumber(equipData.shonourSell) == 1 then -- shonourSell == 1 不显示裸模, 服务器下发字段
...
function PlayerSuperEquip_Look_TradingBank.UpdateModelFeatureData()
    ...
    dump(PlayerSuperEquip_Look_TradingBank._feature, "--PlayerSuperEquip_Look_TradingBank._feature-----")
end
...
function PlayerSuperEquip_Look_TradingBank.InitEquipCells()
    ...
    if openFEquip and openFEquip == 0 then
        table.insert(PlayerSuperEquip_Look_TradingBank._EquipPosSet, 14)
        table.insert(PlayerSuperEquip_Look_TradingBank._EquipPosSet, 15)
        ...
        PlayerSuperEquip_Look_TradingBank._EquipPosSet = {}
        PlayerSuperEquip_Look_TradingBank._EquipPosSet = newPosSetting
    else
        -- 额外的装备位置 1是6格 0是4格
