...
function FriendAddBlacklist.main()
    local parent = GUI:Win_Create(UIConst.LAYERID.FriendAddBlacklistGUI, 0, 0, 0, 0, false, false, true, true)
    ...
    -- 添加好友
    GUI:addOnClickEvent(FriendAddBlacklist._ui["Button_ok"], function(sender)
